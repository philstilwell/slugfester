import { topicCategoryDefinitions } from "./data/topics.js?v=3b280f5fe1ddadae";
import { assessmentGuide, debateSectionAnchor, relatedDebates } from "./data/reader-guides.js?v=3b280f5fe1ddadae";
import { debateSummaries } from "./data/debate-summaries.js?v=3b280f5fe1ddadae";
import { avatarsForSpeakerText } from "./data/interlocutors.js?v=3b280f5fe1ddadae";
import { getReferenceDefinition, referenceFromUrl } from "./data/references.js?v=3b280f5fe1ddadae";
import {
  DEFAULT_IMAGE_ALT,
  ...
  topicsPath,
  topicsSeo
} from "./seo.js?v=3b280f5fe1ddadae";
...
async function loadDebateAnalytics() {
  if (!debateAnalyticsPromise) {
    debateAnalyticsPromise = import("./data/debate-analytics.js?v=3b280f5fe1ddadae")
...
async function loadSectionScoreExtremes() {
  if (!sectionScoreExtremesPromise) {
    sectionScoreExtremesPromise = import("./data/section-score-extremes.js?v=3b280f5fe1ddadae")
...
async function loadDebateDetail(id) {
  if (!debateDetailPromises.has(id)) {
    const promise = import(`./data/debate-details/${id}.js?v=3b280f5fe1ddadae`)
      .then(({ debate }) => debate)
      .catch((error) => {
...
async function loadReferenceAppearances(type, slug) {
  ...
  if (!referenceAppearancePromises.has(key)) {
    const promise = import(`./data/reference-appearances/${type}-${slug}.js?v=3b280f5fe1ddadae`)
...
async function route({ focusMain = false } = {}) {
  ...
  if (interlocutorMatch && !biographies) {
    biographiesPromise ||= import("./data/interlocutor-bios.js?v=3b280f5fe1ddadae")
  ...
  if (insightsMatch && window.location.pathname.includes("/data-and-methods") && !insightsMethodsContent) {
    insightsMethodsPromise ||= import("./data/insights-methods.js?v=3b280f5fe1ddadae")
  ...
  if (insightsMatch && !insightsContent) {
    insightsPromise ||= import("./data/insights.js?v=3b280f5fe1ddadae")
