import { topicCategoryDefinitions } from "./data/topics.js?v=f0164dfdca94638e";
import { assessmentGuide, debateSectionAnchor, relatedDebates } from "./data/reader-guides.js?v=f0164dfdca94638e";
import { debateSummaries } from "./data/debate-summaries.js?v=f0164dfdca94638e";
import { avatarsForSpeakerText } from "./data/interlocutors.js?v=f0164dfdca94638e";
import { getReferenceDefinition, referenceFromUrl } from "./data/references.js?v=f0164dfdca94638e";
import {
  DEFAULT_IMAGE_ALT,
  ...
  topicsPath,
  topicsSeo
} from "./seo.js?v=f0164dfdca94638e";
...
async function loadDebateAnalytics() {
  if (!debateAnalyticsPromise) {
    debateAnalyticsPromise = import("./data/debate-analytics.js?v=f0164dfdca94638e")
...
async function loadSectionScoreExtremes() {
  if (!sectionScoreExtremesPromise) {
    sectionScoreExtremesPromise = import("./data/section-score-extremes.js?v=f0164dfdca94638e")
...
async function loadDebateDetail(id) {
  if (!debateDetailPromises.has(id)) {
    const promise = import(`./data/debate-details/${id}.js?v=f0164dfdca94638e`)
      .then(({ debate }) => debate)
      .catch((error) => {
...
async function loadReferenceAppearances(type, slug) {
  ...
  if (!referenceAppearancePromises.has(key)) {
    const promise = import(`./data/reference-appearances/${type}-${slug}.js?v=f0164dfdca94638e`)
...
async function route({ focusMain = false } = {}) {
  ...
  if (interlocutorMatch && !biographies) {
    biographiesPromise ||= import("./data/interlocutor-bios.js?v=f0164dfdca94638e")
  ...
  if (insightsMatch && window.location.pathname.includes("/data-and-methods") && !insightsMethodsContent) {
    insightsMethodsPromise ||= import("./data/insights-methods.js?v=f0164dfdca94638e")
  ...
  if (insightsMatch && !insightsContent) {
    insightsPromise ||= import("./data/insights.js?v=f0164dfdca94638e")
