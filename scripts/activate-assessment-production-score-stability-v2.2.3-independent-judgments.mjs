...
const SCRIPT =
  "scripts/activate-assessment-production-score-stability-v2.2.3-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-score-stability-v2.2.3-independent-judgments.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-score-stability-v2.2.3-independent-judgments.mjs";
const VALIDATOR =
  "scripts/validate-assessment-production-score-stability-v2.2.3-independent-judgment.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.2.3-independent-judgment-activation.mjs";
...
assertV4(
  ...
  "v2.2.3 independent-judgment activation is not authorized"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-score-stability-v2.2.3-independent-judgment-execution-activation",
  protocolId: preparation.protocolId,
  status: "frozen-twenty-v2.2.3-independent-judgment-contexts-authorized",
  activatedAt,
  ...
  AIOnly: true,
  userAuthorization: {
    instruction: "Ok, proceed at your discretion.",
