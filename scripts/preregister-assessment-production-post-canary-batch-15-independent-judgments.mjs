...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-15-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-15-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 191 &&
    preparation.totals.movesJudgedAcrossPasses === 382 &&
  ...
  "Batch 15 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 15 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 15 exact-source compatibility boundary drifted"
);
assertV4(
