...
import {
  buildAssessmentProductionPostCanaryBatch17AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-17-audio-work-items.mjs";
import {
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-17-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-17-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-17-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 17 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 17 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  analysis.audioWorkload.moves === 1 &&
  ...
  "Batch 17 one-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 17 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 17 exact one-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 1 &&
  ...
  "Batch 17 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-17-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_17_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-one-post-canary-batch-17-local-audio-source-work-item-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-17-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_17_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-and-frozen-one-post-canary-batch-17-local-audio-source-work-item-standing-authorization-active-for-audio-preparation",
  developmentValidationOnly: false,
  productionCanary: false,
  batchNumber: 17,
  stagingOnly: true,
  ...
  nextAuthorizedAction:
    "prepare-local-batch-17-source-audio-and-one-frozen-clip-under-standing-authorization"
};
