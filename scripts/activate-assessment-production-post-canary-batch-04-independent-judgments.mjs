...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-04-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-04-independent-judgments.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-post-canary-batch-04-independent-judgments.mjs";
const VALIDATOR =
  "scripts/validate-assessment-production-post-canary-batch-04-independent-judgment.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-04-independent-judgment-activation.mjs";
...
assertV4(
  ...
  "Batch 4 independent-judgment activation prerequisites drifted"
);
assertV4(
  ...
  "frozen Batch 4 judgment packet preparation drifted"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-independent-judgment-execution-activation",
  ...
  userAuthorization: {
    scope:
      "activate and execute exactly the twenty frozen Batch 4 score-blind independent-judgment contexts under the frozen standing authorization",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-04-independent-judgment-gate-once",
};
if (shouldWrite) {
