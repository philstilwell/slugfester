...
assert.equal(analysis.evidenceBoundary.audioTranscriptInputs, 9);
...
if (
  ...
  assert.equal(analysis.gate.disputedMovesDecided, 177);
  assert.equal(analysis.gate.candidateSelections, 483);
  assert.equal(
