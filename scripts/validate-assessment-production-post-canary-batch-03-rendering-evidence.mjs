...
assertV4(
  ...
  "valid Batch 3 rendering activation required"
);
...
assertV4(
  ...
  "complete passing Batch 3 rendering evidence required"
);
...
console.log(
  JSON.stringify(
    {
      schemaVersion:
        "1.0-assessment-production-post-canary-batch-03-rendering-evidence-audit",
      protocolId: POST_CANARY_BATCH_03_RENDERING_PROTOCOL_ID,
      status: "ten-debate-batch-03-rendering-evidence-passed",
      debates: 10,
      sections: 53,
      moves: 200,
