...
assert.equal(execution.state.debate170AdditionalDownloadCliInvocations, 1);
assert.equal(execution.state.debate19DownloadCliInvocations, 1);
assert.equal(execution.state.debate183DownloadCliInvocations, 1);
...
assert.equal(baseResult.sources, 3);
assert.equal(baseResult.clips, 4);
