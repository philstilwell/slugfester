...
assertV4(
  ...
  "Batch 13 publication execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-13-publication-execution-activation",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 13 standing authorization permits activation and execution of exactly the ten frozen score-locked publication contexts using 5.6 Sol with low reasoning effort through ChatGPT subscription, the frozen 1→2 scheduler, one attempt per context, and no retries.",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-13-publication-gate-once"
};
