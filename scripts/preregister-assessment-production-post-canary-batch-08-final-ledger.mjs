...
import {
  POST_CANARY_BATCH_08_FINAL_LEDGER_PROTOCOL_ID,
...
const analysisPath = `${POST_CANARY_BATCH_08_FINAL_LEDGER_ROOT}/analysis.json`;
if (shouldWrite) {
...
const preview = buildPostCanaryBatch08FinalLedger(
  inputs.debateInputs,
  inputs.sourceHashes
);
...
const expected = {
  ...
  pairSelections: 192,
  scoringFieldSelections: 321,
  burdenAdjustmentSelections: 20,
  roundedMeanPopulation: 373,
...
assertV4(
  ...
  "post-canary Batch 8 final-ledger preview population mismatch"
);
...
const sourceFiles = [
  ...
  "docs/assessment-production/post-canary-continuation-v1/batch-08/dispute-only-adjudication/gate-correction-2-analysis.json",
  ...
  "scripts/preregister-assessment-production-post-canary-batch-08-final-ledger.mjs",
  "scripts/assemble-assessment-production-post-canary-batch-08-final-ledger.mjs",
  "scripts/validate-assessment-production-post-canary-batch-08-final-ledger.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-08-final-ledger.mjs",
  "scripts/test-assessment-production-post-canary-batch-08-final-ledger.mjs"
];
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-final-ledger-assembly-manifest",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 8 standing authorization permits deterministic final-ledger assembly and the single repository score pass while every gate passes.",
    scopeReference:
      "docs/assessment-production/post-canary-continuation-v1/batch-08/continuation-standing-authorization.json",
  ...
  nextAuthorizedAction:
    "assemble-and-validate-ten-post-canary-batch-08-final-ledgers-deterministically"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_08_FINAL_LEDGER_ROOT), {
    recursive: true
  });
  await writeFile(
