...
import {
  POST_CANARY_BATCH_10_SCORE_ROOT,
  POST_CANARY_BATCH_10_SCORE_STABILITY_THRESHOLDS
...
const ledgerAnalysisPath =
  `${POST_CANARY_BATCH_10_FINAL_LEDGER_ROOT}/analysis.json`;
const preparationPath =
  `${POST_CANARY_BATCH_10_SCORE_ROOT}/score-pass-preparation-manifest.json`;
const activationPath =
  `${POST_CANARY_BATCH_10_SCORE_ROOT}/score-pass-manifest.json`;
const scoresPath = `${POST_CANARY_BATCH_10_SCORE_ROOT}/calculated-scores.json`;
const scoreAnalysisPath = `${POST_CANARY_BATCH_10_SCORE_ROOT}/analysis.json`;
...
assertV4(
  ...
  "post-canary Batch 10 score-pass preparation gate is unavailable"
);
...
const batchFixtureTestPath =
  "scripts/test-assessment-production-post-canary-batch-10-score-gate.mjs";
const judgmentActivationPath =
  "docs/assessment-production/post-canary-continuation-v1/batch-10/independent-judgments/execution-activation.json";
...
assertV4(
  ...
  "Batch 10 upstream judgment configuration changed"
);
...
assertV4(
  ...
  "Batch 10 policy fixture test failed"
);
...
const sourcePaths = [
  ...
  "scripts/test-assessment-production-post-canary-batch-10-score-pass-gate.mjs",
  "scripts/preregister-assessment-production-post-canary-batch-10-score-pass.mjs",
  "scripts/activate-assessment-production-post-canary-batch-10-score-pass.mjs",
  "scripts/derive-assessment-production-post-canary-batch-10-scores.mjs",
  "scripts/validate-assessment-production-post-canary-batch-10-scores.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-10-scores.mjs"
];
const sourceHashes = {};
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-single-score-pass-preparation-manifest",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 10 standing authorization permits preparation, activation, and exactly one deterministic repository score pass while every gate passes.",
    scopeReference:
      "docs/assessment-production/post-canary-continuation-v1/batch-10/standing-authorization.json",
  ...
  acceptanceRule: {
    ...
    ...structuredClone(POST_CANARY_BATCH_10_SCORE_STABILITY_THRESHOLDS)
  },
  artifacts: {
  ...
  nextAuthorizedAction:
    "standing-authorization-permits-activation-and-execution-of-the-single-deterministic-batch-10-score-pass"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_10_SCORE_ROOT), { recursive: true });
  await writeFile(
  ...
  JSON.stringify(
    {
      ...
      finalSides: 20,
      activePolicy: "v2.2",
      thresholds: POST_CANARY_BATCH_10_SCORE_STABILITY_THRESHOLDS,
