...
assert.equal(activation.status, "frozen-batch-08-production-publication-mutation-pass-activated");
assert.equal(activation.directIncrementalCostCapUsd, 0);
assert.deepEqual(activation.frozenOutput.changedDebateNumbers, POST_CANARY_BATCH_08_PRODUCTION_PUBLICATION_ORDER);
