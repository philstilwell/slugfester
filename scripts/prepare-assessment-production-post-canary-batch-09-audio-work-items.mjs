...
import {
  buildAssessmentProductionPostCanaryBatch09AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-09-audio-work-items.mjs";
import {
...
const EXPECTED_AUDIO = [
  ...
  "183:con-foundational-anomaly-significance",
  "183:con-informed-deliberator-method"
];
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 9 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 9 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  analysis.audioWorkload.moves === 4 &&
  ...
  "Batch 9 four-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 9 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 9 exact four-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 4 &&
  ...
  "Batch 9 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-09-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_09_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-four-post-canary-batch-09-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-09-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_09_DISAGREEMENT_PROTOCOL_ID,
  status:
