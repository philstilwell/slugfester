...
import { sha256 } from "./lib/assessment-production-post-canary-batch-13-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-13-generated-seo-correction-pass-activated");
