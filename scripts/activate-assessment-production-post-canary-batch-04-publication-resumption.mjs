...
import { activateBatch04PublicationResumption } from "./lib/assessment-production-post-canary-batch-04-publication-resumption-workflow.mjs";

const activatedAtIndex = process.argv.indexOf("--activated-at");
const activation = await activateBatch04PublicationResumption({
