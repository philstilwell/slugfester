...
assertV4(write, "Batch 15 compatibility runner requires --write");
...
const paths = {
  root: POST_CANARY_BATCH_15_COMPATIBILITY_ROOT,
...
assertV4(
  ...
  "Batch 15 compatibility pass was already attempted; rerun forbidden"
);
...
assertV4(
  ...
  "frozen Batch 15 compatibility activation is unavailable"
);
...
tests.push(
  runCommand(
    "batch-15-route-positive-negative-controls",
    process.execPath,
...
const nextAuthorizedAction = compatibilityAcceptancePassed
  ? "prepare-batch-15-production-publication-mutation-manifest-under-standing-authorization"
  : "diagnose-batch-15-compatibility-failure-under-failure-recovery-standing-authorization";
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-15-compatibility-execution",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-15-route-score-checkpoint-batch-01-through-batch-14-legacy-reference-validation-passed"
    : "failed-closed-batch-15-compatibility-staging-pass",
  startedAt,
  completedAt,
  activation: {
  ...
  regressions: {
    batch15RouteControlsPassed: tests[0]?.passed === true,
    checkpointBatch01ThroughBatch14LegacyReferencePassed:
      tests[1]?.passed === true,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-15-compatibility-execution-analysis",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-15-production-compatibility-passed"
    : "batch-15-production-compatibility-failed-closed",
  ...
  checks: {
    ...
    routeAndScoreControlsPassed: execution.regressions.batch15RouteControlsPassed,
    checkpointBatch01ThroughBatch14LegacyReferencePassed:
      execution.regressions.checkpointBatch01ThroughBatch14LegacyReferencePassed,
