...
import { sha256 } from "./lib/assessment-production-post-canary-batch-12-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-12-generated-seo-correction-pass-activated");
