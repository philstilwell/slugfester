...
import {
  buildAssessmentProductionPostCanaryBatch08AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-08-audio-work-items.mjs";
import {
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 8 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 8 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  ...
  "Batch 8 six-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 8 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 8 exact six-move audio queue was not reproduced"
);
assertV4(
  ...
  "Batch 8 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_08_DISAGREEMENT_PROTOCOL_ID,
  status:
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_08_DISAGREEMENT_PROTOCOL_ID,
  status:
