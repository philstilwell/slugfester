...
import { validateV374Output } from "./lib/v374-disjoint-atomic.mjs";

const [outputPath, packetPath, schemaPath] = process.argv.slice(2);
if (!outputPath || !packetPath || !schemaPath) throw new Error("usage: validate-v374-atomic-output.mjs OUTPUT PACKET SCHEMA");
