...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 154 &&
  ...
  "the Batch 2 publication resumption-2 is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-2-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-eight-frozen-batch-02-publication-resumption-2-contexts-once"
};
