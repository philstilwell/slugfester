...
import { buildPostCanaryBatch12PublicationFinalization,
  validatePostCanaryBatch12PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-12-publication-finalization-prepared" &&
...
"Batch 12 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 204, "finalization move count changed");
