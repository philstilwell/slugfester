...
import { validateV375Output } from "./lib/v375-correction.mjs";

const [outputPath, packetPath, schemaPath] = process.argv.slice(2);
if (!outputPath || !packetPath || !schemaPath) throw new Error("usage: validate-v375-correction-output.mjs OUTPUT PACKET SCHEMA");
