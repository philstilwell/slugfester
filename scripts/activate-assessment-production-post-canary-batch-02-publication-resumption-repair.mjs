...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_02_DEBATE_172_REPAIR_PROTOCOL_ID &&
    preparation.status ===
    ...
    preparation.authorization?.remainingEightContextExecution === false &&
  ...
  "the Debate 172 repair execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-debate-172-publication-repair-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-one-frozen-debate-172-publication-repair-context-once"
};
