...
assert.equal(manifest.context.debateNumber, "17");
assert.deepEqual(manifest.context.disputedMoves, [
...
if (analysis.status === "v2.2.3-audio-attribution-adjudication-passed") {
