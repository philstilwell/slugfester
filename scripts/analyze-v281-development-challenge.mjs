...
const analysis = {
  schemaVersion: "2.8.1-development-challenge-analysis",
...
if (selfTest) {
  ...
  console.log(JSON.stringify({ status: "passed", kind: "v2.8.1-analyzer-self-test", caseCount: rows.length }, null, 2));
} else {
