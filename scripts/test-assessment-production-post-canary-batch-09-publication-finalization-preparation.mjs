...
import { buildPostCanaryBatch09PublicationFinalization,
  validatePostCanaryBatch09PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-09-publication-finalization-prepared" &&
...
"Batch 9 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 180, "finalization move count changed");
