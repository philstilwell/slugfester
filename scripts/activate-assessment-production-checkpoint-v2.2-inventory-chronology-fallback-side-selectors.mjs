...
const SCRIPT =
  "scripts/activate-assessment-production-checkpoint-v2.2-inventory-chronology-fallback-side-selectors.mjs";
const RUNNER =
  "scripts/run-assessment-production-checkpoint-v2.2-inventory-chronology-fallback-side-selectors.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-checkpoint-v2.2-inventory-chronology-fallback-side-selectors.mjs";
const TEST =
  "scripts/test-assessment-production-checkpoint-v2.2-inventory-chronology-fallback-side-selector-activation.mjs";
