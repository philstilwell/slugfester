...
import {
  buildAssessmentProductionScoreStabilityV223AudioWorkItems
} from "./lib/assessment-production-score-stability-v2.2.3-audio-work-items.mjs";
import {
  ASSESSMENT_PRODUCTION_SCORE_STABILITY_V223_DISAGREEMENT_PROTOCOL_ID,
  ASSESSMENT_PRODUCTION_SCORE_STABILITY_V223_DISAGREEMENT_ROOT
} from "./lib/assessment-production-score-stability-v2.2.3-disagreement.mjs";
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-score-stability-v2.2.3-audio-work-items.mjs",
  "scripts/lib/assessment-production-score-stability-v2.2.3-audio-work-items.mjs",
  ...
  "scripts/test-assessment-production-score-stability-v2.2.3-audio-work-items.mjs"
];
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen v2.2.3 audio work-item artifacts already exist"
  );
}
...
assertV4(
  analysis.status ===
    ...
    analysis.nextAuthorizedAction ===
      "prepare-four-v2.2.3-local-audio-source-work-items-model-free-only",
  "v2.2.3 audio work-item preparation is not authorized"
);
assertV4(
  analysis.audioWorkload.moves === 4 &&
    analysis.audioWorkload.workItemsPrepared === false &&
    analysis.audioWorkload.audioAccessed === false,
  "v2.2.3 audio queue or preparation boundary changed"
);
assertV4(
  ...
  "v2.2.3 execution-preparation population changed"
);
...
assertV4(
  ...
  "v2.2.3 four-move audio queue was not reproduced"
);
assertV4(
  ...
  "v2.2.3 audio work-item trigger or clip-window contract changed"
);

const workDocument = {
  schemaVersion: "1.0-score-stability-v2.2.3-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_SCORE_STABILITY_V223_DISAGREEMENT_PROTOCOL_ID,
  status: "prepared-four-v2.2.3-local-audio-source-work-items",
...
const preparation = {
  schemaVersion:
    "1.0-score-stability-v2.2.3-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_SCORE_STABILITY_V223_DISAGREEMENT_PROTOCOL_ID,
  status: "prepared-and-frozen-four-v2.2.3-local-audio-source-work-items",
  productionCanary: false,
  stagingOnly: true,
  developmentValidationOnly: true,
  ...
  nextAuthorizedAction:
    "prepare-four-v2.2.3-local-audio-sources-and-clips-model-free-only"
};
