...
assertV4(
  ...
  "Batch 1 publication execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-publication-execution-activation",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-01-publication-gate-once"
};
