...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 163 &&
    preparation.totals?.cohortMoves === 177 &&
  ...
  "the Batch 1 publication resumption is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-publication-resumption-execution-activation",
  ...
  userAuthorization: {
    instruction:
      "I approve activation and execution of exactly the nine frozen Batch 1 score-locked publication-resumption contexts using 5.6 Sol with low reasoning effort through my ChatGPT subscription, with a direct incremental cost cap of $0. Use the frozen 1→2 scheduler, one attempt per context, and no retries. Stop after deterministic publication-output validation, complete ten-debate cohort analysis, committing, and pushing. Do not prepare or execute repair packets, use paid services, compile or finalize publication, mutate production, or select the next batch.",
  ...
  acceptedDebate31: structuredClone(preparation.acceptedDebate31),
  ...
  nextRequiredAction:
    "execute-the-nine-frozen-batch-01-publication-resumption-contexts-once"
};
