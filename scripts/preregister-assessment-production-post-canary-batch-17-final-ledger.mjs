...
import {
  POST_CANARY_BATCH_17_FINAL_LEDGER_PROTOCOL_ID,
  POST_CANARY_BATCH_17_FINAL_LEDGER_ROOT,
  buildPostCanaryBatch17FinalLedger,
...
const manifestPath =
  `${POST_CANARY_BATCH_17_FINAL_LEDGER_ROOT}/final-ledger-manifest.json`;
const ledgerPath = `${POST_CANARY_BATCH_17_FINAL_LEDGER_ROOT}/final-ledger.json`;
const analysisPath = `${POST_CANARY_BATCH_17_FINAL_LEDGER_ROOT}/analysis.json`;
if (shouldWrite) {
...
const preview = buildPostCanaryBatch17FinalLedger(
  inputs.debateInputs,
  inputs.sourceHashes
);
const validation = validatePostCanaryBatch17FinalLedger(
  preview,
  inputs.debateInputs,
  inputs.sourceHashes
);
const expected = {
  ...
  finalMoves: 79,
  disputedMoves: 77,
  candidateSelections: 230,
  pairSelections: 80,
  scoringFieldSelections: 142,
  burdenAdjustmentSelections: 8,
  roundedMeanPopulation: 158,
  dependencyMeanMergesSuppressed: 0,
  audioVerifiedMoves: 1,
  acceptedAdjudicationOutputsWithoutCorrection: 4,
  calculatedScores: 0
};
assertV4(
  ...
  "post-canary Batch 17 final-ledger preview population mismatch"
);
...
const sourceFiles = [
  ...
  "scripts/lib/assessment-production-post-canary-batch-17-dispute-adjudication.mjs",
  "scripts/lib/assessment-production-post-canary-batch-17-final-ledger.mjs",
  "scripts/preregister-assessment-production-post-canary-batch-17-final-ledger.mjs",
  "scripts/assemble-assessment-production-post-canary-batch-17-final-ledger.mjs",
  "scripts/validate-assessment-production-post-canary-batch-17-final-ledger.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-17-final-ledger.mjs",
  "scripts/test-assessment-production-post-canary-batch-17-final-ledger.mjs"
];
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-17-final-ledger-assembly-manifest",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 17 standing authorization permits deterministic final-ledger assembly and the single repository score pass while every gate passes.",
    scopeReference:
      "docs/assessment-production/post-canary-continuation-v1/batch-17/standing-authorization.json",
  ...
  nextAuthorizedAction:
    "assemble-and-validate-four-post-canary-batch-17-final-ledgers-deterministically"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_17_FINAL_LEDGER_ROOT), {
    recursive: true
  });
  await writeFile(
