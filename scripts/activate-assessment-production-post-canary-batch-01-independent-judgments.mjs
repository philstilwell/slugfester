...
const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-01/independent-judgments";
...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-01-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-01-independent-judgments.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-post-canary-batch-01-independent-judgments.mjs";
const VALIDATOR =
  "scripts/validate-assessment-production-post-canary-batch-01-independent-judgment.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-01-independent-judgment-activation.mjs";
...
assertV4(
  preparation.status ===
      "frozen-twenty-post-canary-batch-01-independent-judgment-contexts-prepared-not-authorized" &&
    ...
    preparation.nextAuthorizedAction ===
      "user-approval-required-before-batch-01-independent-judgment-execution-activation-or-any-judgment-model-execution",
  "Batch 1 independent-judgment activation prerequisites drifted"
);
assertV4(
  ...
  "frozen Batch 1 judgment packet preparation drifted"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-independent-judgment-execution-activation",
  protocolId: preparation.protocolId,
  status:
    "frozen-twenty-post-canary-batch-01-independent-judgment-contexts-authorized",
  activatedAt,
  ...
  userAuthorization: {
    instruction:
      "I approve activation and execution of exactly the twenty frozen Batch 1 score-blind independent-judgment contexts using 5.6 Sol with low reasoning effort through my ChatGPT subscription, with a direct incremental cost cap of $0. Use the frozen 1→2 scheduler and one attempt per context, then stop after deterministic judgment validation, compilation, analysis, commit, and push. Do not extract disagreements, run audio or adjudication, derive scores, reconstruct publication, use paid services, or mutate production.",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-01-independent-judgment-gate-once",
};
if (shouldWrite) {
