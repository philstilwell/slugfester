...
import { sha256 } from "./lib/assessment-production-post-canary-batch-08-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-08-dependent-pilot-analysis-correction-activated");
