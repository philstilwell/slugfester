...
import {
  buildAssessmentProductionPostCanaryBatch14AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-14-audio-work-items.mjs";
import {
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-14-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-14-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-14-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 14 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 14 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  analysis.audioWorkload.moves === 12 &&
  ...
  "Batch 14 twelve-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 14 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 14 exact twelve-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 12 &&
    sourceSummaries.length === 7 &&
  ...
  "Batch 14 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_14_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-twelve-post-canary-batch-14-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_14_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-and-frozen-twelve-post-canary-batch-14-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
  developmentValidationOnly: false,
  productionCanary: false,
  batchNumber: 14,
  stagingOnly: true,
  ...
  nextAuthorizedAction:
    "prepare-local-batch-14-source-audio-and-twelve-frozen-clips-under-standing-authorization"
};
