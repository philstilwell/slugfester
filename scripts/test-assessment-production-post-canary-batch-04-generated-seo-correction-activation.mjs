...
import { sha256 } from "./lib/assessment-production-post-canary-batch-04-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-04-generated-seo-correction-pass-activated");
