...
assertV4(write, "Batch 5 compatibility runner requires --write");
...
const paths = {
  root: POST_CANARY_BATCH_05_COMPATIBILITY_ROOT,
...
assertV4(
  ...
  "Batch 5 compatibility pass was already attempted; rerun forbidden"
);
...
assertV4(
  ...
  "frozen Batch 5 compatibility activation is unavailable"
);
...
tests.push(
  runCommand(
    "batch-05-route-positive-negative-controls",
    process.execPath,
...
if (tests.at(-1).passed) {
  tests.push(
    runCommand("checkpoint-batch-01-batch-02-batch-03-batch-04-legacy-reference-regression", process.execPath, [
...
const nextAuthorizedAction = compatibilityAcceptancePassed
  ? "prepare-batch-05-production-publication-mutation-manifest-under-standing-authorization"
  : "diagnose-batch-05-compatibility-failure-under-failure-recovery-standing-authorization";
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-05-compatibility-execution",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-05-route-score-checkpoint-batch-01-batch-02-batch-03-batch-04-legacy-reference-validation-passed"
    : "failed-closed-batch-05-compatibility-staging-pass",
  startedAt,
  completedAt,
  activation: {
  ...
  regressions: {
    batch05RouteControlsPassed: tests[0]?.passed === true,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-05-compatibility-execution-analysis",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-05-production-compatibility-passed"
    : "batch-05-production-compatibility-failed-closed",
  ...
  checks: {
    ...
    routeAndScoreControlsPassed: execution.regressions.batch05RouteControlsPassed,
    checkpointBatch01Batch02Batch03LegacyReferencePassed:
