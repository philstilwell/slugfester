...
import { buildPostCanaryBatch15PublicationFinalization,
  validatePostCanaryBatch15PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-15-publication-finalization-prepared" &&
...
"Batch 15 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 191, "finalization move count changed");
