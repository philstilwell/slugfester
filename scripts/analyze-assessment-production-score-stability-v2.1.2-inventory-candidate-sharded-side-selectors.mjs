...
for (const prepared of sourcePreparation.contexts) {
  ...
  const summary = {
    schemaVersion:
      "1.0-score-stability-v2.1.2-candidate-sharded-inventory-validation",
    ...
    candidateShardedPlanAndSideSelectorsUsed: true,
...
const analysis = {
  schemaVersion:
    "1.0-score-stability-v2.1.2-candidate-sharded-inventory-analysis",
  protocolId: activation.protocolId,
  status:
    "v2.1.2-candidate-sharded-inventory-gate-passed-independent-judgment-packet-preparation-authorized",
  developmentValidationOnly: true,
  productionCanary: false,
  stagingOnly: true,
  ...
  nextAuthorizedAction:
    "prepare-and-freeze-twenty-v2.1.2-independent-judgment-packets-model-free-only",
};
