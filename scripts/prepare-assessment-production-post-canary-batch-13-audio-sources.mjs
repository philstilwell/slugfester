...
const planRoot =
  "docs/assessment-production/post-canary-continuation-v1/batch-13/disagreement-extraction";
const localRoot =
  "output/transcribe/assessment-production-post-canary-batch-13-audio-verification";
...
const SOURCE_FORMATS = Object.freeze({
  "4qpwVLLebng": "bestaudio/best",
  "LVUQAVQS1-U": "bestaudio/best",
  "KvGdllx9pJU": "bestaudio/best"
});
const TOOL_SOURCES = [
...
assertV4(
  ...
  "Batch 13 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
...
assertV4(
  grouped.size === 3,
  "expected exactly three Batch 13 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-three-post-canary-batch-13-local-audio-sources-eight-clips",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-13-audio-source-preparation",
