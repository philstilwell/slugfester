...
import { sha256 } from "./lib/assessment-production-post-canary-batch-06-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-06-generated-seo-correction-pass-activated");
