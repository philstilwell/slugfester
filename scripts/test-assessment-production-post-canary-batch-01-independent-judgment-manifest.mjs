...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-01/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(preparation.totals.uniqueMoves, 177);
assert.equal(preparation.totals.movesJudgedAcrossPasses, 354);
