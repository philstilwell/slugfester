...
assertV4(
  ...
  "the Batch 2 publication resumption analysis boundary changed"
);
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-analysis",
  protocolId: activation.protocolId,
  status: passed
    ? "post-canary-batch-02-publication-resumption-output-gate-passed"
    : cohortSemanticPass
      ? "post-canary-batch-02-publication-resumption-failed-timing"
