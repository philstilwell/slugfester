...
import {
  POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_DEBATES,
  POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_PROTOCOL_ID,
  POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_ROOT
} from "./lib/assessment-production-post-canary-batch-07-publication-resumption.mjs";
...
assertV4(
  originalExecution.status ===
    ...
    canonicalJson(diagnosis.preservedExecution.unattemptedDebates) ===
      canonicalJson(POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_DEBATES),
...
for (
  ...
  resumptionIndex < POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_DEBATES.length;
  resumptionIndex += 1
) {
  const debateNumber =
    POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_DEBATES[resumptionIndex];
...
const newStaticSources = [
  ...
  REPAIRED_DEBATE_193,
  DEBATE_193_PACKET,
  "scripts/lib/assessment-production-post-canary-batch-07-publication-resumption.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-07-publication-resumption.mjs",
  "scripts/test-assessment-production-post-canary-batch-07-publication-resumption-preparation.mjs",
  "scripts/activate-assessment-production-post-canary-batch-07-publication-resumption.mjs",
  "scripts/run-assessment-production-post-canary-batch-07-publication-resumption.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-07-publication-resumption.mjs"
];
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-07-publication-resumption-execution-preparation-manifest",
  protocolId: POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_PROTOCOL_ID,
  status:
  ...
  userAuthorization: {
    instruction:
      "The Batch 7 standing authorization permits preparation, activation, execution, validation, analysis, committing, and pushing of the nine untouched score-locked publication-resumption contexts at direct incremental cost $0.",
  ...
  acceptanceContract: {
    ...
    resumptionMovesRequired: 168,
    cohortMovesRequired: 187,
    resumptionCritiquesRequired: 168,
  ...
  nextAuthorizedAction:
    "activate-and-execute-exactly-nine-frozen-batch-07-publication-resumption-contexts-under-standing-authorization"
};
