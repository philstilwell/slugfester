...
import {
  buildAssessmentProductionPostCanaryBatch13AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-13-audio-work-items.mjs";
import {
  ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_13_DISAGREEMENT_PROTOCOL_ID,
  ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_13_DISAGREEMENT_ROOT
} from "./lib/assessment-production-post-canary-batch-13-disagreement.mjs";
import {
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-13-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-13-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-13-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-13-disagreement.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 13 audio work-item artifacts already exist"
  );
}
...
assertV4(
  analysis.status ===
    ...
    analysis.nextAuthorizedAction ===
      "prepare-freeze-and-analyze-batch-13-local-audio-source-work-items-under-standing-authorization",
  "Batch 13 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  analysis.audioWorkload.moves === 8 &&
  ...
  "Batch 13 eight-move audio queue or preparation boundary changed"
);
assertV4(
  ...
  "Batch 13 source-compatibility evidence changed"
);
assertV4(
  ...
  "Batch 13 execution-preparation population changed"
);
assertV4(
...
const sourceHashes = {
  ...
  [POST_CANARY_BATCH_13_STANDING_AUTHORIZATION]: standingAuthorization.sha256
};
...
assertV4(
  ...
  "Batch 13 exact eight-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 8 &&
  ...
  "Batch 13 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-13-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_13_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-eight-post-canary-batch-13-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-13-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_13_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-and-frozen-eight-post-canary-batch-13-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
  developmentValidationOnly: false,
  productionCanary: false,
  batchNumber: 13,
  stagingOnly: true,
  ...
  nextAuthorizedAction:
    "prepare-local-batch-13-source-audio-and-eight-frozen-clips-under-standing-authorization"
};
