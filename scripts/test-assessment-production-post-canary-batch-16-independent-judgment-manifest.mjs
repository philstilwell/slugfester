...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-16/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(preparation.totals.uniqueMoves, 194);
assert.equal(preparation.totals.movesJudgedAcrossPasses, 388);
