...
const localRoot =
  "output/transcribe/assessment-production-post-canary-batch-14-audio-verification";
...
assertV4(
  grouped.size === 7,
  "expected exactly seven Batch 14 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-seven-post-canary-batch-14-local-audio-sources-twelve-clips",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-audio-source-preparation",
