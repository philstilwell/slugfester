...
const resumptionPassed =
  execution.status === "five-original-unattempted-batch-13-publication-contexts-passed" &&
...
const analysis = {
  ...
  status: resumptionPassed
    ? "five-original-unattempted-batch-13-publication-contexts-passed"
...
if (resumptionPassed) {
  const allDebates = ["26", "190", "87", "20", "70", ...DEBATES];
