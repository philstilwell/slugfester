...
import { POST_CANARY_BATCH_10_PUBLICATION_FINALIZATION_PROTOCOL_ID,
...
assertV4(p.status === "frozen-post-canary-batch-10-publication-finalization-prepared" &&
  p.protocolId === POST_CANARY_BATCH_10_PUBLICATION_FINALIZATION_PROTOCOL_ID && p.contexts?.length === 10 &&
...
"Batch 10 finalization is not prepared");
...
const activation = { schemaVersion: "1.0-assessment-production-post-canary-batch-10-publication-finalization-activation",
  protocolId: p.protocolId, status: "frozen-post-canary-batch-10-publication-finalization-authorized",
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-10-deterministic-publication-finalization-pass" };
