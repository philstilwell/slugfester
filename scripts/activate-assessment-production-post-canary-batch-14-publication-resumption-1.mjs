...
assertV4(
  preparation.protocolId === PROTOCOL_ID &&
    preparation.status === "frozen-nine-original-unattempted-batch-14-publication-contexts-prepared-not-activated" &&
    preparation.contexts?.length === 9 && preparation.totals?.moves === 170 &&
...
const activation = {
  ...
  status: "frozen-nine-original-unattempted-batch-14-publication-contexts-activated",
  activatedAt,
