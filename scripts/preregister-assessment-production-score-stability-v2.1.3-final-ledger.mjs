...
const preview = buildV213FinalLedger(inputs.debateInputs, inputs.sourceHashes);
...
assertV4(
  ...
  "v2.1.3 final-ledger preview population mismatch"
);
const sourceFiles = [
  ...inputs.sourcePaths,
  ...
  "scripts/preregister-assessment-production-score-stability-v2.1.3-final-ledger.mjs",
  "scripts/assemble-assessment-production-score-stability-v2.1.3-final-ledger.mjs",
  "scripts/analyze-assessment-production-score-stability-v2.1.3-final-ledger.mjs",
  "scripts/test-assessment-production-score-stability-v2.1.3-final-ledger.mjs",
  "scripts/validate-assessment-production-score-stability-v2.1.3-final-ledger.mjs",
];
...
const manifest = {
  schemaVersion: "1.0-score-stability-v2.1.3-final-ledger-assembly-manifest",
  protocolId: V213_FINAL_LEDGER_PROTOCOL_ID,
  status: "frozen-ten-debate-v2.1.3-deterministic-final-ledger-assembly",
  frozenAt,
...
if (shouldWrite) {
  await mkdir(path.resolve(V213_FINAL_LEDGER_ROOT), { recursive: true });
  await writeFile(
