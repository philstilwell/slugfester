...
const activationPath =
  `${POST_CANARY_BATCH_11_DISPUTE_ADJ_ROOT}/execution-activation.json`;
...
const approvedScope =
  "Standing authorization activates exactly the ten frozen Batch 11 score-blind dispute-only adjudication contexts using 5.6 Sol with low reasoning effort through the ChatGPT subscription, the frozen 1→2 scheduler, one attempt per context, no retries or timeout extensions, and a $0 direct incremental cost cap.";
const executionTools = [
  "scripts/activate-assessment-production-post-canary-batch-11-dispute-adjudication.mjs",
  "scripts/run-assessment-production-post-canary-batch-11-dispute-adjudication.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-11-dispute-adjudication.mjs",
  "scripts/test-assessment-production-post-canary-batch-11-dispute-adjudication-gate.mjs"
];
...
assertV4(
  ...
  "Batch 11 adjudication activation is not prepared"
);
assertV4(
  ...
  "Batch 11 standing adjudication authorization changed"
);
assertV4(
  ...
  "Batch 11 model, authentication, score-blindness, or tie boundary changed"
);
assertV4(
...
const activation = {
  ...preparation,
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-11-dispute-only-adjudication-execution-activation",
  status:
    "frozen-ten-post-canary-batch-11-dispute-only-adjudication-contexts-authorized",
  authorizedAt,
  ...
  nextAuthorizedAction:
    "execute-exactly-ten-ramped-post-canary-batch-11-dispute-only-adjudication-contexts-once"
};
assertV4(
  ...
  "Batch 11 execution authorization expanded beyond the user instruction"
);
if (shouldWrite) {
