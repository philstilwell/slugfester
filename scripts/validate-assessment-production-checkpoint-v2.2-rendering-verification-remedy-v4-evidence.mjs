...
import {
  ...
  validateCheckpointV22RenderingRemedyV4ViewportEvidence
...
assertV4(
  preparation.protocolId === CHECKPOINT_V22_RENDERING_REMEDY_V4_PROTOCOL_ID &&
    activation.protocolId === CHECKPOINT_V22_RENDERING_REMEDY_V4_PROTOCOL_ID &&
    activation.status ===
  ...
  "valid remedy-v4 activation required"
);
...
assertV4(
  ...
  "complete passing remedy-v4 evidence required"
);

console.log(JSON.stringify({
  schemaVersion:
    "1.0-production-checkpoint-v2.2-rendering-remedy-v4-evidence-audit",
  protocolId: CHECKPOINT_V22_RENDERING_REMEDY_V4_PROTOCOL_ID,
  status: "ten-debate-remedy-v4-rendering-evidence-passed",
  debates: 10,
  viewportResults: results.length,
  screenshots: results.length * 2,
  validPngScreenshots: results.length * 2,
