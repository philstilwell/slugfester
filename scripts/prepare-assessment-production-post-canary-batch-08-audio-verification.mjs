...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-08";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-08-audio-verification";
...
const EXPECTED_DEBATES = ["137", "156", "120"];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-08-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-08-audio-verification-preparation.mjs",
  "scripts/assessment-production-post-canary-batch-08-audio-verification-stage.mjs",
...
assertV4(
  ...
  "Batch 8 audio-verification preparation is not authorized"
);
assertV4(sourcePreparation.clips.length === 6 && work.moves.length === 6, "six-clip cohort changed");
assertV4(
...
assertV4(calls.length === 6 && references.length === 6, "six calls and six references required");
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_08_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-08-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-08-decomposed-consensus",
  status: shouldWrite
    ? "prepared-six-post-canary-batch-08-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-six-post-canary-batch-08-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  userAuthorization: {
    ...
    verificationCallsAuthorizedForPreparation: 6,
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 8 exact clip seconds and six-call count",
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-six-batch-08-paid-audio-verification-calls-under-standing-authorization"
};
