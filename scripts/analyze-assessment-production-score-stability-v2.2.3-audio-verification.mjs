...
assertV4(
  ...
  "v2.2.3 audio execution unavailable or crossed its boundary"
);
...
const status = passed
  ? "passed-all-four-v2.2.3-confidence-moves-audio-verified"
  : "v2.2.3-audio-verification-unresolved";
const audit = {
  schemaVersion: "1.0-score-stability-v2.2.3-audio-verification-audit",
...
const analysis = {
  schemaVersion: "1.0-score-stability-v2.2.3-audio-verification-analysis",
  protocolId: manifest.protocolId,
  status,
  productionCanary: false,
  stagingOnly: true,
  ...
  nextAuthorizedAction: passed
    ...
    : "diagnose-v2.2.3-audio-verification-failure-only"
};
if (shouldWrite) {
