...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_02_RENDERING_PROTOCOL_ID &&
    activation.protocolId === POST_CANARY_BATCH_02_RENDERING_PROTOCOL_ID &&
    activation.status ===
  ...
  "valid frozen Batch 2 rendering activation required"
);
if (shouldWrite) {
...
assertV4(
  audit.status === "ten-debate-batch-02-rendering-evidence-passed" &&
    audit.debates === 10 &&
    audit.sections === 51 &&
    audit.moves === 190 &&
  ...
  "passing Batch 2 rendering evidence audit required"
);
...
const renderingAudit = {
  ...audit,
  status: "passed-ten-debate-batch-02-rendering-verification",
  completedAt,
...
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-rendering-verification-execution",
  protocolId: POST_CANARY_BATCH_02_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-02-rendering-verification-passed",
  completedAt,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-rendering-verification-analysis",
  protocolId: POST_CANARY_BATCH_02_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-02-rendering-verification-passed",
