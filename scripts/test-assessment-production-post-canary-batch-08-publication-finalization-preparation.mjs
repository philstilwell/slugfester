...
import { buildPostCanaryBatch08PublicationFinalization,
  validatePostCanaryBatch08PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-08-publication-finalization-prepared" &&
...
"Batch 8 finalization preparation changed");
let moves = 0;
