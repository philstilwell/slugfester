...
const USER_AUTHORIZATION = Object.freeze({
  instruction:
    "I approve preparation, validation, freezing, committing, and pushing of exactly three Batch 1 local audio-source work items, with a direct incremental cost cap of $0. Do not access, download, or play audio; execute models; use paid services; adjudicate; derive scores; reconstruct publication; mutate production; or select the next batch.",
  directIncrementalCostUsdMaximum: 0,
  workItemsAuthorized: 3,
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-01-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-01-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-01-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 1 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 1 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  analysis.audioWorkload.moves === 3 &&
  ...
  "Batch 1 three-move audio queue or preparation boundary changed"
);
assertV4(
  ...
  "Batch 1 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 1 exact three-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 3 &&
  ...
  "Batch 1 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_01_DISAGREEMENT_PROTOCOL_ID,
  status:
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_01_DISAGREEMENT_PROTOCOL_ID,
  status:
