...
const SCRIPT =
  "scripts/run-assessment-production-post-canary-batch-17-discovery.mjs";
...
if (command === "preflight") await preflight();
  ...
  throw new Error(
    "usage: run-assessment-production-post-canary-batch-17-discovery.mjs <preflight|activate|run|analyze|validate>"
  );
}
