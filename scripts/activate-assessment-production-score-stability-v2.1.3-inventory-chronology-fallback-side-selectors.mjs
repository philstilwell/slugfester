...
const SCRIPT =
  "scripts/activate-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback-side-selectors.mjs";
const RUNNER =
  "scripts/run-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback-side-selectors.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback-side-selectors.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback-side-selector-activation.mjs";
...
const activation = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-side-selector-execution-activation",
  protocolId: preparation.protocolId,
  sideSelectionProtocolId: preparation.sideSelectionProtocolId,
  status: "frozen-twenty-v2.1.3-side-selector-contexts-authorized",
  activatedAt,
  ...
  nextRequiredAction:
    "execute-frozen-v2.1.3-side-selector-gate-once",
};
