...
assertV4(
  ...
  "the Batch 5 deterministic publication compilation is not prepared"
);
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-05-deterministic-publication-compilation-execution-activation",
  ...
  nextRequiredAction:
    "execute-one-frozen-batch-05-deterministic-publication-compilation-pass"
};
