...
import { sha256 } from "./lib/assessment-production-post-canary-batch-14-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-14-generated-seo-correction-pass-activated");
