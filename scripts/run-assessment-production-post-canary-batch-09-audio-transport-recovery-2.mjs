  ...
  if (source.mode === "recover-once") {
    assertV4(
      source.sourceVideoId === "HoTILnpd3q8" &&
        ...
        !(await exists(plan.debate170Recovery.finalSourcePath)),
    ...
    acquisitionMode = "recovered-public-source-progressive-chunk-transport";
  } else {
...
try {
  ...
  const preparation = {
    ...
    acquisitionPolicy: {
      ...
      acquisitionFormat: "bestaudio/best-or-frozen-progressive-webm-recovery",
...
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-09-audio-source-transport-recovery-2-execution",
  status: executionFailure
    ? "failed-one-shot-batch-09-audio-source-transport-recovery-2-stop-required"
    : "completed-one-shot-batch-09-audio-source-transport-recovery-2-and-cohort",
  batchNumber: 9,
  planSha256: sha256(planBytes),
  activationSha256: sha256(activationBytes),
  state,
