...
import { analyzeBatch04PublicationResumption } from "./lib/assessment-production-post-canary-batch-04-publication-resumption-workflow.mjs";

const analysis = await analyzeBatch04PublicationResumption({
