...
for (const prepared of sourcePreparation.contexts) {
  ...
  const summary = {
    schemaVersion:
      "1.0-assessment-production-post-canary-batch-14-chronology-fallback-inventory-validation",
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-chronology-fallback-inventory-analysis",
  protocolId: activation.protocolId,
  status:
    belowHighAttributionMoves > 0
      ...
      : "post-canary-batch-14-inventory-gate-passed-standing-authorization-active-for-independent-judgment-packet-preparation",
  developmentValidationOnly: false,
  productionCanary: false,
  batchNumber: 11,
  stagingOnly: true,
