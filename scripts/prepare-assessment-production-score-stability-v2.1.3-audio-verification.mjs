...
const EXPECTED_DEBATES = ["181", "92", "78"];
const TOOL_SOURCES = [
  "docs/assessment-production-score-stability-v2.1.3-audio-verification-workflow.md",
  "docs/assessment-production-workflow.md",
  "scripts/lib/v416-audio-verification.mjs",
  "scripts/lib/v4-lean-production.mjs",
  "scripts/prepare-assessment-production-score-stability-v2.1.3-audio-verification.mjs",
  "scripts/activate-assessment-production-score-stability-v2.1.3-audio-verification.mjs",
  "scripts/run-assessment-production-score-stability-v2.1.3-audio-verification.mjs",
  "scripts/analyze-assessment-production-score-stability-v2.1.3-audio-verification.mjs",
  "scripts/test-assessment-production-score-stability-v2.1.3-audio-verification.mjs",
...
assertV4(
  sourcePreparation.status === "prepared-five-v2.1.3-local-audio-clips" &&
  ...
  "v2.1.3 audio-verification preparation is not authorized"
);
assertV4(
  sourcePreparation.clips.length === 5 && work.moves.length === 5,
  "v2.1.3 five-clip population changed"
);
...
const manifest = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-score-stability-v2.1.3-audio-verification",
  status: shouldWrite
    ? "prepared-five-paid-known-speaker-diarizations-pending-explicit-user-approval"
    : "preview-five-paid-known-speaker-diarizations-pending-explicit-user-approval",
  ...
  costEstimate: {
    ...
    officialPricingCheckedAt: "2026-08-11",
    officialPricingUrl:
  ...
  nextAuthorizedAction:
    "record-explicit-user-approval-and-freeze-v2.1.3-paid-audio-verification-activation"
};
assertV4(
