...
import {
  buildAssessmentProductionCheckpointV22AudioWorkItems
} from "./lib/assessment-production-checkpoint-v2.2-audio-work-items.mjs";
import {
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-checkpoint-v2.2-audio-work-items.mjs",
  "scripts/test-assessment-production-checkpoint-v2.2-audio-work-items.mjs",
  "scripts/lib/assessment-production-checkpoint-v2.2-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen production checkpoint v2.2 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "production checkpoint v2.2 audio work-item preparation is not authorized"
);
assertV4(
  analysis.audioWorkload.moves === 2 &&
    analysis.audioWorkload.workItemsPrepared === false &&
    analysis.audioWorkload.audioAccessed === false,
  "production checkpoint v2.2 audio queue or preparation boundary changed"
);
assertV4(
  ...
  "production checkpoint v2.2 execution-preparation population changed"
);
...
assertV4(
  ...
  "production checkpoint v2.2 audio work-item trigger or clip-window contract changed"
);

const workDocument = {
  schemaVersion: "1.0-production-checkpoint-v2.2-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_CHECKPOINT_V22_DISAGREEMENT_PROTOCOL_ID,
  status: "prepared-two-production-checkpoint-v2.2-local-audio-source-work-items",
...
const preparation = {
  schemaVersion:
    "1.0-production-checkpoint-v2.2-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_CHECKPOINT_V22_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-and-frozen-two-production-checkpoint-v2.2-local-audio-source-work-items",
  productionCanary: true,
  stagingOnly: true,
  developmentValidationOnly: false,
  ...
  gateDisposition: structuredClone(analysis.gateDisposition),
  ...
  nextAuthorizedAction:
    "prepare-two-production-checkpoint-v2.2-local-audio-sources-and-clips-model-free-only"
};
