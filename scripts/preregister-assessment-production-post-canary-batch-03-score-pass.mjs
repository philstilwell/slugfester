...
import {
  POST_CANARY_BATCH_03_SCORE_ROOT,
...
const ledgerAnalysisPath =
  `${POST_CANARY_BATCH_03_FINAL_LEDGER_ROOT}/analysis.json`;
const preparationPath =
  `${POST_CANARY_BATCH_03_SCORE_ROOT}/score-pass-preparation-manifest.json`;
const activationPath =
  `${POST_CANARY_BATCH_03_SCORE_ROOT}/score-pass-manifest.json`;
const scoresPath = `${POST_CANARY_BATCH_03_SCORE_ROOT}/calculated-scores.json`;
const scoreAnalysisPath = `${POST_CANARY_BATCH_03_SCORE_ROOT}/analysis.json`;
...
assertV4(
  ...
  "post-canary Batch 3 score-pass preparation gate is unavailable"
);
...
const batchFixtureTestPath =
  "scripts/test-assessment-production-post-canary-batch-03-score-gate.mjs";
const judgmentActivationPath =
  "docs/assessment-production/post-canary-continuation-v1/batch-03/independent-judgments/execution-activation.json";
...
assertV4(
  ...
  "Batch 3 upstream judgment configuration changed"
);
...
assertV4(
  ...
  "Batch 3 policy fixture test failed"
);
...
const sourcePaths = [
  ...
  "scripts/test-assessment-production-post-canary-batch-03-score-pass-gate.mjs",
  "scripts/preregister-assessment-production-post-canary-batch-03-score-pass.mjs",
  "scripts/activate-assessment-production-post-canary-batch-03-score-pass.mjs",
  "scripts/derive-assessment-production-post-canary-batch-03-scores.mjs",
  "scripts/validate-assessment-production-post-canary-batch-03-scores.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-03-scores.mjs"
];
const sourceHashes = {};
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-single-score-pass-preparation-manifest",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 3 standing authorizations permit preparation, activation, and exactly one deterministic repository score pass while every gate passes.",
    scopeReference:
  ...
  acceptanceRule: {
    ...
    ...structuredClone(POST_CANARY_BATCH_03_SCORE_STABILITY_THRESHOLDS)
  },
  artifacts: {
  ...
  nextAuthorizedAction:
    "standing-authorization-permits-activation-and-execution-of-the-single-deterministic-batch-03-score-pass"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_03_SCORE_ROOT), { recursive: true });
  await writeFile(
  ...
  JSON.stringify(
    {
      ...
      finalSides: 20,
      activePolicy: "v2.2",
      thresholds: POST_CANARY_BATCH_03_SCORE_STABILITY_THRESHOLDS,
