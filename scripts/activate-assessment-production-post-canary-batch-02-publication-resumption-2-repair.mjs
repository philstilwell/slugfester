...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_02_RESUMPTION_2_REPAIR_PROTOCOL_ID &&
    preparation.status ===
    ...
    preparation.authorization?.remainingFiveContextExecution === false &&
  ...
  "the resumption-2 repair execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-2-repair-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-six-frozen-resumption-2-publication-repair-contexts-once"
};
