...
import {
  POST_CANARY_BATCH_05_FINAL_LEDGER_PROTOCOL_ID,
...
const preview = buildPostCanaryBatch05FinalLedger(
  inputs.debateInputs,
  inputs.sourceHashes
);
...
const expected = {
  ...
  pairSelections: 189,
  scoringFieldSelections: 324,
  burdenAdjustmentSelections: 14,
  roundedMeanPopulation: 411,
...
assertV4(
  ...
  "post-canary Batch 5 final-ledger preview population mismatch"
);
...
const sourceFiles = [
  ...
  "scripts/preregister-assessment-production-post-canary-batch-05-final-ledger.mjs",
  "scripts/assemble-assessment-production-post-canary-batch-05-final-ledger.mjs",
  "scripts/validate-assessment-production-post-canary-batch-05-final-ledger.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-05-final-ledger.mjs",
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-05-final-ledger-assembly-manifest",
  ...
  nextAuthorizedAction:
    "assemble-and-validate-ten-post-canary-batch-05-final-ledgers-deterministically"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_05_FINAL_LEDGER_ROOT), {
    recursive: true
  });
  await writeFile(
