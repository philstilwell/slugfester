...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_02_RESUMPTION_3_REPAIR_PROTOCOL_ID &&
    preparation.status ===
    ...
    preparation.authorization?.remainingTwoContextExecution === false &&
  ...
  "the resumption-3 repair execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-3-repair-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-five-frozen-resumption-3-publication-repair-contexts-once"
};
