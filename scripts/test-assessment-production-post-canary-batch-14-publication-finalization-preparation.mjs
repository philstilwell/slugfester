...
import { buildPostCanaryBatch14PublicationFinalization,
  validatePostCanaryBatch14PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-14-publication-finalization-prepared" &&
...
"Batch 14 finalization preparation changed");
let moves = 0;
