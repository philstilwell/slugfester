...
import { buildPostCanaryBatch07PublicationFinalization,
  validatePostCanaryBatch07PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-07-publication-finalization-prepared" &&
...
"Batch 7 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 187, "finalization move count changed");
