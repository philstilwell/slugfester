...
assertV4(
  activation.status === "frozen-four-original-unattempted-batch-13-publication-contexts-activated" &&
  ...
  "four-context resumption execution is not activated"
);
assertV4(
  ...
  "four-context execution policy changed"
);
...
const execution = {
  ...
  status: passed
    ...
    : "four-context-publication-resumption-stopped-with-failure",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-replay-four-outputs-and-complete-ten-debate-publication-cohort"
