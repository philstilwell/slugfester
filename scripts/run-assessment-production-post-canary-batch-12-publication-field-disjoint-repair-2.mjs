...
assertV4(
  activation.status === "frozen-one-context-one-field-batch-12-publication-repair-level-2-activated" &&
    activation.authorization?.modelExecution === true && activation.contexts?.length === 1 &&
...
const execution = {
  ...
  protocolId: activation.protocolId,
  status: passed
    ? "one-field-disjoint-batch-12-publication-repair-level-2-context-passed"
    : "one-field-disjoint-batch-12-publication-repair-level-2-context-failed",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-merge-and-validate-debate-28-then-prepare-eight-unattempted-contexts"
