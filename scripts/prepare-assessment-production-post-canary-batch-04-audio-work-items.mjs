...
import {
  buildAssessmentProductionPostCanaryBatch04AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-04-audio-work-items.mjs";
import {
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-04-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-04-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 4 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 4 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  ...
  "Batch 4 four-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 4 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 4 exact four-move audio queue was not reproduced"
);
assertV4(
  ...
  "Batch 4 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_04_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-four-post-canary-batch-04-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_04_DISAGREEMENT_PROTOCOL_ID,
  status:
  ...
  nextAuthorizedAction:
    "prepare-local-batch-04-source-audio-and-four-frozen-clips-under-standing-authorization"
};
