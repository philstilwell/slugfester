...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 162 &&
    preparation.totals?.cohortMoves === 182 &&
  ...
  "the Batch 8 publication resumption is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-publication-resumption-execution-activation",
  ...
  userAuthorization: {
    instruction:
      "The Batch 8 standing authorization permits activation and execution of exactly the nine frozen score-locked publication-resumption contexts using 5.6 Sol with low reasoning through the ChatGPT subscription, one attempt per context, no retries, and direct incremental cost $0.",
  ...
  acceptedDebate88: structuredClone(preparation.acceptedDebate88),
  ...
  nextRequiredAction:
    "execute-the-nine-frozen-batch-08-publication-resumption-contexts-once"
};
