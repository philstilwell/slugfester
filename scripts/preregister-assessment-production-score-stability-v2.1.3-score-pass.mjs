...
import {
  V213_SCORE_ROOT,
  V213_SCORE_STABILITY_THRESHOLDS,
...
const ledgerAnalysisPath = `${V213_FINAL_LEDGER_ROOT}/analysis.json`;
const manifestPath = `${V213_SCORE_ROOT}/score-pass-manifest.json`;
const scoresPath = `${V213_SCORE_ROOT}/calculated-scores.json`;
const scoreAnalysisPath = `${V213_SCORE_ROOT}/analysis.json`;
...
assertV4(
  ...
  "single v2.1.3 score pass is not authorized"
);
const sourcePaths = [
  ledgerPath,
  ledgerAnalysisPath,
  ...
  "scripts/lib/assessment-production-score-stability-v2.1.3-final-ledger.mjs",
  ...
  "scripts/test-assessment-production-score-stability-v2.1.3-score-gate.mjs",
  "scripts/preregister-assessment-production-score-stability-v2.1.3-score-pass.mjs",
  "scripts/derive-assessment-production-score-stability-v2.1.3-scores.mjs",
  "scripts/validate-assessment-production-score-stability-v2.1.3-scores.mjs",
  "scripts/analyze-assessment-production-score-stability-v2.1.3-scores.mjs",
];
...
const manifest = {
  schemaVersion: "1.0-score-stability-v2.1.3-single-score-pass-manifest",
  protocolId: ledger.protocolId,
  status: "frozen-v2.1.3-single-deterministic-score-pass",
  frozenAt,
...
if (shouldWrite) {
  await mkdir(path.resolve(V213_SCORE_ROOT), { recursive: true });
  await writeFile(
