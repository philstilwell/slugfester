...
const passed =
  ...
  validation.disputedMoves === 197 &&
  validation.candidateSelections === 609 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-06-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-06-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-06-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-06-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
