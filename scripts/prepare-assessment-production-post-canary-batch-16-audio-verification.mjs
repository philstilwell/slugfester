...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-16";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-16-audio-verification";
...
const EXPECTED_DEBATES = ["108", "144", "76", "92"];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-16-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-16-audio-verification-preparation.mjs",
  "scripts/assessment-production-post-canary-batch-16-audio-verification-stage.mjs",
...
assertV4(
  ...
  "Batch 16 audio-verification preparation is not authorized"
);
assertV4(sourcePreparation.clips.length === 10 && work.moves.length === 10, "ten-clip cohort changed");
assertV4(
...
assertV4(calls.length === 10 && references.length === 8, "ten calls and eight references required");
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_16_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-16-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-16-decomposed-consensus",
  status: shouldWrite
    ? "prepared-ten-post-canary-batch-16-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-ten-post-canary-batch-16-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  userAuthorization: {
    ...
    verificationCallsAuthorizedForPreparation: 10,
    speakerReferencesAuthorizedForPreparation: 8,
  ...
  scope: {
    ...
    frozenTargetClips: 10,
    verificationCalls: 10,
    additionalVerificationTargets: 0,
    sameDebateSpeakerSupportReferences: 8,
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 16 exact clip seconds and ten-call count",
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-ten-batch-16-paid-audio-verification-calls-under-standing-authorization"
};
