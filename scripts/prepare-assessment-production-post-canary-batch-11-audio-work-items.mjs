...
import {
  buildAssessmentProductionPostCanaryBatch11AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-11-audio-work-items.mjs";
import {
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-11-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-11-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-11-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 11 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 11 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  analysis.audioWorkload.moves === 2 &&
  ...
  "Batch 11 two-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 11 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 11 exact two-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 2 &&
    sourceSummaries.length === 2 &&
  ...
  "Batch 11 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-11-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_11_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-two-post-canary-batch-11-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-11-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_11_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-and-frozen-two-post-canary-batch-11-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
  developmentValidationOnly: false,
  productionCanary: false,
  batchNumber: 11,
  stagingOnly: true,
  ...
  nextAuthorizedAction:
    "prepare-local-batch-11-source-audio-and-two-frozen-clips-under-standing-authorization"
};
