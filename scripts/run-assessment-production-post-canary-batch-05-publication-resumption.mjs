...
import { runBatch05PublicationResumption } from "./lib/assessment-production-post-canary-batch-05-publication-resumption-workflow.mjs";

const execution = await runBatch05PublicationResumption();
