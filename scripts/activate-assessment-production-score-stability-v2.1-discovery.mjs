...
const SCRIPT =
  "scripts/activate-assessment-production-score-stability-v2.1-discovery.mjs";
const RUNNER =
  "scripts/run-assessment-production-score-stability-v2.1-discovery.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-score-stability-v2.1-discovery.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1-discovery-activation.mjs";
...
const preparation = JSON.parse(await readFile(PREPARATION_MANIFEST, "utf8"));
assertV4(
  preparation.status ===
      "frozen-forty-v2.1-validation-discovery-contexts-prepared-not-authorized" &&
    preparation.contexts.length === 40 &&
  ...
  "discovery activation is not authorized by the frozen preparation manifest"
);
...
const activation = {
  schemaVersion:
    "1.0-score-stability-v2.1-discovery-execution-activation",
  protocolId: preparation.protocolId,
  status: "frozen-forty-v2.1-validation-discovery-contexts-authorized",
  activatedAt,
