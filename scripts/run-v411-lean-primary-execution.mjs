...
for (const context of manifest.contexts) {
  ...
  try {
    const copies = [
      [manifest.modelInputs.workflowBase, "workflow-v40.md"], [manifest.modelInputs.workflowDerivedScores, "workflow-v401.md"], [manifest.modelInputs.workflow, "workflow-v41.md"], [manifest.modelInputs.workflowBurdenIds, "workflow-v411.md"], [manifest.modelInputs.workflowChronology, "workflow-v412.md"], [manifest.modelInputs.workflowConsistency, "workflow-v413.md"], [manifest.modelInputs.workflowBurdenTuple, "workflow-v414.md"],
