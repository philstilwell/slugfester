...
for (const context of manifest.contexts) {
  ...
  try {
    const copies = [
      [manifest.modelInputs.workflowBase, "workflow-v40.md"], [manifest.modelInputs.workflowDerivedScores, "workflow-v401.md"], [manifest.modelInputs.workflow, "workflow-v41.md"], [manifest.modelInputs.workflowBurdenIds, "workflow-v411.md"], [manifest.modelInputs.workflowChronology, "workflow-v412.md"], [manifest.modelInputs.workflowConsistency, "workflow-v413.md"], [manifest.modelInputs.workflowBurdenTuple, "workflow-v414.md"], [manifest.modelInputs.workflowTiming, "workflow-v415.md"],
    ...
    const prompt = `Read workflow-v40.md, workflow-v401.md, workflow-v41.md, workflow-v411.md, workflow-v412.md, workflow-v413.md, workflow-v414.md, workflow-v415.md, rubric-v40.md, rubric-v401.md, rubric-v41.md, manual.md, packet.json, schema.json, transcript.txt, and events.json completely and no other files. The v4.1.5 files govern conflicts. Act only as the fresh isolated bounded primary judge for Debate ${context.debateNumber}. Build four to six genuinely contested sections and the minimum eight-to-twenty-four moves needed to preserve every load-bearing route and decisive exchange, with one or two actual moves per side per section. Do not supply sequence numbers; chronology is repository-derived from source spans. Supply every required route tier. Before submitting, silently run the inherited response, burden-reference, rating-band, and charity consistency checklist over every move and correct the JSON if any tuple fails it. For each non-null burden contact, look up its bridgeId in your own routes, copy that bridge's exact tier, and rate relevance/burden only inside that looked-up tier's band. Do not calculate totals, identify a winner, write publication prose, or supply precision/clarity or epistemic-calibration scalar values. The control selection, comparator, high-effort references, legacy assessments, prior scores, prior winners, and other debates are unavailable. Return exactly one schema-conforming JSON object and no commentary.`;
    process.stdout.write(`\n[v4.1.5-primary] starting ${manifest.model.label}/${manifest.model.reasoningEffort} Debate ${context.debateNumber}\n`);
