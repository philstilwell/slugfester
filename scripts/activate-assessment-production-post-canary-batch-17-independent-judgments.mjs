...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-17-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-17-independent-judgments.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-post-canary-batch-17-independent-judgments.mjs";
const VALIDATOR =
...
assertV4(
  preparation.status ===
    ...
    preparation.executionPolicy.contexts === 8 &&
...
assertV4(
  ...
  "frozen Batch 17 judgment packet preparation drifted"
);
assertV4(
...
const activation = {
  ...
  userAuthorization: {
    scope:
      "activate and execute exactly the eight frozen Batch 17 score-blind independent-judgment contexts under the frozen standing authorization",
