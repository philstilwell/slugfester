...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_03_RENDERING_PROTOCOL_ID &&
    activation.protocolId === POST_CANARY_BATCH_03_RENDERING_PROTOCOL_ID &&
    activation.status ===
      "frozen-post-canary-batch-03-rendering-verification-authorized" &&
  ...
  "valid frozen Batch 3 rendering activation required"
);
if (shouldWrite) {
...
assertV4(
  audit.status === "ten-debate-batch-03-rendering-evidence-passed" &&
    audit.debates === 10 &&
    audit.sections === 53 &&
    audit.moves === 200 &&
  ...
  "passing Batch 3 rendering evidence audit required"
);
...
const renderingAudit = {
  ...audit,
  status: "passed-ten-debate-batch-03-rendering-verification",
  completedAt,
...
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-rendering-verification-execution",
  protocolId: POST_CANARY_BATCH_03_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-03-rendering-verification-passed",
  completedAt,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-rendering-verification-analysis",
  protocolId: POST_CANARY_BATCH_03_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-03-rendering-verification-passed",
