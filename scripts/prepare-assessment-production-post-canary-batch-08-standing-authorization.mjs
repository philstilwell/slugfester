...
import {
  ...
  POST_CANARY_BATCH_08_STANDING_AUTHORIZATION_INSTRUCTION,
  POST_CANARY_BATCH_08_STANDING_AUTHORIZATION_INSTRUCTION_PATH,
  POST_CANARY_BATCH_08_STANDING_AUTHORIZATION_PROTOCOL_ID,
  POST_CANARY_BATCH_08_STANDING_AUTHORIZATION_STATUS,
  validatePostCanaryBatch08StandingAuthorization
...
const SELECTION_FREEZE_COMMIT = "644f7f78599b4063c6054df1a9332bc5377936fc";
const SOURCE_PACKET_COMMIT = "8add15b63fc813d3d9b74565143dfcd136f2b18f";
const SOURCE_FILES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-08-standing-authorization.mjs",
  "scripts/test-assessment-production-post-canary-batch-08-standing-authorization.mjs"
];
const REQUIRED_ORDER = ["88", "194", "137", "08", "65", "140", "156", "120", "118", "145"];
const sha256 = (value) => createHash("sha256").update(value).digest("hex");
const exists = (file) => access(path.resolve(file)).then(() => true, () => false);

assertV4(
  !(await exists(POST_CANARY_BATCH_08_STANDING_AUTHORIZATION)),
  `${POST_CANARY_BATCH_08_STANDING_AUTHORIZATION} already exists`
);
...
assertV4(
  selection.status ===
    ...
    selection.batchNumber === 8 &&
    selection.checkpointCommit ===
      "a3ace6ac65d7d9f0390e79fd808b32a9e09f3209" &&
    ...
    analysis.status ===
      "eighth-post-canary-batch-selection-analysis-passed-awaiting-standing-authorization" &&
  ...
  "the frozen Batch 8 selection or source-packet boundary changed"
);
assertV4(
  execFileSync("git", ["show", `${SELECTION_FREEZE_COMMIT}:${SELECTION}`]).equals(selectionBytes),
  "Batch 8 selection differs from the user-authorized selection commit"
);
...
assertV4(
  ...
  "Batch 8 standing authorization must freeze at the pushed source-packet commit"
);
...
const record = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-standing-authorization",
  protocolId: POST_CANARY_BATCH_08_STANDING_AUTHORIZATION_PROTOCOL_ID,
  status: POST_CANARY_BATCH_08_STANDING_AUTHORIZATION_STATUS,
  authorizedAt,
  ...
  userAuthorization: {
    instruction: POST_CANARY_BATCH_08_STANDING_AUTHORIZATION_INSTRUCTION,
    resolvedAntecedent: "The next approval needed is for the Batch 8 standing authorization and score-blind source-packet preparation.",
    scopeInterpretation: "Create and use a complete-workflow Batch 8 standing authorization for the ten frozen selections, beginning with the separately frozen score-blind source packets, while preserving the established campaign controls and stopping before Batch 9 selection.",
  ...
  nextAuthorizedAction:
    "prepare-validate-freeze-commit-and-push-batch-08-discovery-execution-manifest"
};
validatePostCanaryBatch08StandingAuthorization(record);
if (shouldWrite) {
  await writeFile(
    path.resolve(POST_CANARY_BATCH_08_STANDING_AUTHORIZATION),
