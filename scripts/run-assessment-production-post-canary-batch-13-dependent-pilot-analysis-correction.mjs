...
const analysisPath = `${BATCH_13_DEPENDENT_PILOT_CORRECTION_ROOT}/analysis.json`;
...
assertV4(
  plan.protocolId === BATCH_13_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID &&
    activation.status === "frozen-batch-13-dependent-pilot-analysis-correction-activated" &&
  ...
  "frozen one-shot Batch 13 dependent pilot correction activation required"
);
...
const execution = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-13-dependent-pilot-analysis-correction-execution",
  protocolId: BATCH_13_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID,
  status: "passed-complete-batch-13-production-transaction-after-dependent-pilot-analysis-correction",
  startedAt,
  completedAt,
...
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-13-dependent-pilot-analysis-correction-analysis",
  protocolId: BATCH_13_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID,
  status: "batch-13-production-publication-accepted-after-dependent-pilot-analysis-correction",
