...
const SCRIPT =
  "scripts/activate-assessment-production-score-stability-v2.1.3-inventory-candidate-census-plans.mjs";
const RUNNER =
  "scripts/run-assessment-production-score-stability-v2.1.3-inventory-candidate-census-plans.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-score-stability-v2.1.3-inventory-candidate-census-plans.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.3-inventory-candidate-census-plan-activation.mjs";
...
const activation = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-candidate-census-plan-execution-activation",
  ...
  nextRequiredAction:
    "execute-frozen-v2.1.3-candidate-census-plan-gate-once",
};
