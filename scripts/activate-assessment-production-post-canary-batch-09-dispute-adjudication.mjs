...
const approvedScope =
  "Standing authorization activates exactly the ten frozen Batch 9 score-blind dispute-only adjudication contexts using 5.6 Sol with low reasoning effort through the ChatGPT subscription, the frozen 1→2 scheduler, one attempt per context, no retries or timeout extensions, and a $0 direct incremental cost cap.";
const executionTools = [
  "scripts/activate-assessment-production-post-canary-batch-09-dispute-adjudication.mjs",
  "scripts/run-assessment-production-post-canary-batch-09-dispute-adjudication.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-09-dispute-adjudication.mjs",
  "scripts/test-assessment-production-post-canary-batch-09-dispute-adjudication-gate.mjs"
];
...
assertV4(
  ...
  "Batch 9 adjudication activation is not prepared"
);
assertV4(
  ...
  "Batch 9 standing adjudication authorization changed"
);
assertV4(
  ...
  "Batch 9 model, authentication, score-blindness, or tie boundary changed"
);
assertV4(
...
const activation = {
  ...preparation,
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-09-dispute-only-adjudication-execution-activation",
  status:
  ...
  nextAuthorizedAction:
    "execute-exactly-ten-ramped-post-canary-batch-09-dispute-only-adjudication-contexts-once"
};
assertV4(
  ...
  "Batch 9 execution authorization expanded beyond the user instruction"
);
if (shouldWrite) {
