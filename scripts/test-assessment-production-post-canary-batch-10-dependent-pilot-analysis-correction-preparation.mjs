...
import { BATCH_10_DEPENDENT_PILOT_CORRECTION_ROOT } from "./lib/assessment-production-post-canary-batch-10-dependent-pilot-analysis-correction.mjs";
...
assert.equal(plan.status, "frozen-batch-10-dependent-pilot-analysis-two-file-correction-plan-prepared");
...
assert.equal(analysis.status, "batch-10-dependent-pilot-analysis-correction-plan-freeze-passed");
