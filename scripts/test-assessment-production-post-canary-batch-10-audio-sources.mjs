...
assert.equal(preparation.clips.length, 9);
assert.equal(preparation.totals.sources, 5);
assert.equal(preparation.totals.clips, 9);
...
assert.equal(preparation.userAuthorization.sourceAudioFilesAuthorized, 5);
assert.equal(preparation.userAuthorization.clipsAuthorized, 9);
...
assert.equal(preparation.publicSourceAttemptAudit.length, 5);
assert(
