...
import {
  POST_CANARY_BATCH_06_RENDERING_ORDER,
  POST_CANARY_BATCH_06_RENDERING_PROTOCOL_ID,
  POST_CANARY_BATCH_06_RENDERING_ROOT,
  validatePostCanaryBatch06RenderingPacket,
  validatePostCanaryBatch06RenderingViewportEvidence
} from "./lib/assessment-production-post-canary-batch-06-rendering-verification.mjs";
...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_06_RENDERING_PROTOCOL_ID &&
    activation.protocolId === POST_CANARY_BATCH_06_RENDERING_PROTOCOL_ID &&
    activation.status ===
      "frozen-post-canary-batch-06-rendering-verification-authorized" &&
  ...
  "valid Batch 6 rendering activation required"
);
...
assertV4(
  ...
  "complete passing Batch 6 rendering evidence required"
);
...
console.log(
  JSON.stringify(
    {
      schemaVersion:
        "1.0-assessment-production-post-canary-batch-06-rendering-evidence-audit",
      protocolId: POST_CANARY_BATCH_06_RENDERING_PROTOCOL_ID,
      status: "ten-debate-batch-06-rendering-evidence-passed",
      debates: 10,
      sections: 52,
      moves: 200,
