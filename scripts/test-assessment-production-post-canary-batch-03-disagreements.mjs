...
import { extractAssessmentProductionPostCanaryBatch03Disagreements } from "./lib/assessment-production-post-canary-batch-03-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 3);
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 200);
assert.equal(
