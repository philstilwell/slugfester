...
assertV4(
  ...
  "Batch 17 judgment execution crossed its frozen boundary"
);
const contexts = [];
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-17-independent-judgment-analysis",
  ...
  pairs,
  acceptance: {
    eightValidContexts: execution.validContexts === 8,
  ...
  nextAuthorizedAction: passed
    ...
    : "stop-post-canary-batch-17-independent-judgment-gate-for-audit",
};
if (shouldWrite) {
  await writeFile(
