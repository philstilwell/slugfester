...
const ROOT = "docs/assessment-production/post-canary-continuation-v1/batch-01/independent-judgments";
const PROTOCOL_ID =
  "assessment-production-post-canary-batch-01-independent-judgments";
const INVENTORY_ANALYSIS = "docs/assessment-production/post-canary-continuation-v1/batch-01/inventory-candidate-sharded/inventory-analysis.json";
const INVENTORY_PREPARATION = "docs/assessment-production/post-canary-continuation-v1/batch-01/inventory-candidate-sharded/preparation-manifest.json";
const SOURCE_PREPARATION = "docs/assessment-production/post-canary-continuation-v1/batch-01/source-preparation/preparation-manifest.json";
const SOURCE_VALIDATION = "docs/assessment-production/post-canary-continuation-v1/batch-01/source-preparation/validation.json";
...
const SOURCE_FILES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-01-independent-judgments.mjs",
  "scripts/test-assessment-production-post-canary-batch-01-independent-judgment-preparation.mjs"
];
...
assertV4(
  inventoryAnalysis.status ===
      "post-canary-batch-01-inventory-gate-passed-awaiting-separate-judgment-packet-preparation-approval" &&
    ...
    inventoryAnalysis.totals?.moves === 177 &&
    ...
    inventoryAnalysis.nextAuthorizedAction ===
      "user-approval-required-before-batch-01-independent-judgment-packet-preparation",
  "the Batch 1 inventory gate is not ready for the separately authorized independent-judgment packet preparation"
);
assertV4(
  ...
  "the Batch 1 inventory preparation is unavailable"
);
assertV4(
  ...
  "the Batch 1 source preparation is unavailable"
);
assertV4(
  ...
  "the Batch 1 source validation is unavailable"
);
assertV4(
...
assertV4(
  ...
  "the frozen Batch 1 cohort boundary changed"
);
assertV4(
  inventoryAnalysis.debates.map((debate) => debate.debateNumber).join(",") ===
    EXPECTED_DEBATES.join(","),
  "the passed Batch 1 inventory debate order changed"
);
...
assertV4(
  contexts.reduce((sum, context) => sum + context.moves, 0) === 354,
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-independent-judgment-preparation",
  protocolId: PROTOCOL_ID,
  status: shouldWrite
    ? "twenty-post-canary-batch-01-independent-judgment-contexts-prepared-and-frozen"
    : "preview",
  ...
  userAuthorization: {
    instruction:
      "I approve preparation, validation, freezing, committing, and pushing of exactly twenty Batch 1 score-blind independent-judgment packets and the judgment execution-preparation manifest only, with a direct incremental cost cap of $0. Do not execute judgment models, paid services, audio work, score derivation, publication reconstruction, or production mutation.",
  ...
  nextAuthorizedAction:
    "prepare-post-canary-batch-01-independent-judgment-execution-preparation-manifest-model-free-only",
};
