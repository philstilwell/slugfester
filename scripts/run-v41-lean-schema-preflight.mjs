...
let record;
try {
  const copies = [["workflowBase", "workflow-v40.md"], ["workflowDerivedScores", "workflow-v401.md"], ["workflow", "workflow-v41.md"], ["workflowBurdenIds", "workflow-v411.md"], ["rubricBase", "rubric-v40.md"], ["rubricDerivedScores", "rubric-v401.md"], ["rubric", "rubric-v41.md"], ["manual", "manual.md"], ["packet", "packet.json"], ["schema", "schema.json"], ["transcript", "transcript.txt"], ["events", "events.json"]];
  ...
  const prompt = "Read workflow-v40.md, workflow-v401.md, workflow-v41.md, workflow-v411.md, rubric-v40.md, rubric-v401.md, rubric-v41.md, manual.md, packet.json, schema.json, transcript.txt, and events.json completely and no other files. The v4.1.1 files govern conflicts. Act only as the synthetic isolated v4.1.1 bounded primary judge. Use exactly four sections and all eight substantive events as eight chronological nested moves, one actual move per side in each section. Supply every required route tier. In affectedBurdenIds use only route or bridge IDs declared in the output. Do not calculate totals or write publication prose. Return exactly one schema-conforming JSON object and no commentary.";
