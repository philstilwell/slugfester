...
let record;
try {
  const copies = [["workflowBase", "workflow-v40.md"], ["workflowDerivedScores", "workflow-v401.md"], ["workflow", "workflow-v41.md"], ["workflowBurdenIds", "workflow-v411.md"], ["workflowChronology", "workflow-v412.md"], ["workflowConsistency", "workflow-v413.md"], ["workflowBurdenTuple", "workflow-v414.md"], ["workflowTiming", "workflow-v415.md"], ["rubricBase", "rubric-v40.md"], ["rubricDerivedScores", "rubric-v401.md"], ["rubric", "rubric-v41.md"], ["manual", "manual.md"], ["packet", "packet.json"], ["schema", "schema.json"], ["transcript", "transcript.txt"], ["events", "events.json"]];
  ...
  const prompt = "Read workflow-v40.md, workflow-v401.md, workflow-v41.md, workflow-v411.md, workflow-v412.md, workflow-v413.md, workflow-v414.md, workflow-v415.md, rubric-v40.md, rubric-v401.md, rubric-v41.md, manual.md, packet.json, schema.json, transcript.txt, and events.json completely and no other files. The v4.1.5 files govern conflicts. Act only as the synthetic isolated v4.1.5 bounded primary judge. Use exactly four sections and all eight substantive events as eight nested moves, one actual move per side in each section. Do not supply sequence numbers; chronology is repository-derived from source spans. Supply every required route tier. In affectedBurdenIds use only route or bridge IDs declared in the output. Before submitting, silently run the inherited response, burden-reference, rating-band, and charity consistency checklist over every move and correct the JSON if any tuple fails it. For each non-null burden contact, look up its bridgeId in your own routes, copy that bridge's exact tier, and rate relevance/burden only inside that looked-up tier's band. Do not calculate totals or write publication prose. Return exactly one schema-conforming JSON object and no commentary.";
