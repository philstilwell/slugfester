...
let record;
try {
  const copies = [["workflowBase", "workflow-v40.md"], ["workflowDerivedScores", "workflow-v401.md"], ["workflow", "workflow-v41.md"], ["workflowBurdenIds", "workflow-v411.md"], ["workflowChronology", "workflow-v412.md"], ["rubricBase", "rubric-v40.md"], ["rubricDerivedScores", "rubric-v401.md"], ["rubric", "rubric-v41.md"], ["manual", "manual.md"], ["packet", "packet.json"], ["schema", "schema.json"], ["transcript", "transcript.txt"], ["events", "events.json"]];
