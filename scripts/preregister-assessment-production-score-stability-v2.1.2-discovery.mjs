...
const PROTOCOL_ID =
  "assessment-production-score-stability-v2.1.2-fresh-validation-discovery";
const WORKFLOW = "docs/assessment-production-canary-discovery-workflow.md";
const SCRIPT =
  "scripts/preregister-assessment-production-score-stability-v2.1.2-discovery.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.2-discovery.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.ownershipBoundedSchemas === 33 &&
    preparation.totals.boundedEndSchemas === 33 &&
    preparation.totals.modelEndEventRequiringSchemas === 33 &&
    preparation.totals.requestedTokenProhibitingSchemas === 33 &&
    preparation.totals.deterministicTokenMinimumContexts === 33 &&
    preparation.totals.speakerAllowlistedSchemas === 33 &&
  ...
  "v2.1.2 source preparation does not authorize discovery-manifest preparation"
);
assertV4(
...
for (const debate of preparation.contexts) {
  ...
  assertV4(
    packet.modelInputBoundary.scoreBlindDiscoveryOnly === true &&
      ...
      packet.modelInputBoundary.requestedLexicalTokensProhibited ===
        true &&
...
assertV4(contexts.length === 33, "discovery must contain exactly 33 contexts");
...
const manifest = {
  schemaVersion:
    "1.0-score-stability-v2.1.2-discovery-execution-preparation-manifest",
  ...
  costEstimate: {
    ...
    estimateBasis:
      "Scaled from the realized v2.1.1 42-context run and this cohort's 33-context copied-input distribution; subscription use has no direct incremental API charge.",
  },
