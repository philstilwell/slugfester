...
const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-02/independent-judgments";
...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-02-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-02-independent-judgments.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-post-canary-batch-02-independent-judgments.mjs";
const VALIDATOR =
  "scripts/validate-assessment-production-post-canary-batch-02-independent-judgment.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-02-independent-judgment-activation.mjs";
...
assertV4(
  ...
  "Batch 2 independent-judgment activation prerequisites drifted"
);
assertV4(
  ...
  "frozen Batch 2 judgment packet preparation drifted"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-independent-judgment-execution-activation",
  protocolId: preparation.protocolId,
  status:
    "frozen-twenty-post-canary-batch-02-independent-judgment-contexts-authorized",
  activatedAt,
  ...
  userAuthorization: {
    ...
    approvedScope:
      "Activate and execute exactly the twenty frozen Batch 2 score-blind independent-judgment contexts using 5.6 Sol with low reasoning effort through the ChatGPT subscription, with a direct incremental cost cap of $0. Use the frozen 1→2 scheduler, one attempt per context, no retries, and no timeout extensions, then stop after deterministic judgment validation, compilation, analysis, commit, and push. Do not extract disagreements, run audio or adjudication, derive scores, reconstruct publication, use paid services, mutate production, or select the next batch.",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-02-independent-judgment-gate-once",
};
if (shouldWrite) {
