...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-12/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(preparation.totals.uniqueMoves, 204);
assert.equal(preparation.totals.movesJudgedAcrossPasses, 408);
