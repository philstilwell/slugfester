...
import { extractAssessmentProductionPostCanaryBatch16Disagreements } from "./lib/assessment-production-post-canary-batch-16-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 16);
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 194);
assert.equal(
