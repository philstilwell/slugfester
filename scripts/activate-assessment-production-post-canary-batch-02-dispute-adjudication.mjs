...
const activationPath =
  `${POST_CANARY_BATCH_02_DISPUTE_ADJ_ROOT}/execution-activation.json`;
const userInstruction = "I approve.";
const approvedScope =
  "I approve activation and execution of exactly the ten frozen Batch 2 score-blind dispute-only adjudication contexts using 5.6 Sol with low reasoning effort through my ChatGPT subscription, with a direct incremental cost cap of $0. Use the frozen 1→2 scheduler, one attempt per context, and no retries. Stop after deterministic adjudication validation, analysis, committing, and pushing. Do not run judgment models, use paid services, assemble final ledgers, derive scores, reconstruct publication, mutate production, or select the next batch.";
const executionTools = [
  "scripts/activate-assessment-production-post-canary-batch-02-dispute-adjudication.mjs",
  "scripts/run-assessment-production-post-canary-batch-02-dispute-adjudication.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-02-dispute-adjudication.mjs",
  "scripts/test-assessment-production-post-canary-batch-02-dispute-adjudication-gate.mjs"
];
...
assertV4(
  ...
  "Batch 2 adjudication activation is not prepared"
);
assertV4(
  ...
  "Batch 2 model, authentication, score-blindness, or tie boundary changed"
);
assertV4(
...
const activation = {
  ...preparation,
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-dispute-only-adjudication-execution-activation",
  status:
    "frozen-ten-post-canary-batch-02-dispute-only-adjudication-contexts-authorized",
  authorizedAt,
  ...
  nextAuthorizedAction:
    "execute-exactly-ten-ramped-post-canary-batch-02-dispute-only-adjudication-contexts-once"
};
assertV4(
  ...
  "Batch 2 execution authorization expanded beyond the user instruction"
);
if (shouldWrite) {
