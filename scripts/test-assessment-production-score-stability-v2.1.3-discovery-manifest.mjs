...
const MANIFEST =
  "docs/assessment-production/score-stability-v2.1.3-validation-cohort/discovery/execution-preparation-manifest.json";
...
assert.deepEqual(manifest.costEstimate.expectedParallelWallMinutes, [14, 28]);
