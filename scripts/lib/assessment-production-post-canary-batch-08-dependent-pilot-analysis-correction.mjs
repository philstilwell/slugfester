...
export const BATCH_08_DEPENDENT_PILOT_CORRECTION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-08/production-publication/generated-seo-correction/dependent-pilot-analysis-correction";
export const BATCH_08_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-08-dependent-pilot-analysis-correction";
export const BATCH_08_DEPENDENT_PILOT_OUTPUT_PATHS = Object.freeze([
...
export async function runIsolatedBatch08DependentPilotAnalysis(repositoryRoot) {
  const temporaryRoot = await mkdtemp(path.join(tmpdir(), "slugfester-batch-08-pilot-"));
  try {
    ...
    const outputs = await Promise.all(
      BATCH_08_DEPENDENT_PILOT_OUTPUT_PATHS.map(async (relativePath) => {
