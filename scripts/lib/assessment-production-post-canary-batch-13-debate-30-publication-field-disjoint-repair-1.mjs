...
export const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-13/publication-reconstruction/original-unattempted-context-resumption-3/debate-30-field-disjoint-repair-1";
export const PROTOCOL_ID =
  "assessment-production-post-canary-batch-13-debate-30-publication-field-disjoint-repair-1";
export const OUTPUT_VERSION =
  "1.0-assessment-production-post-canary-batch-13-publication-field-disjoint-repair-output";
...
export const DEBATE_PLANS = Object.freeze([
  Object.freeze({ debateNumber: "30", critiqueShardSizes: Object.freeze([1, 2, 2, 2, 2, 2, 2, 2, 1]) })
]);
...
export function buildFieldDisjointRepairSchema(packet) {
  return {
    ...
    $id: `slugfester-batch-13-debate-30-field-disjoint-repair-${packet.contextIndex}`,
    title: `Batch 13 Debate 30 field-disjoint repair ${packet.shardId}`,
    type: "object",
