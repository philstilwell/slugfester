...
export const POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-11/production-publication/generated-seo-correction";
export const POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-11-generated-seo-derivative-correction";
export const POST_CANARY_BATCH_11_GENERATED_SEO_OUTPUT_COUNT = 380;
export const POST_CANARY_BATCH_11_GENERATOR_INPUT_PATHS = Object.freeze([
  "package.json",
...
export async function runIsolatedBatch11SeoGenerator(repositoryRoot) {
  const temporaryRoot = await mkdtemp(
    path.join(tmpdir(), "slugfester-batch-11-seo-")
  );
  try {
    for (const relativePath of POST_CANARY_BATCH_11_GENERATOR_INPUT_PATHS) {
    ...
    const excluded = new Set(POST_CANARY_BATCH_11_GENERATOR_INPUT_PATHS);
