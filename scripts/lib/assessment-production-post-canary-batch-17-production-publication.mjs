...
export const POST_CANARY_BATCH_17_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-17/production-publication";
export const POST_CANARY_BATCH_17_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-17-production-publication";
export const POST_CANARY_BATCH_17_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "77",
  "44",
  "171",
  "62"
