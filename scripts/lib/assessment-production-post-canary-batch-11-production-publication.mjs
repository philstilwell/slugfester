...
export const POST_CANARY_BATCH_11_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-11/production-publication";
export const POST_CANARY_BATCH_11_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-11-production-publication";
export const POST_CANARY_BATCH_11_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "54",
  "01",
  "82",
  "191",
