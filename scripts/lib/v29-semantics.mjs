...
export function deriveTargetDisposition(annotation) {
  if (annotation.exclusiveObjectSubstitution) return "substituted";
  return annotation.originalTargetContact ? "preserved" : "unaddressed";
}

export function deriveCoverage(annotation) {
  if (annotation.exclusiveObjectSubstitution) return "substitution";
...
export function deriveBurdenRelevance(challengeCase, annotation) {
  ...
  if (!route || packet.primaryRouteId === null) return "unadopted-or-irrelevant";
...
export function derivedTuple(challengeCase, annotation) {
  return {
    ...
    scopeRelation: annotation.scopeRelation,
    ...
    burdenRelevance: deriveBurdenRelevance(challengeCase, annotation),
  };
}
