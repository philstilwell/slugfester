...
export const POST_CANARY_BATCH_03_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-03/production-publication";
export const POST_CANARY_BATCH_03_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-03-production-publication";
export const POST_CANARY_BATCH_03_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "124",
  "14",
  "58",
  "150",
