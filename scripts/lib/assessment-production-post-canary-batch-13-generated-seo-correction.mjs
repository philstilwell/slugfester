...
export const POST_CANARY_BATCH_13_GENERATED_SEO_CORRECTION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-13/production-publication/generated-seo-correction";
export const POST_CANARY_BATCH_13_GENERATED_SEO_CORRECTION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-13-generated-seo-derivative-correction";
export const POST_CANARY_BATCH_13_GENERATED_SEO_OUTPUT_COUNT = 380;
export const POST_CANARY_BATCH_13_GENERATOR_INPUT_PATHS = Object.freeze([
  "package.json",
...
export async function runIsolatedBatch13SeoGenerator(repositoryRoot) {
  const temporaryRoot = await mkdtemp(
    path.join(tmpdir(), "slugfester-batch-13-seo-")
  );
  try {
    for (const relativePath of POST_CANARY_BATCH_13_GENERATOR_INPUT_PATHS) {
    ...
    const excluded = new Set(POST_CANARY_BATCH_13_GENERATOR_INPUT_PATHS);
