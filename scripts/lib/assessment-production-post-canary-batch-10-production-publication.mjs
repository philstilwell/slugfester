...
export const POST_CANARY_BATCH_10_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-10/production-publication";
export const POST_CANARY_BATCH_10_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-10-production-publication";
export const POST_CANARY_BATCH_10_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "21",
  "74",
  "107",
  "142",
