...
export const BATCH_04_DEPENDENT_PILOT_CORRECTION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-04/production-publication/generated-seo-correction/dependent-pilot-analysis-correction";
export const BATCH_04_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-04-dependent-pilot-analysis-correction";
export const BATCH_04_DEPENDENT_PILOT_OUTPUT_PATHS = Object.freeze([
...
export async function runIsolatedBatch04DependentPilotAnalysis(repositoryRoot) {
  const temporaryRoot = await mkdtemp(path.join(tmpdir(), "slugfester-batch-04-pilot-"));
  try {
    ...
    const outputs = await Promise.all(
      BATCH_04_DEPENDENT_PILOT_OUTPUT_PATHS.map(async (relativePath) => {
