...
export const POST_CANARY_BATCH_06_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-06/production-publication";
export const POST_CANARY_BATCH_06_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-06-production-publication";
export const POST_CANARY_BATCH_06_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "73",
  "36",
  "38",
  "97",
