...
export const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-13/publication-reconstruction/original-unattempted-context-resumption-2/debate-70-field-disjoint-repair-1";
export const PROTOCOL_ID =
  "assessment-production-post-canary-batch-13-debate-70-publication-field-disjoint-repair-1";
...
export const DEBATE_PLANS = Object.freeze([
  Object.freeze({ debateNumber: "70", critiqueShardSizes: Object.freeze([2, 2, 1]) })
]);
...
export function buildFieldDisjointRepairSchema(packet) {
  return {
    ...
    $id: `slugfester-batch-13-debate-70-field-disjoint-repair-${packet.contextIndex}`,
    title: `Batch 13 Debate 70 field-disjoint repair ${packet.shardId}`,
    type: "object",
