...
export const POST_CANARY_BATCH_06_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-06";
export const POST_CANARY_BATCH_06_STANDING_AUTHORIZATION =
  `${POST_CANARY_BATCH_06_ROOT}/standing-authorization.json`;
export const POST_CANARY_BATCH_06_STANDING_AUTHORIZATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-06-standing-authorization";
export const POST_CANARY_BATCH_06_STANDING_AUTHORIZATION_STATUS =
  "frozen-active-batch-06-complete-remaining-workflow-standing-authorization";
export const POST_CANARY_BATCH_06_STANDING_AUTHORIZATION_INSTRUCTION_PATH =
  POST_CANARY_BATCH_06_ROOT + "/standing-authorization-instruction.txt";
export const POST_CANARY_BATCH_06_STANDING_AUTHORIZATION_INSTRUCTION = readFileSync(
  path.resolve(POST_CANARY_BATCH_06_STANDING_AUTHORIZATION_INSTRUCTION_PATH),
  "utf8"
).trimEnd();

const sha256 = (value) => createHash("sha256").update(value).digest("hex");

export function validatePostCanaryBatch06StandingAuthorization(record) {
  assertV4(
    ...
    "Batch 6 standing-authorization identity changed"
  );
  assertV4(
    canonicalJson(record.selectedDebates) ===
      canonicalJson(["73", "36", "38", "97", "141", "06", "168", "135", "143", "169"]),
    "Batch 6 standing-authorization debate boundary changed"
  );
  assertV4(
    ...
    "Batch 6 standing-authorization model changed"
  );
  assertV4(
    ...
    "Batch 6 standing-authorization execution controls changed"
  );
  assertV4(
  ...
  assertV4(
    ...
    "Batch 6 standing-authorization cost boundary changed"
  );
  assertV4(
    Object.values(record.stopRules ?? {}).every(Boolean),
    "Batch 6 standing-authorization stop rule disabled"
  );
  assertV4(
    ...
    "Batch 6 standing-authorization recovery controls changed"
  );
  return record;
}

export async function loadAndValidatePostCanaryBatch06StandingAuthorization() {
  const bytes = await readFile(
    path.resolve(POST_CANARY_BATCH_06_STANDING_AUTHORIZATION)
  );
  const record = validatePostCanaryBatch06StandingAuthorization(JSON.parse(bytes));
