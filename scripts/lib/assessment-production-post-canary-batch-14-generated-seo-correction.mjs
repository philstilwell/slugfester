...
import { sha256 } from "./assessment-production-post-canary-batch-14-production-publication.mjs";

export const POST_CANARY_BATCH_14_GENERATED_SEO_CORRECTION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-14/production-publication/generated-seo-correction";
export const POST_CANARY_BATCH_14_GENERATED_SEO_CORRECTION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-14-generated-seo-derivative-correction";
export const POST_CANARY_BATCH_14_GENERATED_SEO_OUTPUT_COUNT = 380;
export const POST_CANARY_BATCH_14_GENERATOR_INPUT_PATHS = Object.freeze([
  "package.json",
...
export async function runIsolatedBatch14SeoGenerator(repositoryRoot) {
  const temporaryRoot = await mkdtemp(
    path.join(tmpdir(), "slugfester-batch-14-seo-")
  );
  try {
    for (const relativePath of POST_CANARY_BATCH_14_GENERATOR_INPUT_PATHS) {
    ...
    const excluded = new Set(POST_CANARY_BATCH_14_GENERATOR_INPUT_PATHS);
