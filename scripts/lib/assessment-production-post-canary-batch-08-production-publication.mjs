...
export const POST_CANARY_BATCH_08_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-08/production-publication";
export const POST_CANARY_BATCH_08_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-08-production-publication";
export const POST_CANARY_BATCH_08_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "88",
  "194",
  "137",
  "08",
