...
export const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-12/publication-reconstruction/failure-recovery/original-unattempted-context-resumption-1/field-disjoint-repair-2";
export const PROTOCOL_ID =
  "assessment-production-post-canary-batch-12-publication-field-disjoint-repair-2";
...
export const DEBATE_PLANS = Object.freeze([
  Object.freeze({ debateNumber: "28", critiqueShardSizes: Object.freeze([1]) })
]);
