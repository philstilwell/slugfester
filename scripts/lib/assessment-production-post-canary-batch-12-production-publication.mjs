...
export const POST_CANARY_BATCH_12_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-12/production-publication";
export const POST_CANARY_BATCH_12_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-12-production-publication";
export const POST_CANARY_BATCH_12_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "152",
  "28",
  "119",
  "116",
