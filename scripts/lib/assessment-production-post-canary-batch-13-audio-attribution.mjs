...
export const ROOT = "docs/assessment-production/post-canary-continuation-v1/batch-13/audio-verification/audio-attribution-recovery";
export const PROTOCOL_ID = "assessment-production-post-canary-batch-13-audio-attribution-recovery";
export const OUTPUT_VERSION = "1.0-assessment-production-post-canary-batch-13-audio-attribution-output";
export const PACKET_VERSION = "1.0-assessment-production-post-canary-batch-13-audio-attribution-packet";
...
export function makeSchema(packet) {
  ...
  return {
    ...
    $id: `slugfester-batch-13-audio-attribution-${packet.debateNumber}`,
    title: `Slugfester Batch 13 isolated audio-attribution recovery for Debate ${packet.debateNumber}`,
    type: "object",
    additionalProperties: false,
