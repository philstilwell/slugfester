...
import {
  ...
  POST_CANARY_BATCH_09_PUBLICATION_DISCLOSURE,
  POST_CANARY_BATCH_09_PUBLICATION_MODEL,
  POST_CANARY_BATCH_09_PUBLICATION_OUTPUT_VERSION,
...
export const POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_RECOVERY_ROOT =
  `${POST_CANARY_BATCH_09_PUBLICATION_ROOT}/resumption-1/recovery-1`;
export const POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_RECOVERY_PROTOCOL_ID =
  "assessment-production-post-canary-batch-09-publication-resumption-1-timeout-recovery-1";
export const POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_RECOVERY_DEBATES =
  Object.freeze(["166", "183", "112", "17"]);
export const POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_SHARD_PACKET_VERSION =
  "1.0-assessment-production-post-canary-batch-09-publication-timeout-recovery-shard-packet";
export const POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_SHARD_OUTPUT_VERSION =
  "1.0-assessment-production-post-canary-batch-09-publication-timeout-recovery-shard-output";
...
export function buildPublicationTimeoutRecoveryShardSchema(packet) {
  const original = buildPostCanaryBatch09PublicationSchema(
  ...
  return {
    ...
    $id:
      `slugfester-batch-09-publication-timeout-recovery-${packet.debateNumber}-${packet.shardId}`,
    title:
      `Batch 9 Debate ${packet.debateNumber} publication timeout recovery ${packet.shardId}`,
    type: "object",
    additionalProperties: false,
    required: [
      "schemaVersion",
    ...
    properties: {
      schemaVersion: {
        type: "string",
        const: POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_SHARD_OUTPUT_VERSION
      },
      protocolId: {
        type: "string",
        const: POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_RECOVERY_PROTOCOL_ID
      },
...
export function validatePublicationTimeoutRecoveryShardOutput(output, packet) {
  ...
  assertV4(
    output.schemaVersion ===
        POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_SHARD_OUTPUT_VERSION &&
      output.protocolId ===
        POST_CANARY_BATCH_09_PUBLICATION_TIMEOUT_RECOVERY_PROTOCOL_ID &&
      ...
      output.assessmentModel === POST_CANARY_BATCH_09_PUBLICATION_MODEL.label &&
...
export function mergeAndValidatePublicationTimeoutRecoveryDebate({
  ...
  const merged = {
    schemaVersion: POST_CANARY_BATCH_09_PUBLICATION_OUTPUT_VERSION,
    ...
    assessmentModel: POST_CANARY_BATCH_09_PUBLICATION_MODEL.label,
    ...
    aiExtension: {
      aiGenerated: true,
      disclaimer: POST_CANARY_BATCH_09_PUBLICATION_DISCLOSURE,
    ...
    displayContract: {
      ...
      byline: POST_CANARY_BATCH_09_PUBLICATION_BYLINE,
  ...
  const validation = validatePostCanaryBatch09PublicationOutput(
    merged,
    publicationPacket
  );
