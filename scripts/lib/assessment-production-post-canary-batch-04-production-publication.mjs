...
export const POST_CANARY_BATCH_04_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-04/production-publication";
export const POST_CANARY_BATCH_04_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-04-production-publication";
export const POST_CANARY_BATCH_04_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "127",
  "67",
  "85",
  "49",
