...
export const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-11/publication-reconstruction/failure-recovery/field-disjoint-repair-1";
export const PROTOCOL_ID =
  "assessment-production-post-canary-batch-11-publication-field-disjoint-repair-1";
export const OUTPUT_VERSION =
  "1.0-assessment-production-post-canary-batch-11-publication-field-disjoint-repair-output";
...
export const DEBATE_PLANS = Object.freeze([
  Object.freeze({ debateNumber: "191", critiqueShardSizes: Object.freeze([1]) }),
  Object.freeze({ debateNumber: "151", critiqueShardSizes: Object.freeze([1]) }),
  Object.freeze({
    debateNumber: "60",
    critiqueShardSizes: Object.freeze([2, 2, 2, 2, 2, 2, 2, 2, 2, 1])
  }),
  Object.freeze({
    debateNumber: "43",
    critiqueShardSizes: Object.freeze([2, 2, 2, 2, 2, 1])
  })
]);
...
export function buildFieldDisjointRepairSchema(packet) {
  return {
    ...
    $id: `slugfester-batch-11-field-disjoint-repair-${packet.contextIndex}`,
    title: `Batch 11 Debate ${packet.debateNumber} field-disjoint repair ${packet.shardId}`,
    type: "object",
