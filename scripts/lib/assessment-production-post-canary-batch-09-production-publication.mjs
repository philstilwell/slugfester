...
export const POST_CANARY_BATCH_09_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-09/production-publication";
export const POST_CANARY_BATCH_09_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-09-production-publication";
export const POST_CANARY_BATCH_09_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "170",
  "134",
  "19",
  "114",
