...
export const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-12/publication-reconstruction/failure-recovery/field-disjoint-repair-1";
export const PROTOCOL_ID =
  "assessment-production-post-canary-batch-12-publication-field-disjoint-repair-1";
...
export const DEBATE_PLANS = Object.freeze([
  Object.freeze({ debateNumber: "152", critiqueShardSizes: Object.freeze([2, 1]) })
]);
