...
export const POST_CANARY_BATCH_10_PUBLICATION_COMPILATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-10/deterministic-publication-compilation";
export const POST_CANARY_BATCH_10_PUBLICATION_COMPILATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-10-deterministic-publication-compilation";
export const POST_CANARY_BATCH_10_PUBLICATION_COMPILATION_ORDER = Object.freeze(
  [...POST_CANARY_BATCH_10_PUBLICATION_DEBATES]);

export function compilePostCanaryBatch10PublicationStagingRecord({ output, packet, identity }) {
  validatePostCanaryBatch10PublicationOutput(output, packet);
...
export function validatePostCanaryBatch10CompiledStagingRecord({ compiled, output, packet, identity }) {
  const expected = compilePostCanaryBatch10PublicationStagingRecord({ output, packet, identity });
