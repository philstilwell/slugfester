...
export const POST_CANARY_BATCH_10_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-10/publication-reconstruction";
export const POST_CANARY_BATCH_10_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-10-publication-reconstruction";
export const POST_CANARY_BATCH_10_PUBLICATION_PACKET_VERSION =
  "1.0-assessment-production-post-canary-batch-10-publication-packet";
export const POST_CANARY_BATCH_10_PUBLICATION_OUTPUT_VERSION =
  "1.0-assessment-production-post-canary-batch-10-publication-output";
export const POST_CANARY_BATCH_10_PUBLICATION_MODEL =
  CHECKPOINT_V22_PUBLICATION_MODEL;
export const POST_CANARY_BATCH_10_PUBLICATION_BYLINE =
  CHECKPOINT_V22_PUBLICATION_BYLINE;
export const POST_CANARY_BATCH_10_PUBLICATION_DISCLOSURE =
  CHECKPOINT_V22_PUBLICATION_DISCLOSURE;
export const POST_CANARY_BATCH_10_PUBLICATION_DEBATES = Object.freeze([
  "21",
  "74",
  "107",
  "142",
...
export const postCanaryBatch10ReferenceCatalog =
  checkpointV22ReferenceCatalog;
...
export function buildPostCanaryBatch10PublicationPacket(input) {
  return {
    ...buildCheckpointV22PublicationPacket(input),
    schemaVersion: POST_CANARY_BATCH_10_PUBLICATION_PACKET_VERSION,
    protocolId: POST_CANARY_BATCH_10_PUBLICATION_PROTOCOL_ID,
    productionCanary: false
  };
}

export function buildPostCanaryBatch10PublicationSchema(packet) {
  const schema = buildCheckpointV22PublicationSchema(
    toCheckpointV22PublicationPacket(packet)
  );
  schema.$id =
    `slugfester-post-canary-batch-10-publication-${packet.debateNumber}`;
  schema.title =
    `Slugfester post-canary Batch 10 publication Debate ${packet.debateNumber}`;
