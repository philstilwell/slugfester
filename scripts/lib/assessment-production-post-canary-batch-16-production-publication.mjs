...
export const POST_CANARY_BATCH_16_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-16/production-publication";
export const POST_CANARY_BATCH_16_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-16-production-publication";
export const POST_CANARY_BATCH_16_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "16",
  "108",
  "164",
  "144",
