...
export const POST_CANARY_BATCH_14_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-14";
export const POST_CANARY_BATCH_14_STANDING_AUTHORIZATION =
  `${POST_CANARY_BATCH_14_ROOT}/standing-authorization.json`;
export const POST_CANARY_BATCH_14_STANDING_AUTHORIZATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-14-standing-authorization";
export const POST_CANARY_BATCH_14_STANDING_AUTHORIZATION_STATUS =
  "frozen-active-batch-14-complete-remaining-workflow-standing-authorization";
export const POST_CANARY_BATCH_14_STANDING_AUTHORIZATION_INSTRUCTION_PATH =
  POST_CANARY_BATCH_14_ROOT + "/standing-authorization-instruction.txt";
export const POST_CANARY_BATCH_14_STANDING_AUTHORIZATION_INSTRUCTION = readFileSync(
  path.resolve(POST_CANARY_BATCH_14_STANDING_AUTHORIZATION_INSTRUCTION_PATH),
  "utf8"
).trimEnd();

const sha256 = (value) => createHash("sha256").update(value).digest("hex");

export function validatePostCanaryBatch14StandingAuthorization(record) {
  assertV4(
    record?.schemaVersion ===
      ...
      record.status === POST_CANARY_BATCH_14_STANDING_AUTHORIZATION_STATUS &&
      record.productionCanary === false &&
      record.batchNumber === 14 &&
      record.sourcePacketCommit === "308977929ec1f96d09508c23fdf85f3c19257930" &&
    ...
    "Batch 14 standing-authorization identity changed"
  );
  assertV4(
    canonicalJson(record.selectedDebates) ===
      canonicalJson(["53", "69", "110", "133", "12", "187", "160", "55", "106", "57"]),
    "Batch 14 standing-authorization debate boundary changed"
  );
  assertV4(
    ...
    "Batch 14 standing-authorization model changed"
  );
  assertV4(
    ...
    "Batch 14 standing-authorization execution controls changed"
  );
  assertV4(
  ...
  assertV4(
    ...
    "Batch 14 standing-authorization cost boundary changed"
  );
  assertV4(
    ...
    "Batch 14 standing-authorization source-recovery controls changed"
  );
  assertV4(
    Object.values(record.stopRules ?? {}).every(Boolean),
    "Batch 14 standing-authorization stop rule disabled"
  );
  assertV4(
    ...
    "Batch 14 standing-authorization recovery controls changed"
  );
  assertV4(
    ...
    "Batch 14 atomic-shard preservation-gap standing authorization changed"
  );
  assertV4(
    ...
    "Batch 14 standing-authorization Git controls changed"
  );
  return record;
}

export async function loadAndValidatePostCanaryBatch14StandingAuthorization() {
  const bytes = await readFile(
    path.resolve(POST_CANARY_BATCH_14_STANDING_AUTHORIZATION)
  );
  const record = validatePostCanaryBatch14StandingAuthorization(JSON.parse(bytes));
