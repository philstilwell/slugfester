...
export const POST_CANARY_BATCH_07_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-07/production-publication";
export const POST_CANARY_BATCH_07_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-07-production-publication";
export const POST_CANARY_BATCH_07_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "193",
  "80",
  "121",
  "100",
