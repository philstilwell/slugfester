...
export const POST_CANARY_BATCH_15_PRODUCTION_PUBLICATION_ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-15/production-publication";
export const POST_CANARY_BATCH_15_PRODUCTION_PUBLICATION_PROTOCOL_ID =
  "assessment-production-post-canary-batch-15-production-publication";
export const POST_CANARY_BATCH_15_PRODUCTION_PUBLICATION_ORDER = Object.freeze([
  "39",
  "48",
  "23",
  "162",
