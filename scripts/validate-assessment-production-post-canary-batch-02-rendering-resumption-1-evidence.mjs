...
import {
  ...
  validatePostCanaryBatch02RenderingViewportEvidence
...
assertV4(
  ...
  "complete passing Batch 2 rendering resumption-1 evidence required"
);
...
console.log(
  JSON.stringify(
    {
      schemaVersion:
        "1.0-assessment-production-post-canary-batch-02-rendering-resumption-1-evidence-audit",
      protocolId: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_PROTOCOL_ID,
      status: "ten-debate-batch-02-rendering-resumption-1-evidence-passed",
      debates: 10,
      sections: 51,
      moves: 190,
      viewportResults: 20,
