...
import { sha256 } from "./lib/assessment-production-post-canary-batch-03-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-03-generated-seo-correction-pass-activated");
