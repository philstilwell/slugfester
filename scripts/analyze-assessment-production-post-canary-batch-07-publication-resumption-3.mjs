...
assertV4(e.contextsPlanned === 5 && e.attempts === e.contextsAttempted && e.retries === 0 &&
...
try {
  ...
  if (e.contextsAttempted === 5 && e.validContexts === 5 && e.invalidContexts === 0 &&
...
const analysis = { schemaVersion:
    "1.0-assessment-production-post-canary-batch-07-publication-resumption-3-analysis",
  protocolId: a.protocolId, status: passed
    ? "batch-07-complete-ten-debate-publication-reconstruction-cohort-passed"
    : "batch-07-publication-resumption-3-or-cohort-validation-failed",
  productionCanary: false, batchNumber: 7, stagingOnly: true,
  execution: { contextsPlanned: 5, contextsAttempted: e.contextsAttempted,
  ...
  nextAuthorizedAction: passed ? "prepare-and-execute-one-deterministic-batch-07-publication-compilation-pass"
    : "stop-after-failed-batch-07-publication-resumption-3-output" };
