...
import {
  ...
  canonicalBridges, deriveTargetDisposition, diagnosticObjectEligible, equal, validateSpan,
} from "./lib/v281-semantics.mjs";

const passArgument = process.argv[2];
if (!passArgument) throw new Error("Usage: node scripts/validate-v281-development-pass.mjs <pass-or-key.json>");
const root = process.cwd();
const inputPath = "docs/calibration/v2.8/development/attempt-2/challenge-input.json";
const schemaPath = "docs/calibration/v2.8/development/attempt-2/challenge-annotation-schema.json";
const workflowPath = "docs/assessment-workflow-v2.8.1.md";
const rubricPath = "docs/reassessment-rubric-v2.8.1.md";
const manualPath = "docs/calibration/v2.8/development/attempt-2/annotation-manual.md";
...
assert(pass.schemaVersion === "2.8.1-development-challenge-pass" && pass.workflowVersion === input.workflowVersion && pass.rubricVersion === input.rubricVersion && ["A", "B", "KEY"].includes(pass.pass) && pass.model === "5.6 Sol" && pass.calibrationOnly === true, "pass identity invalid");
...
const expectedMethod = pass.pass === "KEY" ? "fresh-independent-v2.8.1-key-readjudication" : "fresh-isolated-v2.8.1-development-challenge";
...
exactKeys(pass.audit, ["caseCount", "allCasesAnnotatedOnce", "componentSetErrors", "evidenceErrors", "diagnosticEligibilityErrors", "derivedFieldsPresent", "scoreFieldsPresent"], "audit");
assert(pass.audit.caseCount === input.caseCount && pass.audit.allCasesAnnotatedOnce === true && pass.audit.componentSetErrors === 0 && pass.audit.evidenceErrors === 0 && pass.audit.diagnosticEligibilityErrors === 0 && pass.audit.derivedFieldsPresent === false && pass.audit.scoreFieldsPresent === false, "pass audit invalid");
