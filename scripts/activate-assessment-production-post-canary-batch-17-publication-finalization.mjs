...
import { POST_CANARY_BATCH_17_PUBLICATION_FINALIZATION_PROTOCOL_ID,
...
assertV4(p.status === "frozen-post-canary-batch-17-publication-finalization-prepared" &&
  p.protocolId === POST_CANARY_BATCH_17_PUBLICATION_FINALIZATION_PROTOCOL_ID && p.contexts?.length === 4 &&
...
"Batch 17 finalization is not prepared");
...
const activation = { schemaVersion: "1.0-assessment-production-post-canary-batch-17-publication-finalization-activation",
  protocolId: p.protocolId, status: "frozen-post-canary-batch-17-publication-finalization-authorized",
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-17-deterministic-publication-finalization-pass" };
