...
assertV4(
  activation.status === "frozen-one-context-two-field-batch-13-debate-20-publication-repair-activated" &&
...
const execution = {
  ...
  protocolId: activation.protocolId,
  status: passed
    ? "one-field-disjoint-batch-13-debate-20-publication-repair-context-passed"
    : "one-field-disjoint-batch-13-debate-20-publication-repair-context-completed-with-failure",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-merge-and-validate-debate-20-then-prepare-six-unattempted-contexts"
