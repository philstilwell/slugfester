...
import { POST_CANARY_BATCH_14_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-14-score-gate.mjs";
...
const analysisPath = `${POST_CANARY_BATCH_14_SCORE_ROOT}/analysis.json`;
