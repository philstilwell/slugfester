...
assert.equal(work.batchNumber, 4);
assert.equal(work.stagingOnly, true);
assert.equal(preparation.userAuthorization.workItemsAuthorized, 4);
assert.equal(
...
assert.equal(preparation.validation.exactAuthorizedMoveCount, 4);
assert.equal(
