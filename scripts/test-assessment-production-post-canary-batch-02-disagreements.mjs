...
import { extractAssessmentProductionPostCanaryBatch02Disagreements } from "./lib/assessment-production-post-canary-batch-02-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 2);
