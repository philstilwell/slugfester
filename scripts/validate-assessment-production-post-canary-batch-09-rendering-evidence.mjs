...
import {
  POST_CANARY_BATCH_09_RENDERING_ORDER,
  POST_CANARY_BATCH_09_RENDERING_PROTOCOL_ID,
  POST_CANARY_BATCH_09_RENDERING_ROOT,
  validatePostCanaryBatch09RenderingPacket,
  validatePostCanaryBatch09RenderingViewportEvidence
} from "./lib/assessment-production-post-canary-batch-09-rendering-verification.mjs";
...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_09_RENDERING_PROTOCOL_ID &&
    activation.protocolId === POST_CANARY_BATCH_09_RENDERING_PROTOCOL_ID &&
    activation.status ===
      "frozen-post-canary-batch-09-rendering-verification-authorized" &&
  ...
  "valid Batch 9 rendering activation required"
);
...
assertV4(
  ...
  "complete passing Batch 9 rendering evidence required"
);
...
console.log(
  JSON.stringify(
    {
      schemaVersion:
        "1.0-assessment-production-post-canary-batch-09-rendering-evidence-audit",
      protocolId: POST_CANARY_BATCH_09_RENDERING_PROTOCOL_ID,
      status: "ten-debate-batch-09-rendering-evidence-passed",
      debates: 10,
      sections: 51,
      moves: 180,
