...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-14";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-14-audio-verification";
...
const EXPECTED_DEBATES = ["53", "110", "133", "12", "187", "106", "57"];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-14-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-14-audio-verification-preparation.mjs",
  "scripts/assessment-production-post-canary-batch-14-audio-verification-stage.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-14-audio-sources.mjs",
  "scripts/test-assessment-production-post-canary-batch-14-audio-sources.mjs"
];
...
assertV4(
  ...
  "Batch 14 audio-verification preparation is not authorized"
);
assertV4(sourcePreparation.clips.length === 12 && work.moves.length === 12, "twelve-clip cohort changed");
assertV4(
...
assertV4(calls.length === 12 && references.length === 14, "twelve calls and fourteen references required");
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_14_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-14-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-14-decomposed-consensus",
  status: shouldWrite
    ? "prepared-twelve-post-canary-batch-14-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-twelve-post-canary-batch-14-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  userAuthorization: {
    ...
    verificationCallsAuthorizedForPreparation: 12,
    speakerReferencesAuthorizedForPreparation: 14,
  ...
  scope: {
    ...
    frozenTargetClips: 12,
    verificationCalls: 12,
    additionalVerificationTargets: 0,
    sameDebateSpeakerSupportReferences: 14,
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 14 exact clip seconds and twelve-call count",
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-twelve-batch-14-paid-audio-verification-calls-under-standing-authorization"
};
