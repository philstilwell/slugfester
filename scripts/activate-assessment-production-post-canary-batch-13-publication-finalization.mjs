...
import { POST_CANARY_BATCH_13_PUBLICATION_FINALIZATION_PROTOCOL_ID,
  POST_CANARY_BATCH_13_PUBLICATION_FINALIZATION_ROOT } from
...
assertV4(p.status === "frozen-post-canary-batch-13-publication-finalization-prepared" &&
  p.protocolId === POST_CANARY_BATCH_13_PUBLICATION_FINALIZATION_PROTOCOL_ID && p.contexts?.length === 10 &&
...
"Batch 13 finalization is not prepared");
...
const activation = { schemaVersion: "1.0-assessment-production-post-canary-batch-13-publication-finalization-activation",
  protocolId: p.protocolId, status: "frozen-post-canary-batch-13-publication-finalization-authorized",
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-13-deterministic-publication-finalization-pass" };
