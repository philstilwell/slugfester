...
const localRoot =
  "output/transcribe/assessment-production-post-canary-batch-15-audio-verification";
...
const SOURCE_FORMATS = Object.freeze({
  "SEZu7Ej2SzU": "bestaudio/best",
  "dto5DQ7GBEQ": "bestaudio/best",
  "Vs7ArUMuQyg": "bestaudio/best"
});
const TOOL_SOURCES = [
...
assertV4(
  ...
  "Batch 15 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
...
assertV4(
  grouped.size === 3,
  "expected exactly three Batch 15 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-three-post-canary-batch-15-local-audio-sources-three-clips",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-15-audio-source-preparation",
