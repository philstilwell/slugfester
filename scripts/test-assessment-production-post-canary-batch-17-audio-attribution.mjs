...
import { AUDIT, ISOLATION, MODEL, OUTPUT_VERSION, PROTOCOL_ID, ROOT, validateOutput } from "./lib/assessment-production-post-canary-batch-17-audio-attribution.mjs";

const preparation = JSON.parse(await readFile(`${ROOT}/preparation-manifest.json`, "utf8"));
const authorization = JSON.parse(await readFile("docs/assessment-production/post-canary-continuation-v1/batch-17/audio-verification/audio-attribution-successor-authorization.json", "utf8"));
