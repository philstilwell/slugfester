...
import { validateSourceAdjudicationOutput } from "./lib/v381-source-execution.mjs";

const [outputPath, packetPath, schemaPath] = process.argv.slice(2);
if (!outputPath || !packetPath || !schemaPath) {
  console.error("Usage: node scripts/validate-v381-source-adjudication.mjs OUTPUT PACKET SCHEMA");
  process.exit(1);
}
