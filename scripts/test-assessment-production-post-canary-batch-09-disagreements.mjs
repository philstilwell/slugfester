...
import { extractAssessmentProductionPostCanaryBatch09Disagreements } from "./lib/assessment-production-post-canary-batch-09-disagreement.mjs";
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 180);
assert.equal(
