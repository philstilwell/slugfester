...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-13";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-13-audio-verification";
...
const EXPECTED_DEBATES = ["70", "37", "111"];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-13-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-13-audio-verification-preparation.mjs",
  "scripts/assessment-production-post-canary-batch-13-audio-verification-stage.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-13-audio-sources.mjs",
  "scripts/test-assessment-production-post-canary-batch-13-audio-sources.mjs"
];
...
assertV4(
  sourcePreparation.status ===
      "prepared-eight-post-canary-batch-13-local-audio-clips-standing-authorization-active-for-audio-verification-preparation" &&
    sourcePreparation.authorization.audioVerificationManifestPreparation &&
    sourcePreparation.nextAuthorizedAction ===
      "prepare-freeze-validate-and-push-batch-13-audio-verification-manifest-and-cost-estimate-under-standing-authorization",
  "Batch 13 audio-verification preparation is not authorized"
);
assertV4(sourcePreparation.clips.length === 8 && work.moves.length === 8, "eight-clip cohort changed");
assertV4(
...
assertV4(calls.length === 8 && references.length === 6, "eight calls and six references required");
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_13_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-13-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-13-decomposed-consensus",
  status: shouldWrite
    ? "prepared-eight-post-canary-batch-13-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-eight-post-canary-batch-13-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 13 exact clip seconds and eight-call count",
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-eight-batch-13-paid-audio-verification-calls-under-standing-authorization"
};
