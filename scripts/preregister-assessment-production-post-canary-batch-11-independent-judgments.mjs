...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-11-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-11-independent-judgment-manifest.mjs";
...
assertV4(
  ...
  "Batch 11 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 11 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 11 exact-source compatibility boundary drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-11-independent-judgment-execution-preparation-manifest",
