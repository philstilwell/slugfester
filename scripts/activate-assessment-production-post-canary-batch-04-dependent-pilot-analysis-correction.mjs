...
import { BATCH_04_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID, BATCH_04_DEPENDENT_PILOT_CORRECTION_ROOT } from "./lib/assessment-production-post-canary-batch-04-dependent-pilot-analysis-correction.mjs";
...
assertV4(
  plan.protocolId === BATCH_04_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID &&
    plan.status === "frozen-batch-04-dependent-pilot-analysis-two-file-correction-plan-prepared" &&
    analysis.status === "batch-04-dependent-pilot-analysis-correction-plan-freeze-passed" &&
    analysis.plan.sha256 === sha256(await readBytes(planPath)),
  "frozen Batch 4 dependent pilot correction plan required"
);
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-04-dependent-pilot-analysis-correction-activation",
  protocolId: BATCH_04_DEPENDENT_PILOT_CORRECTION_PROTOCOL_ID,
  status: "frozen-batch-04-dependent-pilot-analysis-correction-activated",
  activatedAt,
  batchNumber: 4,
  ...
  nextAuthorizedAction: "execute-one-batch-04-dependent-pilot-analysis-correction-no-retries"
};
if (shouldWrite) {
