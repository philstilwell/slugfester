...
const passed =
  ...
  validation.finalMoves === 187 &&
  validation.disputedMoves === 177 &&
  validation.candidateSelections === 527 &&
  roundedMeanPopulation === 411 &&
  validation.audioVerifiedMoves === 6 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-05-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-05-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-05-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-05-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
