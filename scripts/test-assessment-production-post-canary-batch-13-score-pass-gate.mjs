...
import { POST_CANARY_BATCH_13_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-13-score-gate.mjs";
...
const analysisPath = `${POST_CANARY_BATCH_13_SCORE_ROOT}/analysis.json`;
