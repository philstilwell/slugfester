...
const SCRIPT =
  "scripts/prepare-assessment-production-checkpoint-v2.2-inventory-chronology-fallback-side-packets.mjs";
const TEST =
  "scripts/test-assessment-production-checkpoint-v2.2-inventory-chronology-fallback-side-packets.mjs";
const PROTOCOL_ID =
...
const manifest = {
  schemaVersion:
    "1.0-production-checkpoint-v2.2-chronology-fallback-side-packet-preparation",
  ...
  gateDisposition: structuredClone(
    sourcePreparation.gateDisposition
  ),
