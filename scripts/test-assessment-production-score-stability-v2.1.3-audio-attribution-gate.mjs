...
assert.equal(
  manifest.status,
  "frozen-one-v2.1.3-audio-attribution-context-authorized"
);
...
assert.equal(analysis.preservedDeterministicGate.verified, 4);
...
if (analysis.status === "v2.1.3-audio-attribution-adjudication-passed") {
