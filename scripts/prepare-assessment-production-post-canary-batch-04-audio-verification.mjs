...
const mediaRoot =
  "output/transcribe/assessment-production-post-canary-batch-04-audio-verification";
...
const EXPECTED_DEBATES = ["49", "186", "81"];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-04-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-04-audio-verification-preparation.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-04-audio-sources.mjs",
  "scripts/test-assessment-production-post-canary-batch-04-audio-sources.mjs"
];
...
assertV4(
  sourcePreparation.status ===
      "prepared-four-post-canary-batch-04-local-audio-clips-standing-authorization-active-for-audio-verification-preparation" &&
    sourcePreparation.authorization.audioVerificationManifestPreparation &&
    sourcePreparation.nextAuthorizedAction ===
      "prepare-freeze-validate-and-push-batch-04-audio-verification-manifest-and-cost-estimate-under-standing-authorization",
  "Batch 4 audio-verification preparation is not authorized"
);
assertV4(
  sourcePreparation.clips.length === 4 && work.moves.length === 4,
  "Batch 4 four-clip population changed"
);
assertV4(
  JSON.stringify(
  ...
  "Batch 4 exact audio-verification population changed"
);
...
assertV4(
  references.length === 6 && calls.length === 4,
  "Batch 4 requires six frozen references and four calls"
);
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-04-decomposed-consensus",
  status: shouldWrite
    ? "prepared-four-post-canary-batch-04-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-four-post-canary-batch-04-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  costEstimate: {
    ...
    primaryEstimateBasis:
      "Batch 2 returned-token usage rates applied to Batch 4 exact clip seconds and four-call count",
    ...
    officialPricingCheckedAt: "2026-08-21",
