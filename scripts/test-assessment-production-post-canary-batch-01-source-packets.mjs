...
const ROOT = "docs/assessment-production/post-canary-continuation-v1/batch-01/source-preparation";
...
assert.equal(preparation.status, "post-canary-batch-01-ten-complete-score-blind-source-packets-prepared-awaiting-validation");
...
for (const context of preparation.contexts) {
  ...
  assert(frozen, `${context.debateNumber}: absent from frozen Batch 1 selection`);
  ...
  assert.equal(packet.schemaVersion, "1.0-assessment-production-post-canary-batch-01-score-blind-source-packet");
...
const validation = {
  ...
  status: "post-canary-batch-01-score-blind-source-packet-validation-passed-frozen-awaiting-user-approval-before-any-model-execution",
