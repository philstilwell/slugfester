...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-01-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-01-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 177 &&
    preparation.totals.movesJudgedAcrossPasses === 354 &&
  ...
  "Batch 1 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 1 gate disposition or score-blind inventory contract drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-independent-judgment-execution-preparation-manifest",
