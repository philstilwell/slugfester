...
const ledgerPath = "docs/calibration/v2.8/development/attempt-2/selection-ledger.json";
...
assert(input.schemaVersion === "2.8.1-development-challenge-input" && input.workflowVersion === "Slugfester Reassessment Workflow v2.8.1" && input.rubricVersion === "Slugfester Reassessment Rubric v2.8.1", "input identity invalid");
...
console.log(JSON.stringify({ status: "passed", kind: "v2.8.1-development-input", caseCount: input.caseCount, laneCounts: input.laneCounts, inputSha256: sha256(inputText), ledgerSha256: sha256(ledgerText) }, null, 2));
