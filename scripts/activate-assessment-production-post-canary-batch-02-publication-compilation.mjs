...
assertV4(
  ...
  "the Batch 2 deterministic publication compilation is not prepared"
);
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-deterministic-publication-compilation-execution-activation",
  ...
  nextRequiredAction:
    "execute-one-frozen-batch-02-deterministic-publication-compilation-pass"
};
