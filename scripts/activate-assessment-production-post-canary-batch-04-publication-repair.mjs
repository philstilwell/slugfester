...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_04_DEBATE_127_REPAIR_PROTOCOL_ID &&
    preparation.status ===
  ...
  "the Debate 127 repair execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-debate-127-publication-repair-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-two-frozen-debate-127-publication-repair-contexts-once"
};
