...
assert.equal(manifest.contexts[0].candidateSelections, 60);
...
console.log(JSON.stringify({ status: "passed-debate-185-correction-preparation",
  contexts: 1, candidateSelections: 60, directIncrementalCostUsdMaximum: 0 }, null, 2));
