...
const ROOT =
  "docs/assessment-production/post-canary-continuation-v1/batch-14/independent-judgments";
...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-14-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-14-independent-judgments.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-post-canary-batch-14-independent-judgments.mjs";
const VALIDATOR =
  "scripts/validate-assessment-production-post-canary-batch-14-independent-judgment.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-14-independent-judgment-activation.mjs";
...
assertV4(
  preparation.status ===
      "frozen-twenty-post-canary-batch-14-independent-judgment-contexts-prepared-not-authorized" &&
    ...
    preparation.nextAuthorizedAction ===
      "freeze-and-activate-batch-14-independent-judgment-execution-under-standing-authorization",
  "Batch 14 independent-judgment activation prerequisites drifted"
);
assertV4(
  ...
  "frozen Batch 14 judgment packet preparation drifted"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-independent-judgment-execution-activation",
  protocolId: preparation.protocolId,
  status:
    "frozen-twenty-post-canary-batch-14-independent-judgment-contexts-authorized",
  activatedAt,
  ...
  userAuthorization: {
    scope:
      "activate and execute exactly the twenty frozen Batch 14 score-blind independent-judgment contexts under the frozen standing authorization",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-14-independent-judgment-gate-once",
};
if (shouldWrite) {
