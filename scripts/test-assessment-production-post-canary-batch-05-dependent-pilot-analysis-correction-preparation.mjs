...
assert.equal(plan.status, "frozen-batch-05-dependent-pilot-analysis-two-file-correction-plan-prepared");
...
assert.equal(analysis.status, "batch-05-dependent-pilot-analysis-correction-plan-freeze-passed");
