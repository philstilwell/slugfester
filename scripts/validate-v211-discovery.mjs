...
import { validateV211Discovery } from "./lib/assessment-production-score-stability-v2.1.1-discovery.mjs";
...
assertV4(
  ...
  "usage: validate-v211-discovery.mjs OUTPUT PREPARATION DEBATE_NUMBER CHUNK_ID"
);
...
const validation = validateV211Discovery(JSON.parse(outputBytes), {
  ...
  JSON.stringify(
    {
      ...
      repositoryMaterializedSourceWindows:
        validation.repositoryMaterializedSourceWindows,
      modelAuthoredEndEvents: validation.modelAuthoredEndEvents,
