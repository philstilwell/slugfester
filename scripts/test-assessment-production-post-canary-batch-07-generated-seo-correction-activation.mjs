...
import { sha256 } from "./lib/assessment-production-post-canary-batch-07-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-07-generated-seo-correction-pass-activated");
