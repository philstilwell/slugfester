...
import {
  POST_CANARY_BATCH_11_FINAL_LEDGER_PROTOCOL_ID,
  POST_CANARY_BATCH_11_FINAL_LEDGER_ROOT,
  buildPostCanaryBatch11FinalLedger,
...
const manifestPath =
  `${POST_CANARY_BATCH_11_FINAL_LEDGER_ROOT}/final-ledger-manifest.json`;
const ledgerPath = `${POST_CANARY_BATCH_11_FINAL_LEDGER_ROOT}/final-ledger.json`;
const analysisPath = `${POST_CANARY_BATCH_11_FINAL_LEDGER_ROOT}/analysis.json`;
if (shouldWrite) {
...
const preview = buildPostCanaryBatch11FinalLedger(
  inputs.debateInputs,
  inputs.sourceHashes
);
const validation = validatePostCanaryBatch11FinalLedger(
  preview,
  inputs.debateInputs,
  inputs.sourceHashes
);
const expected = {
  ...
  pairSelections: 199,
  scoringFieldSelections: 288,
  burdenAdjustmentSelections: 20,
  roundedMeanPopulation: 438,
...
assertV4(
  ...
  "post-canary Batch 11 final-ledger preview population mismatch"
);
...
const sourceFiles = [
  ...
  "scripts/preregister-assessment-production-post-canary-batch-11-final-ledger.mjs",
  "scripts/assemble-assessment-production-post-canary-batch-11-final-ledger.mjs",
  "scripts/validate-assessment-production-post-canary-batch-11-final-ledger.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-11-final-ledger.mjs",
  "scripts/test-assessment-production-post-canary-batch-11-final-ledger.mjs"
];
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-11-final-ledger-assembly-manifest",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 11 standing authorization permits deterministic final-ledger assembly and the single repository score pass while every gate passes.",
    scopeReference:
      "docs/assessment-production/post-canary-continuation-v1/batch-11/standing-authorization.json",
  ...
  nextAuthorizedAction:
    "assemble-and-validate-ten-post-canary-batch-11-final-ledgers-deterministically"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_11_FINAL_LEDGER_ROOT), {
    recursive: true
  });
  await writeFile(
