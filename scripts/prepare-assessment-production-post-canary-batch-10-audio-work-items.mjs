...
import {
  buildAssessmentProductionPostCanaryBatch10AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-10-audio-work-items.mjs";
import {
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 10 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 10 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  analysis.audioWorkload.moves === 9 &&
  ...
  "Batch 10 nine-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 10 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 10 exact nine-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 9 &&
  ...
  "Batch 10 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_10_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-nine-post-canary-batch-10-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_10_DISAGREEMENT_PROTOCOL_ID,
  status:
