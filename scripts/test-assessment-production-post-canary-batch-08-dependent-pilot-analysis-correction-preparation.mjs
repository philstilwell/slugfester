...
import { BATCH_08_DEPENDENT_PILOT_CORRECTION_ROOT } from "./lib/assessment-production-post-canary-batch-08-dependent-pilot-analysis-correction.mjs";
...
assert.equal(plan.status, "frozen-batch-08-dependent-pilot-analysis-two-file-correction-plan-prepared");
...
assert.equal(analysis.status, "batch-08-dependent-pilot-analysis-correction-plan-freeze-passed");
