...
assertV4(e.contextsPlanned === 6 && e.attempts === e.contextsAttempted && e.retries === 0 &&
...
try {
  ...
  if (e.contextsAttempted === 6 && e.validContexts === 6 && e.invalidContexts === 0 &&
...
const analysis = { schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-publication-resumption-2-analysis",
  protocolId: a.protocolId, status: passed
    ? "batch-08-complete-ten-debate-publication-reconstruction-cohort-passed"
    : "batch-08-publication-resumption-2-or-cohort-validation-failed",
  productionCanary: false, batchNumber: 8, stagingOnly: true,
  execution: { contextsPlanned: 6, contextsAttempted: e.contextsAttempted,
  ...
  nextAuthorizedAction: passed ? "prepare-and-execute-one-deterministic-batch-08-publication-compilation-pass"
    : "stop-after-failed-batch-08-publication-resumption-2-output" };
