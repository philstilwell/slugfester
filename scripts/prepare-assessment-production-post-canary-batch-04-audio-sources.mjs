...
assertV4(
  ...
  "Batch 4 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
...
assertV4(
  grouped.size === 3,
  "expected exactly three Batch 4 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-three-post-canary-batch-04-local-audio-sources-four-clips",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-audio-source-preparation",
