...
assertV4(
  ...
  "usage: validate-assessment-production-checkpoint-v2.2-independent-judgment.mjs JUDGMENT PREPARATION DEBATE PASS [--write]"
);
...
assertV4(
  ...
  "production checkpoint v2.2 independent-judgment preparation unavailable"
);
...
const summary = {
  schemaVersion:
    "1.0-production-checkpoint-v2.2-independent-judgment-validation",
