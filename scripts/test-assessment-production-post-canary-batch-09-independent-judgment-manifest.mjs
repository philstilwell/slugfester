...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-09/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(preparation.totals.uniqueMoves, 180);
assert.equal(preparation.totals.movesJudgedAcrossPasses, 360);
