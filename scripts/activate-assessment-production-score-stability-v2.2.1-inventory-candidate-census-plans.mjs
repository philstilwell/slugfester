...
const SCRIPT =
  "scripts/activate-assessment-production-score-stability-v2.2.1-inventory-candidate-census-plans.mjs";
const RUNNER =
  "scripts/run-assessment-production-score-stability-v2.2.1-inventory-candidate-census-plans.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-score-stability-v2.2.1-inventory-candidate-census-plans.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.2.1-inventory-candidate-census-plan-activation.mjs";
