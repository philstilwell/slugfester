...
assertV4(
  ...
  "valid frozen Batch 4 rendering activation required"
);
if (shouldWrite) {
...
assertV4(
  audit.status === "ten-debate-batch-04-rendering-evidence-passed" &&
    audit.debates === 10 &&
    audit.sections === 53 &&
    audit.moves === 203 &&
  ...
  "passing Batch 4 rendering evidence audit required"
);
...
const renderingAudit = {
  ...audit,
  status: "passed-ten-debate-batch-04-rendering-verification",
  completedAt,
...
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-rendering-verification-execution",
  protocolId: POST_CANARY_BATCH_04_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-04-rendering-verification-passed",
  completedAt,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-rendering-verification-analysis",
  protocolId: POST_CANARY_BATCH_04_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-04-rendering-verification-passed",
