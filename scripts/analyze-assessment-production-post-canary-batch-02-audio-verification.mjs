...
assert(manifest.status === "frozen-ten-post-canary-batch-02-paid-known-speaker-diarizations-authorized", "Batch 2 audio activation unavailable");
...
const status = passed
  ? "passed-all-ten-post-canary-batch-02-confidence-moves-audio-verified"
  : executionComplete
    ? "post-canary-batch-02-audio-verification-unresolved"
    : "post-canary-batch-02-audio-verification-incomplete";
const nextAuthorizedAction = execution.costCapReachedOrExceeded || !execution.directIncrementalCostCapControlPassed
  ? "user-review-required-before-any-batch-02-downstream-work-after-audio-cost-cap-event"
  : passed
    ? "user-approval-required-before-batch-02-dispute-only-adjudication-packet-preparation"
    : "user-approval-required-before-batch-02-audio-verification-failure-diagnosis";
