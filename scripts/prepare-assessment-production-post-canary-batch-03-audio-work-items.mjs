...
import {
  buildAssessmentProductionPostCanaryBatch03AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-03-audio-work-items.mjs";
import {
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-03-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-03-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-03-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 3 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 3 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  ...
  "Batch 3 eight-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 3 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 3 exact eight-move audio queue was not reproduced"
);
assertV4(
  ...
  "Batch 3 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_03_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-eight-post-canary-batch-03-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_03_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-and-frozen-eight-post-canary-batch-03-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
  developmentValidationOnly: false,
  productionCanary: false,
  batchNumber: 3,
  stagingOnly: true,
  ...
  nextAuthorizedAction:
    "prepare-local-batch-03-source-audio-and-eight-frozen-clips-under-standing-authorization"
};
