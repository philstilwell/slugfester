...
const PROTOCOL_ID = "assessment-production-score-stability-v2.1.3-fresh-validation-independent-judgments";
const INVENTORY_ANALYSIS = "docs/assessment-production/score-stability-v2.1.3-validation-cohort/inventory-chronology-fallback/inventory-analysis.json";
const INVENTORY_PREPARATION = "docs/assessment-production/score-stability-v2.1.3-validation-cohort/inventory-chronology-fallback/preparation-manifest.json";
const SOURCE_PREPARATION = "docs/assessment-production/score-stability-v2.1.3-validation-cohort/source-preparation/preparation-manifest.json";
...
const SOURCE_FILES = [
  ...
  "scripts/prepare-assessment-production-score-stability-v2.1.3-independent-judgments.mjs",
  "scripts/test-assessment-production-score-stability-v2.1.3-independent-judgment-preparation.mjs"
];
...
assertV4(
  inventoryAnalysis.status ===
      "v2.1.3-chronology-fallback-inventory-gate-passed-independent-judgment-packet-preparation-authorized" &&
    ...
    inventoryAnalysis.totals?.moves === 189 &&
    ...
    inventoryAnalysis.nextAuthorizedAction ===
      "prepare-and-freeze-twenty-v2.1.3-independent-judgment-packets-model-free-only",
  "the inventory gate does not authorize v2.1.3 independent-judgment packet preparation"
);
assertV4(
  ...
  "the v2.1.3 inventory preparation is unavailable"
);
assertV4(
  ...
  "the v2.1.3 source preparation is unavailable"
);
assertV4(
...
assertV4(
  cohortSelection.status ===
    ...
    cohortSelection.developmentValidationOnly === true &&
    cohortSelection.productionCanary === false &&
  ...
  "the frozen v2.1.3 cohort boundary changed"
);
assertV4(
...
assertV4(
  contexts.reduce((sum, context) => sum + context.moves, 0) === 378,
...
const preparation = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-independent-judgment-preparation",
