...
assert.equal(manifest.acceptedSourceBoundary.allTenAudioMovesVerified, true);
assert.equal(manifest.acceptedSourceBoundary.audioValidationOverlaysPreserved, 2);
