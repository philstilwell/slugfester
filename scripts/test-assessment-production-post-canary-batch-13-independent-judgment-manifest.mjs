...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-13/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(preparation.totals.uniqueMoves, 199);
assert.equal(preparation.totals.movesJudgedAcrossPasses, 398);
