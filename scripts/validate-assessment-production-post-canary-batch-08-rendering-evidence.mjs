...
import {
  POST_CANARY_BATCH_08_RENDERING_ORDER,
  POST_CANARY_BATCH_08_RENDERING_PROTOCOL_ID,
  POST_CANARY_BATCH_08_RENDERING_ROOT,
  validatePostCanaryBatch08RenderingPacket,
  validatePostCanaryBatch08RenderingViewportEvidence
} from "./lib/assessment-production-post-canary-batch-08-rendering-verification.mjs";
...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_08_RENDERING_PROTOCOL_ID &&
    activation.protocolId === POST_CANARY_BATCH_08_RENDERING_PROTOCOL_ID &&
    activation.status ===
      "frozen-post-canary-batch-08-rendering-verification-authorized" &&
  ...
  "valid Batch 8 rendering activation required"
);
...
assertV4(
  ...
  "complete passing Batch 8 rendering evidence required"
);
...
console.log(
  JSON.stringify(
    {
      schemaVersion:
        "1.0-assessment-production-post-canary-batch-08-rendering-evidence-audit",
      protocolId: POST_CANARY_BATCH_08_RENDERING_PROTOCOL_ID,
      status: "ten-debate-batch-08-rendering-evidence-passed",
      debates: 10,
      sections: 51,
      moves: 182,
