...
import { validateV376DOutput } from "./lib/v376d-burden-contact.mjs";

const [outputPath, packetPath, schemaPath] = process.argv.slice(2);
if (!outputPath || !packetPath || !schemaPath) throw new Error("usage: validate-v376d-burden-contact-output.mjs OUTPUT PACKET SCHEMA");
...
validateV376DOutput(output, packet, schema);
