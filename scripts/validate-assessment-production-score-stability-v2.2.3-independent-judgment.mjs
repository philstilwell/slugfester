...
assertV4(
  ...
  "usage: validate-assessment-production-score-stability-v2.2.3-independent-judgment.mjs JUDGMENT PREPARATION DEBATE PASS [--write]"
);
...
assertV4(
  ...
  "v2.2.3 independent-judgment preparation unavailable"
);
...
const summary = {
  schemaVersion:
    "1.0-score-stability-v2.2.3-independent-judgment-validation",
