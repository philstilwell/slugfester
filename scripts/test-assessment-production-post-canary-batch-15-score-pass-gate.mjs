...
import { POST_CANARY_BATCH_15_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-15-score-gate.mjs";
...
const analysisPath = `${POST_CANARY_BATCH_15_SCORE_ROOT}/analysis.json`;
