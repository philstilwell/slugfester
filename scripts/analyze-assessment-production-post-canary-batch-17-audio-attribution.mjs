...
import { PROTOCOL_ID, ROOT, validateOutput } from "./lib/assessment-production-post-canary-batch-17-audio-attribution.mjs";

const shouldWrite = process.argv.includes("--write");
const base = "docs/assessment-production/post-canary-continuation-v1/batch-17/audio-verification";
...
assert.equal(execution.status, "batch-17-audio-attribution-recovery-execution-passed");
...
const combined = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-17-combined-audio-verification",
  protocolId: PROTOCOL_ID,
  status: passed ? "post-canary-batch-17-combined-audio-verification-passed" : "post-canary-batch-17-combined-audio-verification-unresolved",
  ...
  totals: { requiredMoves: 1, deterministicallyVerified: 0, attributionAdjudicatedVerified: recoveredVerified, verified: recoveredVerified, unresolved: recoveredUnresolved, verificationRate: recoveredVerified, paidDiarizationCallsCompleted: 1, paidDiarizationRetries: 0, additionalPaidTranscriptionCalls: 0, additionalDirectIncrementalCostUsd: 0, usageDerivedEstimatedPaidDiarizationCostUsd: originalAudit.totals.usageDerivedEstimatedCostUsd, scoresDerived: 0 },
...
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-17-audio-attribution-recovery-analysis",
  protocolId: PROTOCOL_ID,
  status: passed ? "batch-17-audio-attribution-recovery-passed" : "batch-17-audio-attribution-recovery-unresolved",
  productionCanary: false,
  batchNumber: 17,
  stagingOnly: true,
