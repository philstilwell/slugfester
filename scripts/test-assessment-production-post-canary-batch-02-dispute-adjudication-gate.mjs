...
assert.equal(analysis.evidenceBoundary.audioTranscriptInputs, 10);
...
if (
  ...
  assert.equal(analysis.gate.disputedMovesDecided, 182);
  assert.equal(analysis.gate.candidateSelections, 535);
  assert.equal(
