...
assertV4(
  activation.status === "frozen-five-context-nine-field-batch-13-debate-34-publication-repair-activated" &&
    activation.authorization?.modelExecution === true && activation.contexts?.length === 5 &&
...
const execution = {
  ...
  protocolId: activation.protocolId,
  status: passed
    ? "five-field-disjoint-batch-13-debate-34-publication-repair-contexts-passed"
    : "five-field-disjoint-batch-13-debate-34-publication-repair-contexts-completed-with-failure",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-merge-and-validate-debate-34-then-replay-complete-cohort"
