...
assert.equal(analysis.evidenceBoundary.audioTranscriptInputs, 8);
...
if (
  ...
  assert.equal(analysis.gate.disputedMovesDecided, 191);
  assert.equal(analysis.gate.candidateSelections, 541);
  assert.equal(
