...
const passed =
  ...
  validation.disputedMoves === 181 &&
  validation.candidateSelections === 539 &&
  roundedMeanPopulation === 394 &&
  validation.audioVerifiedMoves === 12 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-14-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-14-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-14-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
