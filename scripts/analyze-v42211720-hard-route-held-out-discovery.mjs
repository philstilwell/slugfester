...
assertV4(
  execution.status === "twenty-hard-route-held-out-discovery-contexts-passed"
...
const analysis = {
  schemaVersion: "4.2.21.17.20-hard-route-held-out-discovery-analysis",
  protocolId: manifest.protocolId,
  status: "hard-route-held-out-discovery-passed-independent-judgment-packet-preparation-authorized",
  ...
  audit: {
    ...
    operationalCanaryStatus: manifest.operationalCanary.status,
    operationalCanaryAgeAtFreezeMs: manifest.operationalCanary.ageAtFreezeMs,
    ...
    frozenInterlocutorSpeakerAllowlist: manifest.schemaHardening.frozenInterlocutorSpeakerAllowlist,
