...
const root = "docs/assessment-production/post-canary-continuation-v1/batch-10/dispute-only-adjudication/failure-recovery/resumption";
...
assertV4(prep.status ===
  "frozen-seven-post-canary-batch-10-dispute-only-adjudication-resumption-contexts-prepared" &&
  prep.contexts.length === 7 && prep.executionPolicy.attemptsPerContext === 1 &&
...
const activation = {
  ...prep,
  schemaVersion: "1.0-assessment-production-post-canary-batch-10-dispute-only-adjudication-resumption-activation",
  status: "frozen-seven-post-canary-batch-10-dispute-only-adjudication-resumption-contexts-authorized",
  authorizedAt,
  ...
  nextAuthorizedAction: "execute-seven-unattempted-batch-10-adjudication-contexts-once"
};
...
console.log(JSON.stringify({ status: shouldWrite ? "frozen-authorized" : "preview",
  contexts: 7, schedulerRamp: [1,2], attemptsPerContext: 1, retriesMaximum: 0,
