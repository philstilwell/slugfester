...
const SCRIPT =
  "scripts/activate-assessment-production-score-stability-v2.1.2-discovery.mjs";
const RUNNER =
  "scripts/run-assessment-production-score-stability-v2.1.2-discovery.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-score-stability-v2.1.2-discovery.mjs";
const VALIDATOR = "scripts/validate-v212-discovery.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.2-discovery-activation.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.contexts.length === 33 &&
...
const activation = {
  schemaVersion:
    "1.0-score-stability-v2.1.2-discovery-execution-activation",
  ...
  nextRequiredAction: "execute-frozen-v2.1.2-discovery-gate-once",
};
