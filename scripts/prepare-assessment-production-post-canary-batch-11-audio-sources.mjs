...
const localRoot =
  "output/transcribe/assessment-production-post-canary-batch-11-audio-verification";
...
assertV4(
  ...
  "Batch 11 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
  ...
  "Batch 11 audio work-item population changed"
);
assertV4(
  sha256(workBytes) === workPreparation.workArtifact.sha256,
  "Batch 11 audio work-item hash changed"
);
assertV4(
  JSON.stringify(
...
assertV4(
  grouped.size === 2,
  "expected exactly two Batch 11 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-two-post-canary-batch-11-local-audio-sources-two-clips",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-11-audio-source-preparation",
