...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-02/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(manifest.sourceCompatibility.occurrences[0].debateNumber, "99");
