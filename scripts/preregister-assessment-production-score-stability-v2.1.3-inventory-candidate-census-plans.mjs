...
const SCRIPT =
  "scripts/preregister-assessment-production-score-stability-v2.1.3-inventory-candidate-census-plans.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.3-inventory-candidate-census-plan-manifest.mjs";
...
assertV4(
  preparation.schemaVersion ===
    ...
    preparation.totals?.candidates === 331 &&
    preparation.totals?.proCandidates === 172 &&
    preparation.totals?.conCandidates === 159 &&
...
const manifest = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-candidate-census-plan-execution-preparation-manifest",
  protocolId: preparation.protocolId,
  status:
    "frozen-ten-v2.1.3-candidate-census-plan-contexts-prepared-not-authorized",
  frozenAt,
  ...
  costEstimate: {
    ...
    estimateBasis:
      "The prior ten-context candidate-census plan stage completed in 6.02 wall minutes and 10.81 aggregate model minutes at concurrency two. These frozen v2.1.3 planner inputs are similar, with a 48,291-byte maximum versus 46,499 bytes previously. ChatGPT-subscription execution has no direct incremental API charge.",
  },
  ...
  nextAuthorizedAction:
    "prepare-separate-v2.1.3-candidate-census-plan-execution-activation-only",
};
