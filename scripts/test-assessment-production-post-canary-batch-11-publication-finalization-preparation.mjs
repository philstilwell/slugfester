...
import { buildPostCanaryBatch11PublicationFinalization,
  validatePostCanaryBatch11PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-11-publication-finalization-prepared" &&
...
"Batch 11 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 190, "finalization move count changed");
