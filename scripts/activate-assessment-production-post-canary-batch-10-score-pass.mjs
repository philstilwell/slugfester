...
import { POST_CANARY_BATCH_10_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-10-score-gate.mjs";
...
assertV4(
  ...
  "post-canary Batch 10 score-pass activation is not prepared"
);
...
const manifest = {
  ...preparation,
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-single-score-pass-execution-manifest",
  status:
  ...
  userExecutionAuthorization: {
    instruction:
      "The frozen Batch 10 standing authorization permits activation and execution of exactly one repository score pass, with no rerun and direct incremental cost capped at $0.",
  ...
  nextAuthorizedAction:
    "execute-single-deterministic-post-canary-batch-10-score-pass-once"
};
if (shouldWrite) {
  await writeFile(
