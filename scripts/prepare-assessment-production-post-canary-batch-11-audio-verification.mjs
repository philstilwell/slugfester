...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-11";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-11-audio-verification";
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-11-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-11-audio-verification-preparation.mjs",
  "scripts/assessment-production-post-canary-batch-11-audio-verification-stage.mjs",
...
assertV4(
  sourcePreparation.status ===
      "prepared-two-post-canary-batch-11-local-audio-clips-standing-authorization-active-for-audio-verification-preparation" &&
    sourcePreparation.authorization.audioVerificationManifestPreparation &&
    sourcePreparation.nextAuthorizedAction ===
      "prepare-freeze-validate-and-push-batch-11-audio-verification-manifest-and-cost-estimate-under-standing-authorization",
  "Batch 11 audio-verification preparation is not authorized"
);
...
assertV4(calls.length === 2 && references.length === 4, "two calls and four references required");
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_11_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-11-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-11-decomposed-consensus",
  status: shouldWrite
    ? "prepared-two-post-canary-batch-11-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-two-post-canary-batch-11-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  userAuthorization: {
    ...
    speakerReferencesAuthorizedForPreparation: 4,
  ...
  scope: {
    ...
    sameDebateSpeakerSupportReferences: 4,
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 11 exact clip seconds and two-call count",
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-two-batch-11-paid-audio-verification-calls-under-standing-authorization"
};
