...
assertV4(
  manifest.protocolId === POST_CANARY_BATCH_08_PRODUCTION_PUBLICATION_PROTOCOL_ID &&
    activation.status === "frozen-batch-08-production-publication-mutation-pass-activated" &&
    activation.executionDiscipline.attempts === 1 &&
    activation.executionDiscipline.retries === 0 &&
    activation.executionDiscipline.reruns === 0,
  "frozen Batch 8 production publication activation required"
);
...
const execution = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-08-production-publication-execution",
  protocolId: POST_CANARY_BATCH_08_PRODUCTION_PUBLICATION_PROTOCOL_ID,
  status: "passed-batch-08-production-publication-mutation-awaiting-generated-derivative-correction",
  startedAt,
  completedAt,
  ...
  protected: {
    ...
    preexistingProductionLedgersByteIdentical: 81
  },
  validation: {
  ...
  nextAuthorizedAction: "prepare-isolated-batch-08-generated-seo-derivative-correction-under-standing-authorization"
};
await writeFile(resolve(executionPath), serializedJson(execution));
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-08-production-publication-analysis",
  protocolId: POST_CANARY_BATCH_08_PRODUCTION_PUBLICATION_PROTOCOL_ID,
  status: "batch-08-production-publication-mutation-passed-pending-generated-derivative-correction",
