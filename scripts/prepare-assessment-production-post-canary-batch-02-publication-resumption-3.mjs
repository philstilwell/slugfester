...
import {
  POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_DEBATES,
  POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_PROTOCOL_ID,
  POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_ROOT
} from "./lib/assessment-production-post-canary-batch-02-publication-resumption-3.mjs";
import {
...
const RESUMPTION_ROOT = POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_ROOT;
...
assertV4(
  originalExecution.status ===
    ...
    canonicalJson(diagnosis.rampDisposition.unattemptedDebates.slice(4)) ===
      canonicalJson(POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_DEBATES),
...
assertV4(
  resumption1Preparation.status ===
    ...
    canonicalJson(resumption1Diagnosis.rampDisposition.unattemptedDebates.slice(3)) ===
      canonicalJson(POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_DEBATES),
...
assertV4(
  resumption2Preparation.status ===
    ...
    canonicalJson(resumption2Diagnosis.rampDisposition.unattemptedDebates) ===
      canonicalJson(POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_DEBATES),
  "the preserved five-context third-resumption boundary changed"
);
assertV4(
...
for (
  ...
  resumptionIndex < POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_DEBATES.length;
  resumptionIndex += 1
) {
  const debateNumber =
    POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_DEBATES[resumptionIndex];
  ...
  assertV4(
    source &&
      source.contextIndex === resumptionIndex + 5 &&
      resumption1Source &&
      resumption1Source.contextIndex === resumptionIndex + 4 &&
      resumption1Source.originalContextIndex === source.contextIndex &&
      resumption2Source &&
      resumption2Source.contextIndex === resumptionIndex + 3 &&
...
assertV4(
  contexts.length === 5 &&
    resumptionMoves === 97 &&
    resumptionSections === 26 &&
    resumptionAudioVerifiedMoves === 8,
  "the five-context third-resumption coverage changed"
);
...
const newStaticSources = [
  ...
  "scripts/lib/assessment-production-post-canary-batch-02-publication-resumption-3.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-02-publication-resumption-3.mjs",
  "scripts/test-assessment-production-post-canary-batch-02-publication-resumption-3-preparation.mjs",
  "scripts/activate-assessment-production-post-canary-batch-02-publication-resumption-3.mjs",
  "scripts/run-assessment-production-post-canary-batch-02-publication-resumption-3.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-02-publication-resumption-3.mjs"
];
...
const rampPhases = [
  {
    phase: "resumption-3-operational-one",
    maximumParallelContexts: 1,
    contextIndexes: [0],
    expansionRequiresAllValid: true
  },
  {
    phase: "resumption-3-ramp-two",
    maximumParallelContexts: 2,
    contextIndexes: [1, 2],
    expansionRequiresAllValid: true
  },
  {
    phase: "resumption-3-steady-two",
    maximumParallelContexts: 2,
    contextIndexes: [3, 4],
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-3-execution-preparation-manifest",
  protocolId: POST_CANARY_BATCH_02_PUBLICATION_RESUMPTION_3_PROTOCOL_ID,
  status:
  ...
  costEstimate: {
    ...
    contexts: 5,
    expectedParallelWallMinutes: [12, 28],
    expectedAggregateModelMinutes: [21, 40],
    expectedAggregateComputeHours: [0.35, 0.67],
    ...
    estimateBasis: {
      ...
      scalingRule: "five-tenths-of-frozen-ten-context-plan-rounded-outward"
    }
  },
  ...
  deterministicValidation: {
    ...
    originalAndPriorResumptionFiveOutputValidationAndProvenancePathsAbsentAtFreeze: true,
  ...
  acceptanceContract: {
    resumptionValidContextsRequired: 5,
    cohortValidDebatesRequired: 10,
    resumptionMovesRequired: 97,
    cohortMovesRequired: 190,
    resumptionCritiquesRequired: 97,
    cohortCritiquesRequired: 190,
    resumptionExactSourceQuotesRequired: 10,
    cohortExactSourceQuotesRequired: 20,
    resumptionOverallCommentarySidesRequired: 10,
    cohortOverallCommentarySidesRequired: 20,
    resumptionAIExtensionSidesRequired: 10,
  ...
  nextAuthorizedAction:
    "activate-and-execute-exactly-five-frozen-batch-02-publication-resumption-3-contexts-under-standing-authorization"
};
