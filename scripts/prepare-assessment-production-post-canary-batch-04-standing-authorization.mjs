...
import {
  ...
  POST_CANARY_BATCH_04_STANDING_AUTHORIZATION_STATUS,
  validatePostCanaryBatch04StandingAuthorization
...
const SOURCE_FILES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-04-standing-authorization.mjs",
  "scripts/test-assessment-production-post-canary-batch-04-standing-authorization.mjs"
];
...
assertV4(
  !(await exists(POST_CANARY_BATCH_04_STANDING_AUTHORIZATION)),
  `${POST_CANARY_BATCH_04_STANDING_AUTHORIZATION} already exists`
);
...
assertV4(
  selection.status ===
    ...
    selection.batchNumber === 4 &&
    selection.checkpointCommit ===
      "1a23cf5749c991903265fcbbc79d015ae6ee0337" &&
    ...
    analysis.status ===
      "fourth-post-canary-batch-selection-analysis-passed-awaiting-source-packet-preparation-decision" &&
  ...
  "the frozen Batch 4 selection or source-packet boundary changed"
);
assertV4(
  execFileSync("git", ["rev-parse", "--abbrev-ref", "HEAD"], {
    ...
    execFileSync("git", ["rev-parse", "HEAD"], { encoding: "utf8" }).trim() ===
      "b69615633cd10f1df7e5d8df478f5f8563be5a41" &&
    execFileSync("git", ["rev-parse", "origin/main"], {
      encoding: "utf8"
    }).trim() === "b69615633cd10f1df7e5d8df478f5f8563be5a41",
  "Batch 4 standing authorization must freeze at the pushed source-packet commit"
);
...
const record = {
  ...
  protocolId: POST_CANARY_BATCH_04_STANDING_AUTHORIZATION_PROTOCOL_ID,
  status: POST_CANARY_BATCH_04_STANDING_AUTHORIZATION_STATUS,
  authorizedAt,
  ...
  stopRules: {
    ...
    outsideBatchFourDebateBlocks: true,
  ...
  nextAuthorizedAction:
    "prepare-validate-freeze-commit-and-push-batch-04-discovery-execution-manifest"
};
validatePostCanaryBatch04StandingAuthorization(record);
if (shouldWrite) {
  await writeFile(
