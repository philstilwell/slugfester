...
assertV4(
  ...
  "Batch 9 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
...
assertV4(
  grouped.size === 3,
  "expected exactly three Batch 9 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-three-post-canary-batch-09-local-audio-sources-four-clips",
