...
import { extractAssessmentProductionPostCanaryBatch10Disagreements } from "./lib/assessment-production-post-canary-batch-10-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 10);
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 182);
assert.equal(
...
assert.equal(analysis.sourceCompatibility.occurrences.length, 0);
