...
assertV4(
  ...
  "Batch 3 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
...
assertV4(
  grouped.size === 5,
  "expected exactly five Batch 3 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-five-post-canary-batch-03-local-audio-sources-eight-clips",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-audio-source-preparation",
