...
assertV4(
  ...
  "the Batch 2 publication resumption-2 analysis boundary changed"
);
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-2-analysis",
  protocolId: activation.protocolId,
  status: passed
    ? "post-canary-batch-02-publication-resumption-2-output-gate-passed"
    : cohortSemanticPass
      ? "post-canary-batch-02-publication-resumption-2-failed-timing"
