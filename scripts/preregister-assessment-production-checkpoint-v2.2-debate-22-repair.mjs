...
import { CHECKPOINT_V22_DEBATE_22_REPAIR_ROOT } from "./lib/assessment-production-checkpoint-v2.2-debate-22-repair.mjs";
...
assertV4(
  preparation.status === "seven-isolated-thirteen-field-debate-22-publication-repair-packets-prepared-and-frozen" &&
    preparation.contexts.length === 7 &&
    preparation.totals.writableFields === 13 &&
    preparation.totals.acceptedCohortDebatesBeforeRepair === 9 &&
    preparation.totals.acceptedCohortMovesBeforeRepair === 169 &&
    preparation.policy.attemptsPerContext === 1 &&
    preparation.policy.retriesMaximum === 0 &&
    preparation.totals.modelAuthoredScores === 0,
  "Debate 22 repair preparation mismatch"
);
...
const sourceFiles = [
  ...
  ...Object.values(preparation.acceptedCohortOutputs),
  ...Object.values(preparation.cohortPackets),
  ...
  "scripts/lib/assessment-production-checkpoint-v2.2-publication-resumption-3.mjs",
  "scripts/lib/assessment-production-checkpoint-v2.2-debate-22-repair.mjs",
  "scripts/prepare-assessment-production-checkpoint-v2.2-debate-22-repair.mjs",
  "scripts/preregister-assessment-production-checkpoint-v2.2-debate-22-repair.mjs",
  "scripts/run-assessment-production-checkpoint-v2.2-debate-22-repair.mjs",
  "scripts/analyze-assessment-production-checkpoint-v2.2-debate-22-repair.mjs",
  "scripts/test-assessment-production-checkpoint-v2.2-debate-22-repair.mjs"
];
...
const execution = `${CHECKPOINT_V22_DEBATE_22_REPAIR_ROOT}/model-execution.json`;
const analysis = `${CHECKPOINT_V22_DEBATE_22_REPAIR_ROOT}/analysis.json`;
const futureOutputPathsExcludedFromSourceHashes = [
  ...
  preparation.artifacts.completeCohortValidation,
  execution,
  analysis
];
...
const activation = {
  schemaVersion: "1.0-production-checkpoint-v2.2-debate-22-publication-repair-execution-activation",
  protocolId: preparation.protocolId,
  status: "frozen-seven-isolated-thirteen-field-debate-22-publication-repair-contexts-authorized",
  frozenAt,
  ...
  costEstimate: {
    ...
    expectedWallMinutes: [5, 15],
    maximumWallMinutes: 56
  },
  authorization: {
