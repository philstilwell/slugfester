...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-10-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-10-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 182 &&
    preparation.totals.movesJudgedAcrossPasses === 364 &&
  ...
  "Batch 10 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 10 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 10 exact-source compatibility boundary drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-independent-judgment-execution-preparation-manifest",
