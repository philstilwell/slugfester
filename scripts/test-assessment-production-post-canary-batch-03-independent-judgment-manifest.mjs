...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-03/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(manifest.audioPolicy.pendingAttributionVerificationMoves.length, 4);
