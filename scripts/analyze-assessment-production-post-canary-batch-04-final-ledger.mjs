...
const passed =
  ...
  validation.finalMoves === 203 &&
  validation.disputedMoves === 196 &&
  validation.candidateSelections === 582 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-04-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-04-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-04-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
