...
import {
  POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_ROOT,
  POST_CANARY_BATCH_17_GENERATED_SEO_OUTPUT_COUNT,
  POST_CANARY_BATCH_17_GENERATOR_INPUT_PATHS,
  generatedInventoryDigest,
  runIsolatedBatch17SeoGenerator
} from "./lib/assessment-production-post-canary-batch-17-generated-seo-correction.mjs";
import {
...
const planPath = `${POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_ROOT}/correction-plan.json`;
const preparationAnalysisPath = `${POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_ROOT}/preparation-analysis.json`;
const activationPath = `${POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_ROOT}/execution-activation.json`;
const executionPath = `${POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_ROOT}/execution.json`;
const analysisPath = `${POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_ROOT}/analysis.json`;
...
const productionPaths = {
  ...
  analysis: `${POST_CANARY_BATCH_17_PRODUCTION_PUBLICATION_ROOT}/analysis.json`
};
...
assertV4(
  mutationExecution.status === "passed-batch-17-production-publication-mutation-awaiting-generated-derivative-correction" &&
    mutationExecution.totals?.mutationPasses === 1 &&
    mutationExecution.totals?.changedDebateRecords === 4 &&
    mutationExecution.totals?.generatedDerivativeWrites === 0 &&
    mutationAnalysis.status === "batch-17-production-publication-mutation-passed-pending-generated-derivative-correction" &&
    mutationAnalysis.decision?.atomicTransactionCommitPending === true,
  "passed one-time Batch 17 production mutation required"
);
assertV4(
...
const isolated = await runIsolatedBatch17SeoGenerator(root);
assertV4(isolated.outputs.length === POST_CANARY_BATCH_17_GENERATED_SEO_OUTPUT_COUNT, "isolated generator must produce exactly 380 outputs");
const inventory = [];
...
assertV4(
  ...
  "isolated comparison must identify exactly the four Batch 17 debate pages, sitemap, and debate summaries"
);

const toolPaths = [
  "scripts/lib/assessment-production-post-canary-batch-17-generated-seo-correction.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-17-generated-seo-correction.mjs",
  "scripts/test-assessment-production-post-canary-batch-17-generated-seo-correction-preparation.mjs",
  "scripts/activate-assessment-production-post-canary-batch-17-generated-seo-correction.mjs",
  "scripts/test-assessment-production-post-canary-batch-17-generated-seo-correction-activation.mjs",
  "scripts/run-assessment-production-post-canary-batch-17-generated-seo-correction.mjs"
];
const plan = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-17-generated-seo-correction-plan",
  protocolId: POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "frozen-batch-17-generated-seo-derivative-correction-plan-prepared",
  frozenAt,
  ...
  generatorInputs: await Promise.all(POST_CANARY_BATCH_17_GENERATOR_INPUT_PATHS.map(lockFile)),
  ...
  executionContract: {
    ...
    preserveOtherGeneratedOutputs: 374,
  ...
  nextAuthorizedAction: "activate-and-execute-one-frozen-batch-17-generated-seo-correction-pass-under-standing-authorization"
};
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-17-generated-seo-correction-preparation-analysis",
  protocolId: POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "batch-17-generated-seo-correction-plan-freeze-passed",
  analyzedAt: frozenAt,
  ...
  checks: {
    ...
    exactChangedFiles: 6,
    unchangedGeneratedFiles: 374,
    generatedProductionFilesWritten: 0,
    repositoryValidationRuns: 0,
    temporaryFilesCleaned: true
  },
  totals: { isolatedGeneratorRuns: 1, proposedWrites: 6, models: 0, paidServices: 0, directIncrementalCostUsd: 0 },
  nextAuthorizedAction: plan.nextAuthorizedAction
};
if (write) {
  await mkdir(resolve(POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_ROOT), { recursive: true });
