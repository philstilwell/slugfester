...
assertV4(
  preparation.protocolId === PROTOCOL_ID &&
    preparation.status === "frozen-six-original-unattempted-batch-13-publication-contexts-prepared-not-activated" &&
    preparation.contexts?.length === 6 && preparation.totals?.moves === 120 &&
...
const activation = {
  ...
  status: "frozen-six-original-unattempted-batch-13-publication-contexts-activated",
  activatedAt,
