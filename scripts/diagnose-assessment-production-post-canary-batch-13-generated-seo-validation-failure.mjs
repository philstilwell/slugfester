...
assertV4(
  plan.status === "frozen-batch-13-generated-seo-derivative-correction-plan-prepared" &&
    activation.status === "frozen-batch-13-generated-seo-correction-pass-activated" &&
    activation.plan.sha256 === sha256(await readBytes(planPath)),
  "spent Batch 13 generated SEO activation required"
);
...
assertV4(
  ...
  "expected exactly Batch 13 Debate 34 to feed the legacy pilot analysis"
);
...
const diagnosis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-13-generated-seo-validation-failure-diagnosis",
  protocolId: "assessment-production-post-canary-batch-13-generated-seo-dependent-pilot-analysis-recovery",
  status: "frozen-batch-13-generated-seo-full-check-dependent-pilot-analysis-staleness-diagnosed",
  diagnosedAt,
  batchNumber: 13,
  directIncrementalCostUsd: 0,
  failedExecution: {
    command: "node scripts/run-assessment-production-post-canary-batch-13-generated-seo-correction.mjs",
  ...
  rootCause: {
    finding: "The complete repository check recomputes the legacy v2.1 pilot report from current production debate scores. Batch 13 replaces Debate 34, which is sampled by that report, so its two checked-in deterministic outputs became stale even though the frozen SEO output inventory passed.",
  ...
  nextAuthorizedAction: "prepare-and-freeze-one-bounded-batch-13-dependent-pilot-analysis-correction"
};
