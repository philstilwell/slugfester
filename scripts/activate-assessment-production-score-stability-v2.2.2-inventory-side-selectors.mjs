...
const SCRIPT =
  "scripts/activate-assessment-production-score-stability-v2.2.2-inventory-side-selectors.mjs";
const RUNNER =
  "scripts/run-assessment-production-score-stability-v2.2.2-inventory-side-selectors.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-score-stability-v2.2.2-inventory-side-selectors.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.2.2-inventory-side-selector-activation.mjs";
...
const sourceFiles = [
  ...
  ...sourcePreparation.contexts.flatMap((context) => [
    ...
    context.sourceContext.validatorCandidateEvidenceBundle,
    context.sourceContext.originalEvents,
  ]),
];
const sourceHashes = {};
...
const activation = {
  schemaVersion:
    "1.0-score-stability-v2.2.2-side-selector-execution-activation",
  protocolId: preparation.protocolId,
  sideSelectionProtocolId: preparation.sideSelectionProtocolId,
  status: "frozen-twenty-v2.2.2-side-selector-contexts-authorized",
  activatedAt,
  ...
  nextRequiredAction:
    "execute-frozen-v2.2.2-side-selector-gate-once",
};
