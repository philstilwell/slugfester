...
assertV4(
  ...
  "post-canary Batch 15 score-pass activation is not prepared"
);
...
const manifest = {
  ...preparation,
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-15-single-score-pass-execution-manifest",
  status:
  ...
  userExecutionAuthorization: {
    instruction:
      "The frozen Batch 15 standing authorization permits activation and execution of exactly one repository score pass, with no rerun and direct incremental cost capped at $0.",
  ...
  nextAuthorizedAction:
    "execute-single-deterministic-post-canary-batch-15-score-pass-once"
};
if (shouldWrite) {
  await writeFile(
