...
assertV4(
  ...
  "the Batch 4 publication finalization is not prepared"
);
for (const [file, digest] of Object.entries(preparation.sourceHashes)) {
  assertV4(
    sha256(await readFile(path.resolve(file))) === digest,
    `Batch 4 finalization preparation source hash mismatch: ${file}`
  );
}
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-04-publication-finalization-execution-activation",
  protocolId: POST_CANARY_BATCH_04_PUBLICATION_FINALIZATION_PROTOCOL_ID,
  status: "frozen-post-canary-batch-04-publication-finalization-authorized",
  activatedAt,
  ...
  nextRequiredAction:
    "execute-one-frozen-batch-04-deterministic-publication-finalization-pass"
};
