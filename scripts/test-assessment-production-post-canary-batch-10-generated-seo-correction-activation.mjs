...
import { sha256 } from "./lib/assessment-production-post-canary-batch-10-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-10-generated-seo-correction-pass-activated");
