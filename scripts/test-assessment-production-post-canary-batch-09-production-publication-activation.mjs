...
assert.equal(activation.status, "frozen-batch-09-production-publication-mutation-pass-activated");
assert.equal(activation.directIncrementalCostCapUsd, 0);
assert.deepEqual(activation.frozenOutput.changedDebateNumbers, POST_CANARY_BATCH_09_PRODUCTION_PUBLICATION_ORDER);
