...
import { sha256 } from "./lib/assessment-production-post-canary-batch-09-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-09-generated-seo-correction-pass-activated");
