...
assert.equal(preparation.clips.length, 10);
assert.equal(preparation.totals.sources, 4);
assert.equal(preparation.totals.clips, 10);
...
assert.equal(preparation.userAuthorization.sourceAudioFilesAuthorized, 4);
assert.equal(preparation.userAuthorization.clipsAuthorized, 10);
...
assert.equal(preparation.publicSourceAttemptAudit.length, 4);
assert(
