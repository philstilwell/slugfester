...
import { serializedJson, sha256 } from "./lib/assessment-production-post-canary-batch-17-production-publication.mjs";
...
assertV4(
  plan.protocolId === POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID &&
    activation.status === "frozen-batch-17-generated-seo-correction-pass-activated" &&
  ...
  "frozen Batch 17 generated SEO activation required"
);
...
assertV4(writablePaths.size === 6, "exactly six generated paths must be writable");
for (const record of plan.inventory) {
...
const execution = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-17-generated-seo-correction-execution",
  protocolId: POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "passed-complete-batch-17-transaction-ready-for-atomic-commit",
  startedAt,
  completedAt,
  ...
  totals: {
    ...
    generatedDerivativeWrites: 6,
    unchangedGeneratedOutputs: 374,
  ...
  nextAuthorizedAction: "atomic-commit-and-push-complete-validated-batch-17-production-transaction-then-stop-before-batch-18-selection"
};
await writeFile(resolve(executionPath), serializedJson(execution));
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-17-generated-seo-correction-analysis",
  protocolId: POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "batch-17-production-publication-accepted-for-atomic-commit-after-generated-seo-correction",
  analyzedAt: completedAt,
  execution: await lockFile(executionPath),
  decision: {
    generatedSeoCorrectionGatePassed: true,
    batch17ProductionPublicationGatePassed: true,
    ...
    other374GeneratedOutputsPreserved: true,
...
console.log(serializedJson({ status: execution.status, outputs: 380, written: 6, unchanged: 374, repositoryValidationPassed: true, directIncrementalCostUsd: 0 }));
