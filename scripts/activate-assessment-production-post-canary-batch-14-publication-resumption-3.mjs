...
assertV4(
  preparation.protocolId === PROTOCOL_ID &&
    preparation.status === "frozen-five-original-unattempted-batch-14-publication-contexts-prepared-not-activated" &&
    preparation.contexts?.length === 5 && preparation.totals?.moves === 94 &&
...
const activation = {
  ...preparation,
  schemaVersion: "1.0-assessment-production-post-canary-batch-14-publication-original-unattempted-context-resumption-activation",
  status: "frozen-five-original-unattempted-batch-14-publication-contexts-activated",
  activatedAt,
