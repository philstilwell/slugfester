...
assertV4(write, "Batch 12 compatibility runner requires --write");
...
const paths = {
  root: POST_CANARY_BATCH_12_COMPATIBILITY_ROOT,
...
assertV4(
  ...
  "Batch 12 compatibility pass was already attempted; rerun forbidden"
);
...
assertV4(
  ...
  "frozen Batch 12 compatibility activation is unavailable"
);
...
tests.push(
  runCommand(
    "batch-12-route-positive-negative-controls",
    process.execPath,
...
if (tests.at(-1).passed) {
  tests.push(
    runCommand("checkpoint-batch-01-batch-02-batch-03-batch-04-batch-05-batch-06-batch-07-batch-08-batch-09-batch-10-batch-11-legacy-reference-regression", process.execPath, [
...
const nextAuthorizedAction = compatibilityAcceptancePassed
  ? "prepare-batch-12-production-publication-mutation-manifest-under-standing-authorization"
  : "diagnose-batch-12-compatibility-failure-under-failure-recovery-standing-authorization";
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-12-compatibility-execution",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-12-route-score-checkpoint-batch-01-batch-02-batch-03-batch-04-batch-05-batch-06-batch-07-batch-08-batch-09-batch-10-batch-11-legacy-reference-validation-passed"
    : "failed-closed-batch-12-compatibility-staging-pass",
  startedAt,
  completedAt,
  activation: {
  ...
  regressions: {
    batch11RouteControlsPassed: tests[0]?.passed === true,
    checkpointBatch01ThroughBatch11LegacyReferencePassed:
      tests[1]?.passed === true,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-12-compatibility-execution-analysis",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-12-production-compatibility-passed"
    : "batch-12-production-compatibility-failed-closed",
  ...
  checks: {
    ...
    routeAndScoreControlsPassed: execution.regressions.batch11RouteControlsPassed,
    checkpointBatch01ThroughBatch11LegacyReferencePassed:
      execution.regressions.checkpointBatch01ThroughBatch11LegacyReferencePassed,
