...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_03_DEBATE_157_REPAIR_PROTOCOL_ID &&
    preparation.status ===
  ...
  "the Debate 157 repair execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-publication-resumption-2-debate-157-repair-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-eight-frozen-debate-157-publication-resumption-2-repair-contexts-once"
};
