...
assert.equal(activation.status, "frozen-batch-06-production-publication-mutation-pass-activated");
assert.equal(activation.directIncrementalCostCapUsd, 0);
assert.deepEqual(activation.frozenOutput.changedDebateNumbers, POST_CANARY_BATCH_06_PRODUCTION_PUBLICATION_ORDER);
