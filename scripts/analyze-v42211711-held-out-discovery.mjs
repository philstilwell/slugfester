...
assertV4(
  execution.status === "seventeen-held-out-discovery-contexts-passed"
...
const analysis = {
  schemaVersion: "4.2.21.17.11-held-out-discovery-analysis",
  protocolId: manifest.protocolId,
  status: "held-out-discovery-passed-independent-judgment-packet-preparation-authorized",
