...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_01_RENDERING_PROTOCOL_ID &&
    activation.protocolId === POST_CANARY_BATCH_01_RENDERING_PROTOCOL_ID &&
    activation.status ===
      "frozen-post-canary-batch-01-rendering-verification-authorized" &&
  ...
  "valid frozen Batch 1 rendering activation required"
);
if (shouldWrite) {
...
assertV4(
  audit.status === "ten-debate-batch-01-rendering-evidence-passed" &&
    audit.debates === 10 &&
    audit.sections === 50 &&
    audit.moves === 177 &&
  ...
  "passing Batch 1 rendering evidence audit required"
);
...
const renderingAudit = {
  ...audit,
  status: "passed-ten-debate-batch-01-rendering-verification",
  completedAt,
...
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-rendering-verification-execution",
  protocolId: POST_CANARY_BATCH_01_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-01-rendering-verification-passed",
  completedAt,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-rendering-verification-analysis",
  protocolId: POST_CANARY_BATCH_01_RENDERING_PROTOCOL_ID,
  status: "ten-debate-batch-01-rendering-verification-passed",
  ...
  nextAuthorizedAction:
    "user-approval-required-before-batch-01-production-compatibility-preparation-only"
};
