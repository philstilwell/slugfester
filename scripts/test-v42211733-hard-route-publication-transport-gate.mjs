...
const manifestPath = `${V42211733_ROOT}/execution-manifest.json`, executionPath = `${V42211733_ROOT}/model-execution.json`, analysisPath = `${V42211733_ROOT}/analysis.json`;
...
assert.equal(preparation.status, "prepared-five-isolated-hard-route-publication-transport-contexts");
...
assert.equal(preparation.repair.allSchemaPreflightsPassed, true);
