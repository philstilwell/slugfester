...
const analysis = {
  ...
  sources: {
    ...
    acceptedDebate66: activation.acceptedDebate66.output,
    acceptedDebate126: activation.acceptedDebate126.output,
    acceptedDebate99: activation.acceptedDebate99.output
  },
  acceptedDebate103: {
