...
assertV4(
  activation.status === "frozen-two-context-three-field-batch-12-publication-repair-activated" &&
    activation.authorization?.modelExecution === true && activation.contexts?.length === 2 &&
...
const execution = {
  ...
  protocolId: activation.protocolId,
  status: passed
    ? "two-field-disjoint-batch-12-publication-repair-contexts-passed"
    : "two-field-disjoint-batch-12-publication-repair-contexts-completed-with-failure",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-merge-and-validate-debate-152-then-prepare-nine-unattempted-contexts"
