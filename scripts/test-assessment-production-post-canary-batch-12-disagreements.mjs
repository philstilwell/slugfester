...
import { extractAssessmentProductionPostCanaryBatch12Disagreements } from "./lib/assessment-production-post-canary-batch-12-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 12);
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 204);
assert.equal(
