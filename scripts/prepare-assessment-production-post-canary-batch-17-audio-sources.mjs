...
const planRoot =
  "docs/assessment-production/post-canary-continuation-v1/batch-17/disagreement-extraction";
const localRoot =
  "output/transcribe/assessment-production-post-canary-batch-17-audio-verification";
...
assertV4(
  ...
  "Batch 17 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
...
assertV4(
  grouped.size === 1,
  "expected exactly one Batch 17 audio source"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-one-post-canary-batch-17-local-audio-source-one-clip",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-17-audio-source-preparation",
