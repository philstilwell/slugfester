...
assert.equal(analysis.evidenceBoundary.audioTranscriptInputs, 12);
...
if (
  ...
  assert.equal(analysis.gate.disputedMovesDecided, 181);
  assert.equal(analysis.gate.candidateSelections, 539);
  assert.equal(
