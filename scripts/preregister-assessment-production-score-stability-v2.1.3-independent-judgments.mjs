...
const SCRIPT =
  "scripts/preregister-assessment-production-score-stability-v2.1.3-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.3-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 189 &&
    preparation.totals.movesJudgedAcrossPasses === 378 &&
  ...
  "v2.1.3 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the unpromoted integer-rounded-tie proposal drifted"
);
assertV4(
  sourcePreparation.stopRules &&
    Object.values(sourcePreparation.stopRules).every(Boolean),
...
const manifest = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-independent-judgment-execution-preparation-manifest",
  protocolId: preparation.protocolId,
  status:
    "frozen-twenty-v2.1.3-independent-judgment-contexts-prepared-not-authorized",
  frozenAt,
  ...
  nextAuthorizedAction:
    "prepare-separate-v2.1.3-independent-judgment-execution-activation-only",
};
