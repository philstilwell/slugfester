...
import {
  POST_CANARY_BATCH_13_FINAL_LEDGER_PROTOCOL_ID,
...
const preview = buildPostCanaryBatch13FinalLedger(
  inputs.debateInputs,
  inputs.sourceHashes
);
...
assertV4(
  ...
  "post-canary Batch 13 final-ledger preview population mismatch"
);
...
const sourceFiles = [
  ...
  "scripts/preregister-assessment-production-post-canary-batch-13-final-ledger.mjs",
  "scripts/assemble-assessment-production-post-canary-batch-13-final-ledger.mjs",
  "scripts/validate-assessment-production-post-canary-batch-13-final-ledger.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-13-final-ledger.mjs",
  "scripts/test-assessment-production-post-canary-batch-13-final-ledger.mjs"
];
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-13-final-ledger-assembly-manifest",
  ...
  nextAuthorizedAction:
    "assemble-and-validate-ten-post-canary-batch-13-final-ledgers-deterministically"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_13_FINAL_LEDGER_ROOT), {
    recursive: true
  });
  await writeFile(
