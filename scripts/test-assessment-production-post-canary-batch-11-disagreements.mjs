...
import { extractAssessmentProductionPostCanaryBatch11Disagreements } from "./lib/assessment-production-post-canary-batch-11-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 11);
