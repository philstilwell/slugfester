...
assertV4(
  plan.protocolId === POST_CANARY_BATCH_07_GENERATED_SEO_CORRECTION_PROTOCOL_ID &&
    activation.status === "frozen-batch-07-generated-seo-correction-pass-activated" &&
  ...
  "frozen Batch 7 generated SEO activation required"
);
...
const execution = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-07-generated-seo-correction-execution",
  protocolId: POST_CANARY_BATCH_07_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "passed-complete-batch-07-transaction-ready-for-atomic-commit",
  startedAt,
  completedAt,
  ...
  nextAuthorizedAction: "atomic-commit-and-push-complete-validated-batch-07-production-transaction-then-stop-before-batch-7-selection"
};
await writeFile(resolve(executionPath), serializedJson(execution));
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-07-generated-seo-correction-analysis",
  protocolId: POST_CANARY_BATCH_07_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "batch-07-production-publication-accepted-for-atomic-commit-after-generated-seo-correction",
