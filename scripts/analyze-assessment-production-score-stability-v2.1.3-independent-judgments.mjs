...
assertV4(
  ...
  "v2.1.3 judgment execution crossed its frozen boundary"
);
...
const analysis = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-independent-judgment-analysis",
  ...
  nextAuthorizedAction: passed
    ...
    : "stop-v2.1.3-independent-judgment-gate-for-audit",
};
if (shouldWrite) {
  await writeFile(
