...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-13-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-13-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 199 &&
    preparation.totals.movesJudgedAcrossPasses === 398 &&
  ...
  "Batch 13 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 13 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 13 exact-source compatibility boundary drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-13-independent-judgment-execution-preparation-manifest",
  protocolId: preparation.protocolId,
  status:
    "frozen-twenty-post-canary-batch-13-independent-judgment-contexts-prepared-not-authorized",
  frozenAt,
  ...
  nextAuthorizedAction:
    "freeze-and-activate-batch-13-independent-judgment-execution-under-standing-authorization",
};
