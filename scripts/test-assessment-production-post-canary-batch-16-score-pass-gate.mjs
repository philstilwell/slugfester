...
import { POST_CANARY_BATCH_16_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-16-score-gate.mjs";
...
const analysisPath = `${POST_CANARY_BATCH_16_SCORE_ROOT}/analysis.json`;
