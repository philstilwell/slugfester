...
import {
  POST_CANARY_BATCH_03_DEBATE_124_BASE_OUTPUT,
  POST_CANARY_BATCH_03_DEBATE_124_PUBLICATION_PACKET,
  POST_CANARY_BATCH_03_DEBATE_124_REPAIR_FIELDS,
  POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PACKET_VERSION,
  POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PARTITIONS,
  POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PROTOCOL_ID,
  POST_CANARY_BATCH_03_DEBATE_124_REPAIR_ROOT,
  buildDebate124RepairSchema,
  debate124RepairMoveId
...
const DIAGNOSIS = `${POST_CANARY_BATCH_03_PUBLICATION_ROOT}/failure-diagnosis.json`;
const FAILED_EXECUTION = `${POST_CANARY_BATCH_03_PUBLICATION_ROOT}/model-execution.json`;
const FAILED_ANALYSIS = `${POST_CANARY_BATCH_03_PUBLICATION_ROOT}/analysis.json`;
...
const STATIC_SOURCE_FILES = [
  ...
  "scripts/lib/assessment-production-post-canary-batch-03-publication-repair.mjs",
  ...
  "scripts/prepare-assessment-production-post-canary-batch-03-publication-repair.mjs",
  "scripts/test-assessment-production-post-canary-batch-03-publication-repair-preparation.mjs",
  "scripts/activate-assessment-production-post-canary-batch-03-publication-repair.mjs",
  "scripts/run-assessment-production-post-canary-batch-03-publication-repair.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-03-publication-repair.mjs"
];
...
const baseOutput = parsed(POST_CANARY_BATCH_03_DEBATE_124_BASE_OUTPUT);
const publicationPacket = parsed(POST_CANARY_BATCH_03_DEBATE_124_PUBLICATION_PACKET);
...
assertV4(
  ...
  "the frozen Debate 124 failure diagnosis changed"
);
assertV4(
...
assertV4(
  execution.contextsPlanned === 10 &&
    ...
    analysis.status === "post-canary-batch-03-publication-output-gate-failed",
  "the preserved failed publication gate changed"
);
assertV4(
  sha256(bytesByFile[POST_CANARY_BATCH_03_DEBATE_124_BASE_OUTPUT]) ===
      diagnosis.failedContext.outputSha256 &&
    sha256(bytesByFile[POST_CANARY_BATCH_03_DEBATE_124_BASE_OUTPUT]) ===
      diagnosis.artifacts.output.sha256 &&
    sha256(bytesByFile[POST_CANARY_BATCH_03_DEBATE_124_PUBLICATION_PACKET]) ===
  ...
  "a diagnosed Debate 124 source artifact drifted"
);
assertV4(
  canonicalJson(diagnosis.prospectiveRecoveryOnly.proposedRepairPartition) ===
      canonicalJson(POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PARTITIONS) &&
    canonicalJson(diagnosis.diagnosticReplay.hypotheticalWritableFields) ===
      canonicalJson(POST_CANARY_BATCH_03_DEBATE_124_REPAIR_FIELDS),
...
for (let packetIndex = 0; packetIndex < 2; packetIndex += 1) {
  const writableFields = POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PARTITIONS[packetIndex];
  const corrections = writableFields.map((field) => {
    const moveId = debate124RepairMoveId(field);
  ...
  const packet = {
    schemaVersion: POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PACKET_VERSION,
    protocolId: POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PROTOCOL_ID,
    packetIndex,
    ...
    immutableBaseOutput: POST_CANARY_BATCH_03_DEBATE_124_BASE_OUTPUT,
    publicationPacket: POST_CANARY_BATCH_03_DEBATE_124_PUBLICATION_PACKET,
  ...
  const schema = buildDebate124RepairSchema(packet);
...
const MERGED_OUTPUT = `${ROOT}/merged/debate-124.json`;
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-debate-124-publication-repair-execution-preparation-manifest",
  protocolId: POST_CANARY_BATCH_03_DEBATE_124_REPAIR_PROTOCOL_ID,
  status:
  ...
  userAuthorization: {
    ...
    resolvedScope:
      "prepare, validate, freeze, activate, and execute exactly two bounded Debate 124 publication-repair packets exposing three diagnosed critique fields",
  ...
  repairContract: {
    repairType: "critique-word-boundary",
    writableFields: POST_CANARY_BATCH_03_DEBATE_124_REPAIR_FIELDS,
  ...
  artifacts: {
    ...
    execution: EXECUTION,
    analysis: ANALYSIS,
    originalFailedOutput: POST_CANARY_BATCH_03_DEBATE_124_BASE_OUTPUT,
