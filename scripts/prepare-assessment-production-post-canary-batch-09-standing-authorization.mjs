...
import {
  ...
  POST_CANARY_BATCH_09_STANDING_AUTHORIZATION_INSTRUCTION_PATH,
  POST_CANARY_BATCH_09_STANDING_AUTHORIZATION_PROTOCOL_ID,
  POST_CANARY_BATCH_09_STANDING_AUTHORIZATION_STATUS,
  validatePostCanaryBatch09StandingAuthorization
...
const SELECTION_FREEZE_COMMIT = "2c3a6ec05210a10c85c9f2e049a9fe077b260d7b";
const SOURCE_PACKET_COMMIT = "5d99d8665b69ea0613b0c9895e26000c50e0229e";
const SOURCE_FILES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-09-standing-authorization.mjs",
  "scripts/test-assessment-production-post-canary-batch-09-standing-authorization.mjs"
];
...
assertV4(
  !(await exists(POST_CANARY_BATCH_09_STANDING_AUTHORIZATION)),
  `${POST_CANARY_BATCH_09_STANDING_AUTHORIZATION} already exists`
);
...
assertV4(
  selection.status ===
    ...
    selection.batchNumber === 9 &&
    selection.checkpointCommit ===
      "596d08afe685c85b2356e1e13d5fede990c7f05c" &&
    ...
    analysis.status ===
      "ninth-post-canary-batch-selection-analysis-passed-awaiting-standing-authorization" &&
    ...
    sourcePreparation.totals.discoveryContexts === 31 &&
    ...
    sourceValidation.totals.discoveryContexts === 31 &&
...
assertV4(
  ...
  "Batch 9 standing authorization must freeze at the pushed source-packet commit"
);
...
const record = {
  ...
  protocolId: POST_CANARY_BATCH_09_STANDING_AUTHORIZATION_PROTOCOL_ID,
  status: POST_CANARY_BATCH_09_STANDING_AUTHORIZATION_STATUS,
  authorizedAt,
  ...
  userAuthorization: {
    instruction: POST_CANARY_BATCH_09_STANDING_AUTHORIZATION_INSTRUCTION,
    resolvedAntecedent: "The frozen Batch 9 selection identified the next approval as creation of the standing authorization and score-blind source-packet workflow.",
    scopeInterpretation: "Create and use a complete-workflow Batch 9 standing authorization for the ten frozen selections, beginning with the separately frozen score-blind source packets, while preserving the established campaign controls and stopping before Batch 10 selection.",
  ...
  authorizedSequence: [
    "thirty-one-frozen-score-blind-discovery-contexts",
  ...
  recoveryHistory: {
    sourcePreparationTransportShape: {
      diagnosis: `${ROOT}/source-preparation-recovery/failure-diagnosis.json`,
      correctionPlan: `${ROOT}/source-preparation-recovery/correction-plan.json`,
      affectedDebate: "19",
      correctionsUsed: 1,
  ...
  stopRules: {
    ...
    outsideBatchNineDebateBlocks: true,
  ...
  nextAuthorizedAction:
    "prepare-validate-freeze-commit-and-push-batch-09-discovery-execution-manifest"
};
validatePostCanaryBatch09StandingAuthorization(record);
if (shouldWrite) {
  await writeFile(
