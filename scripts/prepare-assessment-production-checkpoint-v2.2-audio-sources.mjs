...
assertV4(
  ...
  "production checkpoint v2.2 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
      "prepared-two-production-checkpoint-v2.2-local-audio-source-work-items" &&
    work.moves.length === 2 &&
    work.authorization.localAudioSourcePreparation,
  "production checkpoint v2.2 audio work-item population changed"
);
assertV4(
  sha256(workBytes) === workPreparation.workArtifact.sha256,
  "production checkpoint v2.2 audio work-item hash changed"
);
...
assertV4(
  grouped.size === 2,
  "expected exactly two production checkpoint v2.2 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-two-production-checkpoint-v2.2-local-audio-sources-two-clips",
...
const preparation = {
  schemaVersion: "1.0-production-checkpoint-v2.2-audio-source-preparation",
  protocolId: work.protocolId,
  status: "prepared-two-production-checkpoint-v2.2-local-audio-clips",
  ...
  gateDisposition: structuredClone(workPreparation.gateDisposition),
