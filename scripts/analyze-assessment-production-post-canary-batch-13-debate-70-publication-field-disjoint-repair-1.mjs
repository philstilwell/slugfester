...
assertV4(
  ...
  "three-shard Debate 70 repair execution boundary changed"
);
...
const analysis = {
  ...
  totals: {
    ...
    critiqueFieldsTargeted: 5,
    quoteFieldsTargeted: 0,
    writableFieldsTargeted: 5,
  ...
  authorization: {
    fiveContextResumptionPreparation: allRepaired,
  ...
  nextAuthorizedAction: allRepaired
    ? "prepare-five-original-unattempted-batch-13-publication-contexts"
