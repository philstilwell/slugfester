...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 168 &&
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-07-publication-resumption-execution-activation",
  ...
  userAuthorization: {
    instruction:
      "The Batch 7 standing authorization permits activation and execution of exactly the nine frozen score-locked publication-resumption contexts using 5.6 Sol with low reasoning through the ChatGPT subscription, one attempt per context, no retries, and direct incremental cost $0.",
  ...
  nextRequiredAction:
    "execute-the-nine-frozen-batch-07-publication-resumption-contexts-once"
};
