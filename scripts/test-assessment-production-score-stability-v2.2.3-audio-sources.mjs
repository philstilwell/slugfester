...
assert.equal(preparation.status, "prepared-four-v2.2.3-local-audio-clips");
...
for (const [file, digest] of Object.entries(preparation.toolSourceHashes)) {
  assert.equal(sha256(await readFile(file)), digest, `tool hash mismatch: ${file}`);
}
