...
import { buildPostCanaryBatch16PublicationFinalization,
  validatePostCanaryBatch16PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-16-publication-finalization-prepared" &&
...
"Batch 16 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 194, "finalization move count changed");
