...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-10";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-10-audio-verification";
...
const EXPECTED_DEBATES = ["21", "74", "123", "147", "130"];
const EXPECTED_AUDIO = [
  "21:con-religious-motivation-and-sanctity",
  "21:pro-natural-transcendence-without-supernaturalism",
  "74:pro-voluntary-risk-arena",
  "123:con-involuntary-belief-eternal-stakes",
  "123:pro-continuous-providential-opportunity",
  "123:pro-suffering-enlarges-receptivity",
  "147:pro-qualia-concept-unsettled",
  "147:con-experience-sensitive-religious-belief",
  "130:pro-missing-body-cumulative-significance"
];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-10-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-10-audio-verification-preparation.mjs",
  "scripts/assessment-production-post-canary-batch-10-audio-verification-stage.mjs",
...
assertV4(
  ...
  "Batch 10 audio-verification preparation is not authorized"
);
assertV4(sourcePreparation.clips.length === 9 && work.moves.length === 9, "nine-clip cohort changed");
assertV4(
...
assertV4(calls.length === 9 && references.length === 10, "nine calls and ten references required");
...
const authorizedDurationOnlyPlanningEstimateUsd = 0.1308768;

const sourceFiles = [
  sourcePreparationPath, workPreparationPath, workPath, judgmentPreparationPath,
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_10_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-10-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-10-decomposed-consensus",
  status: shouldWrite
    ? "prepared-nine-post-canary-batch-10-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-nine-post-canary-batch-10-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  userAuthorization: {
    ...
    standingAuthorizationPath: POST_CANARY_BATCH_10_STANDING_AUTHORIZATION,
    ...
    verificationCallsAuthorizedForPreparation: 9,
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 10 exact clip seconds and nine-call count",
    ...
    officialPricingCheckedAt: "2026-08-25",
  ...
  standingAuthorization: {
    path: POST_CANARY_BATCH_10_STANDING_AUTHORIZATION,
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-nine-batch-10-paid-audio-verification-calls-under-standing-authorization"
};
