...
assertV4(
  execution.status === "twenty-v2.1.3-side-selector-contexts-passed" &&
...
for (const prepared of sourcePreparation.contexts) {
  ...
  const summary = {
    schemaVersion:
      "1.0-score-stability-v2.1.3-chronology-fallback-inventory-validation",
...
const analysis = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-chronology-fallback-inventory-analysis",
  protocolId: activation.protocolId,
  status:
