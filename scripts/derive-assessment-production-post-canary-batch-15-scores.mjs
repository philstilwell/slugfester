...
import {
  ...
  derivePostCanaryBatch15Scores
} from "./lib/assessment-production-post-canary-batch-15-score-gate.mjs";
import { assertV4 } from "./lib/v4-lean-production.mjs";

const manifestPath = `${POST_CANARY_BATCH_15_SCORE_ROOT}/score-pass-manifest.json`;
...
assertV4(
  ...
  "post-canary Batch 15 score manifest invalid"
);
...
for (const [file, expected] of Object.entries(manifest.sourceHashes)) {
  assertV4(
    ...
    `${file}: frozen Batch 15 score source hash mismatch`
  );
}
...
const calculated = derivePostCanaryBatch15Scores(
  ledger,
  inputs.debateInputs,
