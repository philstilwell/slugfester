...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-13-inventory-side-selectors.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-13-inventory-side-selectors.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-post-canary-batch-13-inventory-side-selectors.mjs";
...
assertV4(
  sidePacketPreparation.status ===
    ...
    JSON.stringify(sidePacketPreparation.sourceCompatibility) ===
      JSON.stringify(preparation.sourceCompatibility),
  "Batch 13 side-packet preparation drifted"
);
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-13-side-selector-execution-activation",
  ...
  userAuthorization: {
    scope:
      "activate and execute exactly the twenty frozen Batch 13 score-blind side-selector contexts under the frozen standing authorization",
  ...
  nextRequiredAction:
    "execute-exactly-twenty-frozen-post-canary-batch-13-side-selector-contexts-once",
};
