...
assertV4(
  activation.status === "frozen-seven-original-unattempted-batch-13-publication-contexts-activated" &&
  ...
  "seven-context resumption execution is not activated"
);
assertV4(
  ...
  "seven-context execution policy changed"
);
...
const execution = {
  ...
  status: passed
    ...
    : "seven-context-publication-resumption-stopped-with-failure",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-replay-seven-outputs-and-complete-ten-debate-publication-cohort"
