...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-13-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-13-independent-judgments.mjs";
const ANALYZER =
  "scripts/analyze-assessment-production-post-canary-batch-13-independent-judgments.mjs";
const VALIDATOR =
  "scripts/validate-assessment-production-post-canary-batch-13-independent-judgment.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-13-independent-judgment-activation.mjs";
...
assertV4(
  ...
  "Batch 13 independent-judgment activation prerequisites drifted"
);
assertV4(
  ...
  "frozen Batch 13 judgment packet preparation drifted"
);
assertV4(
...
const activation = {
  ...
  userAuthorization: {
    scope:
      "activate and execute exactly the twenty frozen Batch 13 score-blind independent-judgment contexts under the frozen standing authorization",
