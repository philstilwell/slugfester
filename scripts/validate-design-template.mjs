...
requireIncludes("app rankings section score chart", app, "sectionScoreDistribution");
requireIncludes("app rankings section score chart", app, "How individual debate sections score");
requireIncludes("app rankings section score chart", app, "two-percentage-point range");
requireIncludes("app rankings section score chart", app, "not overall debate scores or interlocutor averages");
