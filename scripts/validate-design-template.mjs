...
requireIncludes("app backend update date", app, "Updated August 31, 2026");
...
requireIncludes("app backend recommendation destination", app, "https://formsubmit.co/philstilwell@yahoo.com");
