...
requireIncludes("app sticky header", app, 'aria-expanded="false" aria-controls="external-sites-links"');
requireIncludes("app sticky header", app, 'id="external-sites-links" hidden');
requireIncludes("app sticky header", app, 'aria-describedby="logfall-menu-description"');
requireIncludes("app sticky header", app, 'aria-describedby="cogbias-menu-description"');
...
requireIncludes("app landing scorecard count", app, "Debates/<wbr>Scorecards");
...
requireIncludes("app backend update date", app, "Updated September 5, 2026");
