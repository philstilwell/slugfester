...
const passed =
  ...
  validation.disputedMoves === 174 &&
  validation.candidateSelections === 533 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-08-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-08-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-08-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
