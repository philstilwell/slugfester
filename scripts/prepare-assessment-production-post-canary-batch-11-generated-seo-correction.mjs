...
import {
  ...
  POST_CANARY_BATCH_11_GENERATED_SEO_OUTPUT_COUNT,
  POST_CANARY_BATCH_11_GENERATOR_INPUT_PATHS,
  generatedInventoryDigest,
  runIsolatedBatch11SeoGenerator
...
const planPath = `${POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_ROOT}/correction-plan.json`;
const preparationAnalysisPath = `${POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_ROOT}/preparation-analysis.json`;
const activationPath = `${POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_ROOT}/execution-activation.json`;
const executionPath = `${POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_ROOT}/execution.json`;
const analysisPath = `${POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_ROOT}/analysis.json`;
...
const productionPaths = {
  ...
  analysis: `${POST_CANARY_BATCH_11_PRODUCTION_PUBLICATION_ROOT}/analysis.json`
};
...
assertV4(
  mutationExecution.status === "passed-batch-11-production-publication-mutation-awaiting-generated-derivative-correction" &&
    ...
    mutationAnalysis.status === "batch-11-production-publication-mutation-passed-pending-generated-derivative-correction" &&
    mutationAnalysis.decision?.atomicTransactionCommitPending === true,
  "passed one-time Batch 11 production mutation required"
);
assertV4(
...
const isolated = await runIsolatedBatch11SeoGenerator(root);
assertV4(isolated.outputs.length === POST_CANARY_BATCH_11_GENERATED_SEO_OUTPUT_COUNT, "isolated generator must produce exactly 380 outputs");
const inventory = [];
...
assertV4(
  ...
  "isolated comparison must identify exactly the ten Batch 11 debate pages, sitemap, and debate summaries"
);

const toolPaths = [
  "scripts/lib/assessment-production-post-canary-batch-11-generated-seo-correction.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-11-generated-seo-correction.mjs",
  "scripts/test-assessment-production-post-canary-batch-11-generated-seo-correction-preparation.mjs",
  "scripts/activate-assessment-production-post-canary-batch-11-generated-seo-correction.mjs",
  "scripts/test-assessment-production-post-canary-batch-11-generated-seo-correction-activation.mjs",
  "scripts/run-assessment-production-post-canary-batch-11-generated-seo-correction.mjs"
];
const plan = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-11-generated-seo-correction-plan",
  protocolId: POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "frozen-batch-11-generated-seo-derivative-correction-plan-prepared",
  frozenAt,
  ...
  generatorInputs: await Promise.all(POST_CANARY_BATCH_11_GENERATOR_INPUT_PATHS.map(lockFile)),
  ...
  nextAuthorizedAction: "activate-and-execute-one-frozen-batch-11-generated-seo-correction-pass-under-standing-authorization"
};
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-11-generated-seo-correction-preparation-analysis",
  protocolId: POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "batch-11-generated-seo-correction-plan-freeze-passed",
  analyzedAt: frozenAt,
...
if (write) {
  await mkdir(resolve(POST_CANARY_BATCH_11_GENERATED_SEO_CORRECTION_ROOT), { recursive: true });
