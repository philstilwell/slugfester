...
assertV4(
  ...
  "frozen Batch 8 generated SEO plan required"
);
assertV4(
  preparationAnalysis.status === "batch-08-generated-seo-correction-plan-freeze-passed" &&
    preparationAnalysis.plan.sha256 === sha256(serializedJson(plan)),
  "accepted Batch 8 generated SEO preparation required"
);
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-08-generated-seo-correction-execution-activation",
  protocolId: POST_CANARY_BATCH_08_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "frozen-batch-08-generated-seo-correction-pass-activated",
  activatedAt,
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-08-generated-seo-correction-and-validation-pass-no-reruns"
};
if (write) {
