...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-15";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-15-audio-verification";
...
const EXPECTED_DEBATES = ["39", "159", "98"];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-15-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-15-audio-verification-preparation.mjs",
  "scripts/assessment-production-post-canary-batch-15-audio-verification-stage.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-15-audio-sources.mjs",
  "scripts/test-assessment-production-post-canary-batch-15-audio-sources.mjs"
];
...
assertV4(
  sourcePreparation.status ===
      "prepared-three-post-canary-batch-15-local-audio-clips-standing-authorization-active-for-audio-verification-preparation" &&
    sourcePreparation.authorization.audioVerificationManifestPreparation &&
    sourcePreparation.nextAuthorizedAction ===
      "prepare-freeze-validate-and-push-batch-15-audio-verification-manifest-and-cost-estimate-under-standing-authorization",
  "Batch 15 audio-verification preparation is not authorized"
);
assertV4(sourcePreparation.clips.length === 3 && work.moves.length === 3, "three-clip cohort changed");
assertV4(
...
assertV4(calls.length === 3 && references.length === 6, "three calls and six references required");
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_15_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-15-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-15-decomposed-consensus",
  status: shouldWrite
    ? "prepared-three-post-canary-batch-15-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-three-post-canary-batch-15-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  userAuthorization: {
    ...
    standingAuthorizationPath: POST_CANARY_BATCH_15_STANDING_AUTHORIZATION,
    ...
    verificationCallsAuthorizedForPreparation: 3,
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 15 exact clip seconds and three-call count",
  ...
  standingAuthorization: {
    path: POST_CANARY_BATCH_15_STANDING_AUTHORIZATION,
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-three-batch-15-paid-audio-verification-calls-under-standing-authorization"
};
