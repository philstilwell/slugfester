...
import { MODEL, PROTOCOL_ID, ROOT, sha256 } from "./lib/assessment-production-post-canary-batch-15-audio-attribution.mjs";
...
const authorizationPath = "docs/assessment-production/post-canary-continuation-v1/batch-15/audio-verification/audio-attribution-successor-authorization.json";
...
const sourceFiles = [
  ...
  "scripts/lib/assessment-production-post-canary-batch-15-audio-attribution.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-15-audio-attribution.mjs",
  "scripts/test-assessment-production-post-canary-batch-15-audio-attribution.mjs",
  "scripts/activate-assessment-production-post-canary-batch-15-audio-attribution.mjs",
  "scripts/run-assessment-production-post-canary-batch-15-audio-attribution.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-15-audio-attribution.mjs",
];
const sourceHashes = {};
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-15-audio-attribution-execution-manifest",
  protocolId: PROTOCOL_ID,
  status: "frozen-two-batch-15-audio-attribution-recovery-contexts-active",
  activatedAt,
