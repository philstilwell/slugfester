...
assertV4(
  ...
  "Batch 6 judgment execution crossed its frozen boundary"
);
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-06-independent-judgment-analysis",
  ...
  nextAuthorizedAction: passed
    ...
    : "stop-post-canary-batch-06-independent-judgment-gate-for-audit",
};
if (shouldWrite) {
  await writeFile(
