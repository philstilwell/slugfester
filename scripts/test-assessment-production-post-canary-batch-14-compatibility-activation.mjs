...
assert.equal(activation.batchNumber, 14);
...
const proposedSource = buildPostCanaryBatch14ValidatorSource(baselineSource);
const proposedValidation = validatePostCanaryBatch14ValidatorSource(
  proposedSource
);
