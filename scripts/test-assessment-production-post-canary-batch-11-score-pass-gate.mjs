...
import { POST_CANARY_BATCH_11_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-11-score-gate.mjs";
...
const analysisPath = `${POST_CANARY_BATCH_11_SCORE_ROOT}/analysis.json`;
