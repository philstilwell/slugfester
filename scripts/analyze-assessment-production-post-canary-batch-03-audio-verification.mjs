...
assert(manifest.status === "frozen-eight-post-canary-batch-03-paid-known-speaker-diarizations-authorized-under-standing-authorization", "Batch 3 audio activation unavailable");
...
const status = passed
  ? "passed-all-eight-post-canary-batch-03-confidence-moves-audio-verified"
  : executionComplete
    ? "post-canary-batch-03-audio-verification-unresolved"
    : "post-canary-batch-03-audio-verification-incomplete";
const nextAuthorizedAction = execution.costCapReachedOrExceeded || !execution.directIncrementalCostCapControlPassed
  ? "user-review-required-before-any-batch-03-downstream-work-after-audio-cost-cap-event"
  : passed
    ? "prepare-freeze-and-push-batch-03-dispute-only-adjudication-packets-under-standing-authorization"
    : "standing-authorization-stop-new-approval-required-before-batch-03-audio-verification-failure-diagnosis";

const audit = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-03-audio-verification-audit",
...
const analysis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-03-audio-verification-analysis",
  protocolId: manifest.protocolId,
  status,
  productionCanary: false,
  batchNumber: 3,
