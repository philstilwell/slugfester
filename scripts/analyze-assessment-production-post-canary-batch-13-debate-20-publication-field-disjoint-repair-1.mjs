...
import { DEBATE_PLANS, ROOT, validateFieldDisjointRepairOutput } from
  "./lib/assessment-production-post-canary-batch-13-debate-20-publication-field-disjoint-repair-1.mjs";
...
assertV4(
  ...
  "one-shard Debate 20 repair execution boundary changed"
);
...
const analysis = {
  ...
  totals: {
    ...
    critiqueFieldsTargeted: 2,
    quoteFieldsTargeted: 0,
    writableFieldsTargeted: 2,
  ...
  authorization: {
    sixContextResumptionPreparation: allRepaired,
  ...
  nextAuthorizedAction: allRepaired
    ? "prepare-six-original-unattempted-batch-13-publication-contexts"
