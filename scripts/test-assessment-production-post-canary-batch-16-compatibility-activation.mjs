...
assert.equal(activation.batchNumber, 16);
...
const proposedSource = buildPostCanaryBatch16ValidatorSource(baselineSource);
const proposedValidation = validatePostCanaryBatch16ValidatorSource(
  proposedSource
);
