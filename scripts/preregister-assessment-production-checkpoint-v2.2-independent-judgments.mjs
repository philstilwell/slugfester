...
const SCRIPT =
  "scripts/preregister-assessment-production-checkpoint-v2.2-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-checkpoint-v2.2-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 188 &&
    preparation.totals.movesJudgedAcrossPasses === 376 &&
  ...
  "production checkpoint v2.2 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the production checkpoint gate disposition or score-blind inventory contract drifted"
);
assertV4(
...
assertV4(
  ...
  "production checkpoint v2.2 debate order drifted"
);
