...
assertV4(
  plan.protocolId === POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID &&
    plan.status === "frozen-batch-17-generated-seo-derivative-correction-plan-prepared" &&
    plan.inventory?.length === 380 &&
    plan.proposedWrites?.length === 6 &&
    plan.executionContract?.isolatedGeneratorRuns === 1 &&
    plan.executionContract?.repositoryValidationRuns === 1,
  "frozen Batch 17 generated SEO plan required"
);
assertV4(
  preparationAnalysis.status === "batch-17-generated-seo-correction-plan-freeze-passed" &&
    preparationAnalysis.plan.sha256 === sha256(serializedJson(plan)),
  "accepted Batch 17 generated SEO preparation required"
);
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-17-generated-seo-correction-execution-activation",
  protocolId: POST_CANARY_BATCH_17_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "frozen-batch-17-generated-seo-correction-pass-activated",
  activatedAt,
  ...
  authorization: {
    ...
    exactSixGeneratedDerivativeWrites: true,
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-17-generated-seo-correction-and-validation-pass-no-reruns"
};
if (write) {
...
console.log(serializedJson({ status: activation.status, write, outputs: 380, proposedWrites: 6, repositoryValidationRuns: 1 }));
