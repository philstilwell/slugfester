...
const SCRIPT =
  "scripts/preregister-assessment-production-score-stability-v2.1.2-inventory-candidate-census-plans.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.2-inventory-candidate-census-plan-manifest.mjs";
...
assertV4(
  preparation.schemaVersion ===
    ...
    preparation.protocolId === V212_CANDIDATE_SHARDED_INVENTORY.protocolId &&
    preparation.status ===
    ...
    preparation.totals?.candidates === 307 &&
    preparation.totals?.proCandidates === 154 &&
    preparation.totals?.conCandidates === 153 &&
  ...
  "candidate-sharded preparation does not authorize plan-execution manifest preparation"
);
assertV4(
...
const manifest = {
  ...
  costEstimate: {
    ...
    estimateBasis:
      "The earlier two-wide decomposed-plan run produced eight valid contexts in 36-108 seconds each and two 600-second timeouts at roughly 38-83 KB; these ten candidate-census contexts are smaller at roughly 34-46 KB. Subscription use has no direct incremental API charge.",
  },
