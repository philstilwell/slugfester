...
const SCRIPT =
  "scripts/activate-assessment-production-post-canary-batch-12-independent-judgments.mjs";
const RUNNER =
  "scripts/run-assessment-production-post-canary-batch-12-independent-judgments.mjs";
const ANALYZER =
...
assertV4(
  ...
  "Batch 12 independent-judgment activation prerequisites drifted"
);
assertV4(
  ...
  "frozen Batch 12 judgment packet preparation drifted"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-12-independent-judgment-execution-activation",
  ...
  userAuthorization: {
    scope:
      "activate and execute exactly the twenty frozen Batch 12 score-blind independent-judgment contexts under the frozen standing authorization",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-12-independent-judgment-gate-once",
};
if (shouldWrite) {
