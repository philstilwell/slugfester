...
assert.equal(record.sourcePreparation.frozenDiscoveryContexts, 33);
...
assert.equal(
  sha256(await readFile(POST_CANARY_BATCH_14_STANDING_AUTHORIZATION)),
  sha256(bytes)
);
...
console.log(
  JSON.stringify(
    {
      status: "passed-active-batch-14-standing-authorization",
