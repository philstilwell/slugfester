...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-16-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-16-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 194 &&
    preparation.totals.movesJudgedAcrossPasses === 388 &&
  ...
  "Batch 16 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 16 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 16 exact-source compatibility boundary drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-16-independent-judgment-execution-preparation-manifest",
