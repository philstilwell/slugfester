...
import { POST_CANARY_BATCH_10_PUBLICATION_COMPILATION_PROTOCOL_ID,
  POST_CANARY_BATCH_10_PUBLICATION_COMPILATION_ROOT } from
...
assertV4(p.status === "frozen-post-canary-batch-10-deterministic-publication-compilation-prepared" &&
  p.protocolId === POST_CANARY_BATCH_10_PUBLICATION_COMPILATION_PROTOCOL_ID && p.contexts?.length === 10 &&
...
"Batch 10 compilation is not prepared");
...
const activation = { schemaVersion: "1.0-assessment-production-post-canary-batch-10-publication-compilation-activation",
  protocolId: p.protocolId, status: "frozen-post-canary-batch-10-deterministic-publication-compilation-authorized",
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-10-deterministic-publication-compilation-pass" };
