...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-17-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-17-independent-judgment-manifest.mjs";
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.debates === 4 &&
    preparation.totals.uniqueMoves === 79 &&
    preparation.totals.movesJudgedAcrossPasses === 158 &&
  ...
  "Batch 17 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 17 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 17 exact-source compatibility boundary drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-17-independent-judgment-execution-preparation-manifest",
  ...
  costEstimate: {
    ...
    contexts: 8,
    expectedParallelWallMinutes: [20, 40],
    expectedAggregateModelMinutes: [36, 65],
    expectedAggregateComputeHours: [0.6, 1.08],
  ...
  acceptanceContract: {
    validContextsRequired: 8,
    sameLockedInventoryPerPair: true,
    separatePassOutputsPerPair: true,
    unchangedV4220ValidatorPassesRequired: 8,
    canonicalEventProjectionReplaysRequired: 8,
  ...
  nextAuthorizedAction:
    "freeze-and-activate-batch-17-independent-judgment-execution-under-standing-authorization",
};
