...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-10/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(preparation.totals.uniqueMoves, 182);
assert.equal(preparation.totals.movesJudgedAcrossPasses, 364);
