...
assert.equal(activation.batchNumber, 15);
...
const proposedSource = buildPostCanaryBatch15ValidatorSource(baselineSource);
const proposedValidation = validatePostCanaryBatch15ValidatorSource(
  proposedSource
);
