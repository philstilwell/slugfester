...
import {
  ...
  POST_CANARY_BATCH_01_SCORE_STABILITY_THRESHOLDS
...
const ledgerAnalysisPath =
  `${POST_CANARY_BATCH_01_FINAL_LEDGER_ROOT}/analysis.json`;
...
const scoreAnalysisPath = `${POST_CANARY_BATCH_01_SCORE_ROOT}/analysis.json`;
...
assertV4(
  ...
  "post-canary Batch 1 score-pass preparation gate is unavailable"
);
...
const batchFixtureTestPath =
  "scripts/test-assessment-production-post-canary-batch-01-score-gate.mjs";
const judgmentActivationPath =
  "docs/assessment-production/post-canary-continuation-v1/batch-01/independent-judgments/execution-activation.json";
...
assertV4(
  ...
  "Batch 1 upstream judgment configuration changed"
);
...
assertV4(
  ...
  "Batch 1 policy fixture test failed"
);
...
const sourcePaths = [
  ...
  "scripts/test-assessment-production-post-canary-batch-01-score-pass-gate.mjs",
  "scripts/preregister-assessment-production-post-canary-batch-01-score-pass.mjs",
  "scripts/activate-assessment-production-post-canary-batch-01-score-pass.mjs",
  "scripts/derive-assessment-production-post-canary-batch-01-scores.mjs",
  "scripts/validate-assessment-production-post-canary-batch-01-scores.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-01-scores.mjs"
];
const sourceHashes = {};
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-single-score-pass-preparation-manifest",
  ...
  nextAuthorizedAction:
    "user-approval-required-before-activation-and-execution-of-the-single-deterministic-batch-01-score-pass"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_01_SCORE_ROOT), { recursive: true });
  await writeFile(
