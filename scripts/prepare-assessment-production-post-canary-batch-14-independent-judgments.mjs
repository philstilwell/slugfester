...
const ROOT = "docs/assessment-production/post-canary-continuation-v1/batch-14/independent-judgments";
const PROTOCOL_ID =
  "assessment-production-post-canary-batch-14-independent-judgments";
const INVENTORY_ANALYSIS = "docs/assessment-production/post-canary-continuation-v1/batch-14/inventory-candidate-sharded/inventory-analysis.json";
const INVENTORY_PREPARATION = "docs/assessment-production/post-canary-continuation-v1/batch-14/inventory-candidate-sharded/preparation-manifest.json";
const SOURCE_PREPARATION = "docs/assessment-production/post-canary-continuation-v1/batch-14/source-preparation/preparation-manifest.json";
const SOURCE_VALIDATION = "docs/assessment-production/post-canary-continuation-v1/batch-14/source-preparation/validation.json";
...
const SOURCE_FILES = [
  ...
  POST_CANARY_BATCH_14_STANDING_AUTHORIZATION,
  "scripts/prepare-assessment-production-post-canary-batch-14-independent-judgments.mjs",
  "scripts/test-assessment-production-post-canary-batch-14-independent-judgment-preparation.mjs"
];
...
assertV4(
  inventoryAnalysis.status ===
      "post-canary-batch-14-inventory-gate-passed-audio-verification-required-before-later-adjudication" &&
    ...
    inventoryAnalysis.totals?.chronologyFallbacks === 7 &&
    ...
    inventoryAnalysis.nextAuthorizedAction ===
      "prepare-freeze-and-activate-batch-14-independent-judgment-contexts-under-standing-authorization",
  "the Batch 14 inventory gate is not ready for the separately authorized independent-judgment packet preparation"
);
assertV4(
  ...
  "the Batch 14 inventory preparation is unavailable"
);
assertV4(
  ...
  "the Batch 14 source preparation is unavailable"
);
assertV4(
  sourceValidation.status ===
    ...
    sourceValidation.checks?.exactSourceRowsInjectedOmittedOrRewritten ===
      false,
  "the Batch 14 source validation is unavailable"
);
assertV4(
...
assertV4(
  ...
  "the frozen Batch 14 cohort boundary changed"
);
assertV4(
  inventoryAnalysis.debates.map((debate) => debate.debateNumber).join(",") ===
    EXPECTED_DEBATES.join(","),
  "the passed Batch 14 inventory debate order changed"
);
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-independent-judgment-preparation",
  protocolId: PROTOCOL_ID,
  status: shouldWrite
    ? "twenty-post-canary-batch-14-independent-judgment-contexts-prepared-and-frozen"
    : "preview",
  ...
  userAuthorization: {
    scope:
      "prepare, freeze, activate, and execute exactly twenty Batch 14 score-blind independent-judgment contexts under the frozen standing authorization",
  ...
  nextAuthorizedAction:
    "prepare-post-canary-batch-14-independent-judgment-execution-preparation-manifest-model-free-only",
};
