...
for (const prepared of sourcePreparation.contexts) {
  ...
  const summary = {
    schemaVersion:
      "1.0-assessment-production-post-canary-batch-17-chronology-fallback-inventory-validation",
...
assertV4(debates.length === 4, "compiled inventory debate count drifted");
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-17-chronology-fallback-inventory-analysis",
  protocolId: activation.protocolId,
  status:
    belowHighAttributionMoves > 0
      ? "post-canary-batch-17-inventory-gate-passed-audio-verification-required-before-later-adjudication"
