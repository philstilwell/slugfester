...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-05-independent-judgments.mjs";
const TEST =
  "scripts/test-assessment-production-post-canary-batch-05-independent-judgment-manifest.mjs";
...
assertV4(
  ...
  "Batch 5 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 5 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 5 exact-source compatibility boundary drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-05-independent-judgment-execution-preparation-manifest",
