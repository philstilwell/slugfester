...
import {
  buildAssessmentProductionPostCanaryBatch12AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-12-audio-work-items.mjs";
import {
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 12 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 12 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  ...
  "Batch 12 four-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 12 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 12 exact four-move audio queue was not reproduced"
);
assertV4(
  ...
  "Batch 12 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-12-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_12_DISAGREEMENT_PROTOCOL_ID,
  status:
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-12-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_12_DISAGREEMENT_PROTOCOL_ID,
  status:
