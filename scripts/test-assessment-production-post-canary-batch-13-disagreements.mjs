...
import { extractAssessmentProductionPostCanaryBatch13Disagreements } from "./lib/assessment-production-post-canary-batch-13-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 13);
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 199);
assert.equal(
