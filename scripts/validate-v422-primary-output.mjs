...
import { validateV422PrimaryOutput } from "./lib/v422-chronology-first.mjs";

const [outputPath, packetPath] = process.argv.slice(2);
if (!outputPath || !packetPath) throw new Error("usage: validate-v422-primary-output.mjs OUTPUT PACKET");
...
console.log(JSON.stringify(validateV422PrimaryOutput(output, packet, JSON.parse(eventsBytes), eventsBytes, ledgerBytes), null, 2));
