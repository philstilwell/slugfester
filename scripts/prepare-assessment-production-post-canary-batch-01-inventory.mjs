...
const SCRIPT =
  "scripts/prepare-assessment-production-post-canary-batch-01-inventory.mjs";
const PROTOCOL_ID =
  "assessment-production-post-canary-batch-01-candidate-sharded-inventory";
const SOURCE_PACKET_VERSION =
  "1.0-assessment-production-post-canary-batch-01-candidate-sharded-inventory-source-packet";
...
const EXPECTED = {
  ...
  proCandidates: 147,
  conCandidates: 130,
  belowHighAttributionCandidates: 1,
};
...
function buildInventorySourcePacket(sourcePacket) {
  assertV4(
    sourcePacket?.schemaVersion ===
      "1.0-assessment-production-post-canary-batch-01-score-blind-source-packet" &&
      sourcePacket.protocolId ===
        "assessment-production-post-canary-batch-01-source-preparation" &&
    ...
    "Batch 1 source packet is unavailable or not dyadic"
  );
  return {
...
function makePlanPacket({
  ...
  return {
    schemaVersion:
      "1.0-assessment-production-post-canary-batch-01-candidate-census-plan-packet",
    protocolId: PROTOCOL_ID,
...
async function buildFrozenArtifacts(frozenAt) {
  ...
  assertV4(
    discoveryAnalysis.status ===
      "post-canary-batch-01-discovery-passed-awaiting-separate-inventory-authorization" &&
      ...
      discoveryAnalysis.audit?.validContexts === 31 &&
      ...
      discoveryAnalysis.totals?.modelContextsExecuted === 31 &&
      ...
      discoveryAnalysis.nextAuthorizedAction ===
        "user-approval-required-before-batch-01-inventory-packet-preparation-or-any-inventory-model-execution",
    "passed Batch 1 discovery boundary drifted"
  );
  assertV4(
    discoveryExecution.status ===
      "thirty-one-post-canary-batch-01-discovery-contexts-passed" &&
      discoveryExecution.contextsAttempted === 31 &&
      discoveryExecution.validContexts === 31 &&
    ...
    "Batch 1 discovery execution drifted"
  );
  assertV4(
      sourcePreparation.status ===
      "post-canary-batch-01-ten-complete-score-blind-source-packets-prepared-awaiting-validation" &&
    ...
    "Batch 1 source preparation or model boundary drifted"
  );
  assertV4(
    sourcePreparationValidation.status ===
      "post-canary-batch-01-score-blind-source-packet-validation-passed-frozen-awaiting-user-approval-before-any-model-execution" &&
    ...
    "Batch 1 source validation drifted"
  );
  assertV4(
    selection.status ===
      "first-post-canary-ten-debate-batch-selection-frozen-source-gate-passed" &&
    ...
    "Batch 1 frozen selection drifted"
  );
  assertV4(
  ...
  for (const discovered of discoveryAnalysis.debates) {
    ...
    assertV4(
      ...
      `${discovered.debateNumber}: Batch 1 identity drifted`
    );
    const [
  ...
  assertV4(
    ...
    "Batch 1 totals or packet state drifted"
  );
  ...
  const preparation = {
    schemaVersion:
      "1.0-assessment-production-post-canary-batch-01-candidate-sharded-inventory-preparation",
    protocolId: PROTOCOL_ID,
    ...
    userAuthorization: {
      instruction:
        "I approve preparation, validation, freezing, committing, and pushing of the Batch 1 candidate-sharded inventory packets and execution-preparation manifest only, with a direct incremental cost cap of $0. Do not execute inventory models, judgment models, paid services, audio work, score derivation, publication reconstruction, or production mutation.",
    ...
    discoveryDisposition: {
      batch01DiscoveryPassed: true,
      batch01DiscoveryRetried: false,
      batch01DiscoveryCandidatesChangedDuringTransport: false,
    ...
    nextAuthorizedAction:
      "user-approval-required-before-batch-01-candidate-census-plan-execution-activation-or-any-inventory-model-execution",
  };
  ...
  const executionPreparation = {
    schemaVersion:
      "1.0-assessment-production-post-canary-batch-01-candidate-census-plan-execution-preparation-manifest",
    protocolId: PROTOCOL_ID,
    status:
      "frozen-ten-post-canary-batch-01-candidate-census-plan-contexts-prepared-not-authorized",
    frozenAt,
  ...
  const validation = {
    schemaVersion:
      "1.0-assessment-production-post-canary-batch-01-candidate-sharded-inventory-preparation-validation",
    protocolId: PROTOCOL_ID,
    status:
      "batch-01-candidate-sharded-inventory-packets-and-plan-execution-manifest-validation-passed-frozen-not-authorized",
    ...
    checks: {
      ...
      oneMediumAttributionCandidateRecordedForPossibleLaterAudio: true,
...
async function validateFrozen() {
  ...
  assertV4(
    preparation.status ===
      ...
      preparation.audioPolicy.discoveryBelowHighCandidates === 1 &&
    ...
    "frozen Batch 1 inventory preparation is invalid"
  );
...
if (command === "freeze") await freeze();
  ...
  throw new Error(
    "usage: prepare-assessment-production-post-canary-batch-01-inventory.mjs <freeze|validate>"
  );
}
