...
import { extractAssessmentProductionPostCanaryBatch15Disagreements } from "./lib/assessment-production-post-canary-batch-15-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 15);
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 191);
assert.equal(
