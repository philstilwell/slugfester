...
import {
  POST_CANARY_BATCH_16_FINAL_LEDGER_PROTOCOL_ID,
  POST_CANARY_BATCH_16_FINAL_LEDGER_ROOT,
  buildPostCanaryBatch16FinalLedger,
...
const manifestPath =
  `${POST_CANARY_BATCH_16_FINAL_LEDGER_ROOT}/final-ledger-manifest.json`;
const ledgerPath = `${POST_CANARY_BATCH_16_FINAL_LEDGER_ROOT}/final-ledger.json`;
const analysisPath = `${POST_CANARY_BATCH_16_FINAL_LEDGER_ROOT}/analysis.json`;
if (shouldWrite) {
...
const preview = buildPostCanaryBatch16FinalLedger(
  inputs.debateInputs,
  inputs.sourceHashes
);
const validation = validatePostCanaryBatch16FinalLedger(
  preview,
  inputs.debateInputs,
  inputs.sourceHashes
);
const expected = {
  ...
  finalMoves: 194,
  disputedMoves: 185,
  candidateSelections: 576,
  pairSelections: 190,
  scoringFieldSelections: 366,
  burdenAdjustmentSelections: 20,
  roundedMeanPopulation: 417,
...
assertV4(
  ...
  "post-canary Batch 16 final-ledger preview population mismatch"
);
...
const sourceFiles = [
  ...
  "scripts/lib/assessment-production-post-canary-batch-16-dispute-adjudication.mjs",
  "scripts/lib/assessment-production-post-canary-batch-16-final-ledger.mjs",
  "scripts/preregister-assessment-production-post-canary-batch-16-final-ledger.mjs",
  "scripts/assemble-assessment-production-post-canary-batch-16-final-ledger.mjs",
  "scripts/validate-assessment-production-post-canary-batch-16-final-ledger.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-16-final-ledger.mjs",
  "scripts/test-assessment-production-post-canary-batch-16-final-ledger.mjs"
];
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-16-final-ledger-assembly-manifest",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 16 standing authorization permits deterministic final-ledger assembly and the single repository score pass while every gate passes.",
    scopeReference:
      "docs/assessment-production/post-canary-continuation-v1/batch-16/standing-authorization.json",
  ...
  nextAuthorizedAction:
    "assemble-and-validate-ten-post-canary-batch-16-final-ledgers-deterministically"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_16_FINAL_LEDGER_ROOT), {
    recursive: true
  });
  await writeFile(
