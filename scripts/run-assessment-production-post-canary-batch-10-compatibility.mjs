...
assertV4(write, "Batch 10 compatibility runner requires --write");
...
const paths = {
  root: POST_CANARY_BATCH_10_COMPATIBILITY_ROOT,
...
assertV4(
  ...
  "Batch 10 compatibility pass was already attempted; rerun forbidden"
);
...
assertV4(
  ...
  "frozen Batch 10 compatibility activation is unavailable"
);
...
tests.push(
  runCommand(
    "batch-10-route-positive-negative-controls",
    process.execPath,
...
if (tests.at(-1).passed) {
  tests.push(
    runCommand("checkpoint-batch-01-batch-02-batch-03-batch-04-batch-05-batch-06-batch-07-batch-08-batch-09-legacy-reference-regression", process.execPath, [
...
const nextAuthorizedAction = compatibilityAcceptancePassed
  ? "prepare-batch-10-production-publication-mutation-manifest-under-standing-authorization"
  : "diagnose-batch-10-compatibility-failure-under-failure-recovery-standing-authorization";
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-compatibility-execution",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-10-route-score-checkpoint-batch-01-batch-02-batch-03-batch-04-batch-05-batch-06-batch-07-batch-08-batch-09-legacy-reference-validation-passed"
    : "failed-closed-batch-10-compatibility-staging-pass",
  startedAt,
  completedAt,
  activation: {
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-compatibility-execution-analysis",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-10-production-compatibility-passed"
    : "batch-10-production-compatibility-failed-closed",
