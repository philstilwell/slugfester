...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-05";
...
const EXPECTED_DEBATES = ["158", "189", "05"];
...
const TOOL_SOURCES = [
  ...
  "scripts/prepare-assessment-production-post-canary-batch-05-audio-verification.mjs",
  "scripts/test-assessment-production-post-canary-batch-05-audio-verification-preparation.mjs",
...
assertV4(
  ...
  "Batch 5 audio-verification preparation is not authorized"
);
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_05_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-05-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-05-decomposed-consensus",
  status: shouldWrite
    ? "prepared-six-post-canary-batch-05-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-six-post-canary-batch-05-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 5 exact clip seconds and six-call count",
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-six-batch-05-paid-audio-verification-calls-under-standing-authorization"
};
