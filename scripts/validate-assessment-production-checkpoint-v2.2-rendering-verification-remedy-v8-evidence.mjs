...
assertV4(
  preparation.protocolId === CHECKPOINT_V22_RENDERING_REMEDY_V8_PROTOCOL_ID &&
    activation.protocolId === CHECKPOINT_V22_RENDERING_REMEDY_V8_PROTOCOL_ID &&
    activation.status ===
  ...
  "valid remedy-v8 activation required"
);
...
for (const debateNumber of CHECKPOINT_V22_RENDERING_REMEDY_V8_ORDER) {
  ...
  const packet = validateCheckpointV22RenderingRemedyV8Packet(
...
assertV4(
  ...
  "complete passing remedy-v8 evidence required"
);

console.log(JSON.stringify({
  schemaVersion:
    "1.0-production-checkpoint-v2.2-rendering-remedy-v8-evidence-audit",
  protocolId: CHECKPOINT_V22_RENDERING_REMEDY_V8_PROTOCOL_ID,
  status: "ten-debate-remedy-v8-rendering-evidence-passed",
  debates: 10,
