...
assert.equal(diagnosis.batchNumber, 10);
...
assert.equal(diagnosis.failure.debateNumber, "123");
assert.equal(diagnosis.failure.sourceVideoId, "8k9A7d2Wnjk");
assert.equal(
...
assert.equal(diagnosis.preservedFiles.length, 6);
