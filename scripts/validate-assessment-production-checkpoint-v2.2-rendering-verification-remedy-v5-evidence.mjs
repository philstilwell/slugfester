...
import {
  ...
  validateCheckpointV22RenderingRemedyV5ViewportEvidence
...
const tokenInput = canonicalJson(activation.executionNavigation.input);
assertV4(
  preparation.protocolId === CHECKPOINT_V22_RENDERING_REMEDY_V5_PROTOCOL_ID &&
    activation.protocolId === CHECKPOINT_V22_RENDERING_REMEDY_V5_PROTOCOL_ID &&
    activation.status ===
    ...
    activation.executionNavigation.token === sha256(tokenInput) &&
  ...
  "valid remedy-v5 activation required"
);
...
assertV4(
  ...
  "complete passing remedy-v5 evidence required"
);

console.log(JSON.stringify({
  schemaVersion:
    "1.0-production-checkpoint-v2.2-rendering-remedy-v5-evidence-audit",
  protocolId: CHECKPOINT_V22_RENDERING_REMEDY_V5_PROTOCOL_ID,
  status: "ten-debate-remedy-v5-rendering-evidence-passed",
  debates: 10,
