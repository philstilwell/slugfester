...
import { extractAssessmentProductionPostCanaryBatch07Disagreements } from "./lib/assessment-production-post-canary-batch-07-disagreement.mjs";
...
assert.equal(analysis.batchNumber, 5);
...
assert.equal(analysis.adjudicationWorkload.totalMoves, 187);
assert.equal(
