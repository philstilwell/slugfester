...
assertV4(
  ...
  "Batch 1 judgment execution crossed its frozen boundary"
);
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-independent-judgment-analysis",
  ...
  nextAuthorizedAction: passed
    ...
    : "stop-post-canary-batch-01-independent-judgment-gate-for-audit",
};
if (shouldWrite) {
  await writeFile(
