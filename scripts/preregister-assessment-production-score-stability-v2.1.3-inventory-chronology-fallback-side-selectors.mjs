...
const SCRIPT =
  "scripts/preregister-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback-side-selectors.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback-side-selector-manifest.mjs";
...
assertV4(
  sidePreparation.status ===
    ...
    sidePreparation.totals?.candidatesTransported === 331 &&
    ...
    sidePreparation.inventorySuccessorContract?.scoreFieldsAvailable ===
      false &&
...
const manifest = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-side-selector-execution-preparation-manifest",
  protocolId: sidePreparation.protocolId,
  sideSelectionProtocolId: sidePreparation.sideSelectionProtocolId,
  status:
    "frozen-twenty-v2.1.3-side-selector-contexts-prepared-not-authorized",
  frozenAt,
  ...
  nextAuthorizedAction:
    "prepare-separate-v2.1.3-side-selector-execution-activation-only",
};
