...
const manifest = {
  schemaVersion: "4.1.1-bounded-primary-execution-manifest",
  ...
  judgmentPolicy: { completeTranscriptRequired: true, boundedMovesMinimum: 8, boundedMovesMaximum: 24, sectionsMinimum: 4, sectionsMaximum: 6, movesPerSidePerSectionMinimum: 1, movesPerSidePerSectionMaximum: 2, modelPrecisionScalarProhibited: true, modelCalibrationScalarProhibited: true, allCalculatedTotalsProhibited: true, publicationProseProhibited: true, mediumOrLowAttributionRequiresAudioBeforePassB: true },
