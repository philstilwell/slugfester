...
const passed =
  ...
  validation.finalMoves === 180 &&
  validation.disputedMoves === 173 &&
  validation.candidateSelections === 459 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-09-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-09-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-09-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-09-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
