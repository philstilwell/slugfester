...
assertV4(preparation.status ===
  ...
  preparation.protocolId === POST_CANARY_BATCH_15_RENDERING_PROTOCOL_ID &&
...
"Batch 15 rendering verification is not prepared");
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-15-rendering-activation",
  protocolId: preparation.protocolId,
  status: "frozen-post-canary-batch-15-rendering-verification-authorized",
  authorizedAt,
  activationCommit,
  ...
  nextAuthorizedAction: "execute-frozen-batch-15-rendering-verification"
};
