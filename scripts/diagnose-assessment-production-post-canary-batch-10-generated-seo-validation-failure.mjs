...
assertV4(
  plan.status === "frozen-batch-10-generated-seo-derivative-correction-plan-prepared" &&
    activation.status === "frozen-batch-10-generated-seo-correction-pass-activated" &&
    activation.plan.sha256 === sha256(await readBytes(planPath)),
  "spent Batch 10 generated SEO activation required"
);
...
assertV4(
  affectedCalibrationDebates.length === 1 &&
    affectedCalibrationDebates[0].debateNumber === "68",
  "expected exactly Batch 10 Debate 68 to feed the legacy pilot analysis"
);
...
const diagnosis = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-10-generated-seo-validation-failure-diagnosis",
  protocolId: "assessment-production-post-canary-batch-10-generated-seo-dependent-pilot-analysis-recovery",
  status: "frozen-batch-10-generated-seo-full-check-dependent-pilot-analysis-staleness-diagnosed",
  diagnosedAt,
  batchNumber: 10,
  directIncrementalCostUsd: 0,
  failedExecution: {
    command: "node scripts/run-assessment-production-post-canary-batch-10-generated-seo-correction.mjs",
  ...
  rootCause: {
    finding: "The complete repository check recomputes the legacy v2.1 pilot report from current production debate scores. Batch 10 replaces Debate 68, which is sampled by that report, so its two checked-in deterministic outputs became stale even though the frozen SEO output inventory passed.",
  ...
  nextAuthorizedAction: "prepare-and-freeze-one-bounded-batch-10-dependent-pilot-analysis-correction"
};
