...
const ROOT =
  "docs/assessment-production/score-stability-v2.1-validation-cohort/source-preparation";
...
assert.equal(preparation.priorV2ValidationDisposition.gatesPassed, 0);
assert.equal(preparation.priorV2ValidationDisposition.quarantinedFiles, 106);
...
assert.equal(
  master.authorization.sourcePreparationPacketAndSchemaPreparation,
  true
);
