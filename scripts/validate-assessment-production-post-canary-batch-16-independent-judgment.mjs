...
assertV4(
  ...
  "usage: validate-assessment-production-post-canary-batch-16-independent-judgment.mjs JUDGMENT PREPARATION DEBATE PASS [--write]"
);
...
assertV4(
  ...
  "Batch 16 independent-judgment preparation unavailable"
);
...
const summary = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-16-independent-judgment-validation",
