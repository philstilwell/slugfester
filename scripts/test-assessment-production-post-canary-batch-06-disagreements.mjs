...
import { extractAssessmentProductionPostCanaryBatch06Disagreements } from "./lib/assessment-production-post-canary-batch-06-disagreement.mjs";
...
assert.equal(analysis.sourceCompatibility.occurrences.length, 1);
assert.equal(analysis.sourceCompatibility.occurrences[0].debateNumber, "141");
