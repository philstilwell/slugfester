...
assert.equal(manifest.acceptedSourceBoundary.allTwelveAudioMovesVerified, true);
assert.equal(manifest.acceptedSourceBoundary.audioValidationOverlaysPreserved, 1);
assert.equal(manifest.acceptedSourceBoundary.audioAttributionRecoveryContextsPreserved, 1);
