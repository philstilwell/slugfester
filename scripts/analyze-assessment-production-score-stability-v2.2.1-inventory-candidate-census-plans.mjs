...
const analysis = {
  schemaVersion:
    "1.0-score-stability-v2.2.1-candidate-census-plan-analysis",
  protocolId: activation.protocolId,
  status:
    "v2.2.1-candidate-census-plan-gate-passed-exact-side-packet-preparation-authorized",
  ...
  nextAuthorizedAction:
    "prepare-and-freeze-twenty-exact-v2.2.1-side-selector-packets-model-free-only",
};
