...
assertV4(
  ...
  "Batch 10 local audio-source preparation is not authorized"
);
assertV4(
  work.status ===
...
assertV4(
  grouped.size === 5,
  "expected exactly five Batch 10 audio sources"
);
...
if (!shouldWrite) {
  console.log(
    JSON.stringify(
      {
        status: "preview-five-post-canary-batch-10-local-audio-sources-nine-clips",
