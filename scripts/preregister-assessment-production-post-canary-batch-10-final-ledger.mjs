...
import {
  POST_CANARY_BATCH_10_FINAL_LEDGER_PROTOCOL_ID,
  POST_CANARY_BATCH_10_FINAL_LEDGER_ROOT,
  buildPostCanaryBatch10FinalLedger,
...
const manifestPath =
  `${POST_CANARY_BATCH_10_FINAL_LEDGER_ROOT}/final-ledger-manifest.json`;
const ledgerPath = `${POST_CANARY_BATCH_10_FINAL_LEDGER_ROOT}/final-ledger.json`;
const analysisPath = `${POST_CANARY_BATCH_10_FINAL_LEDGER_ROOT}/analysis.json`;
if (shouldWrite) {
...
const preview = buildPostCanaryBatch10FinalLedger(
  inputs.debateInputs,
  inputs.sourceHashes
);
const validation = validatePostCanaryBatch10FinalLedger(
  preview,
  inputs.debateInputs,
  inputs.sourceHashes
);
const expected = {
  ...
  pairSelections: 200,
  scoringFieldSelections: 265,
  burdenAdjustmentSelections: 18,
  roundedMeanPopulation: 381,
...
assertV4(
  ...
  "post-canary Batch 10 final-ledger preview population mismatch"
);
...
const sourceFiles = [
  ...
  "scripts/preregister-assessment-production-post-canary-batch-10-final-ledger.mjs",
  "scripts/assemble-assessment-production-post-canary-batch-10-final-ledger.mjs",
  "scripts/validate-assessment-production-post-canary-batch-10-final-ledger.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-10-final-ledger.mjs",
  "scripts/test-assessment-production-post-canary-batch-10-final-ledger.mjs"
];
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-10-final-ledger-assembly-manifest",
  ...
  userAuthorization: {
    instruction:
      "The frozen Batch 10 standing authorization permits deterministic final-ledger assembly and the single repository score pass while every gate passes.",
    scopeReference:
      "docs/assessment-production/post-canary-continuation-v1/batch-10/standing-authorization.json",
  ...
  nextAuthorizedAction:
    "assemble-and-validate-ten-post-canary-batch-10-final-ledgers-deterministically"
};
if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_10_FINAL_LEDGER_ROOT), {
    recursive: true
  });
  await writeFile(
