...
assertV4(
  ...
  "v2.1.3 paid audio activation is not prepared"
);
...
const manifest = {
  ...preparation,
  schemaVersion:
    "1.0-score-stability-v2.1.3-audio-verification-execution-manifest",
  status: "frozen-five-paid-known-speaker-diarizations-authorized",
  approvedAt,
  ...
  nextAuthorizedAction: "execute-five-v2.1.3-paid-known-speaker-diarizations-once"
};
if (shouldWrite) {
