...
import {
  ...
  validatePostCanaryBatch01RenderingViewportEvidence
...
assertV4(
  ...
  "valid Batch 1 rendering activation required"
);
...
assertV4(
  ...
  "complete passing Batch 1 rendering evidence required"
);
...
console.log(
  JSON.stringify(
    {
      schemaVersion:
        "1.0-assessment-production-post-canary-batch-01-rendering-evidence-audit",
      protocolId: POST_CANARY_BATCH_01_RENDERING_PROTOCOL_ID,
      status: "ten-debate-batch-01-rendering-evidence-passed",
      debates: 10,
      sections: 50,
      moves: 177,
