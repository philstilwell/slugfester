...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-07-publication-resumption-analysis",
  protocolId: activation.protocolId,
  status: passed
    ? "post-canary-batch-07-publication-resumption-output-gate-passed"
    : cohortSemanticPass
      ? "post-canary-batch-07-publication-resumption-failed-timing"
      : "post-canary-batch-07-publication-resumption-failed-validation",
  ...
  nextAuthorizedAction: passed
    ? "user-approval-required-before-batch-07-publication-compilation-preparation"
    : "user-approval-required-before-batch-07-publication-resumption-failure-diagnosis-only"
};
if (shouldWrite) {
