...
assertV4(
  ...
  "all v2.2 discovery contexts must pass without retry before analysis"
);
if (shouldWrite) {
  assertV4(
...
const analysis = {
  schemaVersion:
    "1.0-score-stability-v2.2-fresh-validation-discovery-analysis",
