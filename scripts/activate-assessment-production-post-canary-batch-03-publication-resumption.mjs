...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 176 &&
  ...
  "the Batch 3 publication resumption is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-publication-resumption-execution-activation",
  ...
  acceptedDebate124: structuredClone(preparation.acceptedDebate124),
  ...
  nextRequiredAction:
    "execute-the-nine-frozen-batch-03-publication-resumption-contexts-once"
};
