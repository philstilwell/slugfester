...
assertV4(
  ...
  "Batch 2 publication execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-execution-activation",
  ...
  userAuthorization: {
    instruction:
      "I approve activation and execution of exactly the ten frozen Batch 2 score-locked publication-reconstruction contexts using 5.6 Sol with low reasoning effort through my ChatGPT subscription, with a direct incremental cost cap of $0. Use the frozen 1→2 scheduler, one attempt per context, and no retries. Stop after deterministic publication-output validation, analysis, committing, and pushing. Do not prepare or execute repair packets, use paid services, finalize publication, mutate production, or select the next batch.",
  ...
  nextRequiredAction:
    "execute-frozen-post-canary-batch-02-publication-gate-once"
};
