...
import {
  buildAssessmentProductionPostCanaryBatch06AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-06-audio-work-items.mjs";
import {
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 6 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 6 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  ...
  "Batch 6 two-move audio queue or preparation boundary changed"
);
assertV4(
  analysis.sourceCompatibility?.status ===
    ...
    analysis.sourceCompatibility.occurrences[0].debateNumber === "141",
...
assertV4(
  ...
  "Batch 6 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 6 exact two-move audio queue was not reproduced"
);
assertV4(
  ...
  "Batch 6 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-06-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_06_DISAGREEMENT_PROTOCOL_ID,
  status:
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-06-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_06_DISAGREEMENT_PROTOCOL_ID,
  status:
