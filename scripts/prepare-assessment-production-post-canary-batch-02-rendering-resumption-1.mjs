...
import {
  ...
  validatePostCanaryBatch02RenderingPacket
...
import {
  ...
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_ANALYSIS,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_APPROVED_SCOPE,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_AUDIT,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_DOCUMENTATION,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_EXECUTION,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_FAILURE,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_PREPARATION,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_PROTOCOL_ID,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_ROOT,
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_VIEWPORT_PLAN,
...
const ORIGINAL_PREPARATION = `${POST_CANARY_BATCH_02_RENDERING_ROOT}/preparation-manifest.json`;
const ORIGINAL_ACTIVATION = `${POST_CANARY_BATCH_02_RENDERING_ROOT}/execution-activation.json`;
...
if (shouldWrite) {
  assertV4(
    !(await exists(POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_ROOT)),
    "Batch 2 rendering resumption-1 preparation already exists"
  );
}
...
assertV4(
  originalPreparation.status ===
      "frozen-post-canary-batch-02-rendering-verification-prepared-not-authorized" &&
    originalActivation.status ===
      "frozen-post-canary-batch-02-rendering-verification-authorized" &&
  ...
  "frozen original Batch 2 rendering activation required"
);
assertV4(
  !(await exists(EVIDENCE_ROOT)) &&
    !(await exists(`${POST_CANARY_BATCH_02_RENDERING_ROOT}/execution.json`)) &&
    !(await exists(`${POST_CANARY_BATCH_02_RENDERING_ROOT}/analysis.json`)) &&
    !(await exists(`${POST_CANARY_BATCH_02_RENDERING_ROOT}/rendering-audit.json`)),
...
for (const row of originalPreparation.packets) {
  ...
  validatePostCanaryBatch02RenderingPacket(JSON.parse(bytes));
}
validatePostCanaryBatch02RenderingResumption1Plan(
  POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_VIEWPORT_PLAN
);
...
const failure = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-rendering-transport-failure-diagnosis",
  protocolId: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_PROTOCOL_ID,
  status: "preserved-batch-02-bootstrap-only-transport-readiness-failure",
...
const directInputPaths = [
  ...
  "scripts/lib/assessment-production-post-canary-batch-02-rendering-resumption-1.mjs",
  "scripts/prepare-assessment-production-post-canary-batch-02-rendering-resumption-1.mjs",
  "scripts/test-assessment-production-post-canary-batch-02-rendering-resumption-1-preparation.mjs",
  "scripts/activate-assessment-production-post-canary-batch-02-rendering-resumption-1.mjs",
  "scripts/validate-assessment-production-post-canary-batch-02-rendering-resumption-1-evidence.mjs",
  "scripts/finalize-assessment-production-post-canary-batch-02-rendering-resumption-1.mjs"
];
const sourceHashes = {};
...
for (const file of futureOutputPathsExcludedFromSourceHashes) {
  assertV4(!(await exists(file)), `future Batch 2 rendering resumption output exists: ${file}`);
}

const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-rendering-transport-readiness-resumption-1-preparation",
  protocolId: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_PROTOCOL_ID,
  status: "frozen-batch-02-rendering-resumption-1-prepared-under-continuation-authorization",
  frozenAt,
  ...
  userAuthorization: {
    ...
    approvedScope: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_APPROVED_SCOPE,
  ...
  failureDiagnosis: {
    path: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_FAILURE,
  ...
  artifacts: {
    failureDiagnosis: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_FAILURE,
    preparation: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_PREPARATION,
    activation: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_ACTIVATION,
    evidenceRoot: EVIDENCE_ROOT,
    execution: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_EXECUTION,
    analysis: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_ANALYSIS,
    renderingAudit: POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_AUDIT
  },
  ...
  nextAuthorizedAction:
    "activate-and-execute-one-frozen-batch-02-rendering-resumption-1-under-continuation-authorization"
};

if (shouldWrite) {
  await mkdir(path.resolve(POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_ROOT), {
    recursive: true
  });
  await writeFile(path.resolve(POST_CANARY_BATCH_02_RENDERING_RESUMPTION_1_FAILURE), failureBytes);
  await writeFile(
