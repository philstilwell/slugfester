...
assert.equal(preparation.totals.sources, 1);
...
assert.equal(preparation.userAuthorization.sourceAudioFilesAuthorized, 1);
assert.equal(preparation.userAuthorization.clipsAuthorized, 2);
...
assert.equal(preparation.publicSourceAttemptAudit.length, 1);
assert(
