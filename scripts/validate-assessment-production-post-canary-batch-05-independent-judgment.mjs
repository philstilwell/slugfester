...
assertV4(
  ...
  "usage: validate-assessment-production-post-canary-batch-05-independent-judgment.mjs JUDGMENT PREPARATION DEBATE PASS [--write]"
);
...
assertV4(
  ...
  "Batch 5 independent-judgment preparation unavailable"
);
...
const summary = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-05-independent-judgment-validation",
