...
const passed =
  ...
  validation.finalMoves === 191 &&
  validation.disputedMoves === 186 &&
  validation.candidateSelections === 561 &&
  roundedMeanPopulation === 409 &&
  validation.audioVerifiedMoves === 3 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-15-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-15-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-15-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-15-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
