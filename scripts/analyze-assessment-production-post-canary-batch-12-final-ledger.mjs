...
const passed =
  ...
  validation.finalMoves === 204 &&
  validation.disputedMoves === 196 &&
  validation.candidateSelections === 528 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-12-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-12-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-12-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-12-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
