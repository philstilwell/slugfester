...
assert.equal(activation.status, "frozen-batch-13-production-publication-mutation-pass-activated");
assert.equal(activation.directIncrementalCostCapUsd, 0);
assert.deepEqual(activation.frozenOutput.changedDebateNumbers, POST_CANARY_BATCH_13_PRODUCTION_PUBLICATION_ORDER);
