...
import { POST_CANARY_BATCH_07_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-07-score-gate.mjs";
...
const analysisPath = `${POST_CANARY_BATCH_07_SCORE_ROOT}/analysis.json`;
