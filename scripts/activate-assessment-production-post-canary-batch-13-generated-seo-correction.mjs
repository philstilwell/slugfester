...
assertV4(
  plan.protocolId === POST_CANARY_BATCH_13_GENERATED_SEO_CORRECTION_PROTOCOL_ID &&
  ...
  "frozen Batch 13 generated SEO plan required"
);
assertV4(
  preparationAnalysis.status === "batch-13-generated-seo-correction-plan-freeze-passed" &&
    preparationAnalysis.plan.sha256 === sha256(serializedJson(plan)),
  "accepted Batch 13 generated SEO preparation required"
);
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-13-generated-seo-correction-execution-activation",
  protocolId: POST_CANARY_BATCH_13_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "frozen-batch-13-generated-seo-correction-pass-activated",
  activatedAt,
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-13-generated-seo-correction-and-validation-pass-no-reruns"
};
if (write) {
