...
for (const prepared of sourcePreparation.contexts) {
  ...
  const summary = {
    schemaVersion:
      "1.0-assessment-production-post-canary-batch-16-chronology-fallback-inventory-validation",
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-16-chronology-fallback-inventory-analysis",
  protocolId: activation.protocolId,
  status:
    belowHighAttributionMoves > 0
      ? "post-canary-batch-16-inventory-gate-passed-audio-verification-required-before-later-adjudication"
