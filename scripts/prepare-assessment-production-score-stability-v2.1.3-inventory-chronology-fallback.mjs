...
const SCRIPT =
  "scripts/prepare-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback.mjs";
const TEST =
  "scripts/test-assessment-production-score-stability-v2.1.3-inventory-chronology-fallback-preparation.mjs";
const PROTOCOL_ID =
  "assessment-production-score-stability-v2.1.3-fresh-validation-chronology-fallback-inventory";
const SOURCE_PACKET_VERSION =
  "1.0-score-stability-v2.1.3-chronology-fallback-inventory-source-packet";
...
function buildInventorySourcePacket(sourcePacket) {
  assertV4(
    ...
    "v2.1.3 discovery source packet is unavailable"
  );
  return {
...
function makePlanPacket({
  ...
  return {
    schemaVersion:
      "1.0-score-stability-v2.1.3-candidate-census-plan-packet",
    protocolId: PROTOCOL_ID,
...
assertV4(
  discoveryAnalysis.status ===
      "v2.1.3-validation-discovery-passed-chronology-fallback-inventory-preparation-authorized" &&
    ...
    discoveryAnalysis.totals?.candidates === 331 &&
    discoveryAnalysis.totals?.pro === 172 &&
    discoveryAnalysis.totals?.con === 159 &&
    ...
    discoveryAnalysis.nextAuthorizedAction ===
      "prepare-v2.1.3-chronology-fallback-inventory-packets-model-free-only",
  "passing v2.1.3 discovery analysis does not authorize preparation"
);
assertV4(
  ...
  "v2.1.3 source preparation or model boundary drifted"
);
assertV4(
...
assertV4(
  ...
  "v2.1.3 cohort totals or packet state drifted"
);
...
const preparation = {
  schemaVersion:
    "1.0-score-stability-v2.1.3-chronology-fallback-inventory-preparation",
  protocolId: PROTOCOL_ID,
  ...
  inventorySuccessorContract: structuredClone(
    discoveryAnalysis.inventorySuccessorContract
  ),
  model: {
  ...
  nextAuthorizedAction:
    "prepare-v2.1.3-candidate-census-plan-execution-manifest-model-free-only",
};
