...
const SCRIPT =
  "scripts/preregister-assessment-production-post-canary-batch-12-independent-judgments.mjs";
const TEST =
...
assertV4(
  preparation.status ===
    ...
    preparation.totals.uniqueMoves === 204 &&
    preparation.totals.movesJudgedAcrossPasses === 408 &&
  ...
  "Batch 12 preparation does not authorize an execution-preparation manifest"
);
assertV4(
...
assertV4(
  ...
  "the Batch 12 gate disposition or score-blind inventory contract drifted"
);
assertV4(
  ...
  "the Batch 12 exact-source compatibility boundary drifted"
);
assertV4(
...
const manifest = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-12-independent-judgment-execution-preparation-manifest",
  ...
  nextAuthorizedAction:
    "freeze-and-activate-batch-12-independent-judgment-execution-under-standing-authorization",
};
