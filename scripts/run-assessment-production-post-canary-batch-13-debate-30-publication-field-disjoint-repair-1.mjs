...
assertV4(
  activation.status === "frozen-nine-context-seventeen-field-batch-13-debate-30-publication-repair-activated" &&
    activation.authorization?.modelExecution === true && activation.contexts?.length === 9 &&
...
const execution = {
  ...
  protocolId: activation.protocolId,
  status: passed
    ? "nine-field-disjoint-batch-13-debate-30-publication-repair-contexts-passed"
    : "nine-field-disjoint-batch-13-debate-30-publication-repair-contexts-completed-with-failure",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-merge-and-validate-debate-30-then-prepare-four-unattempted-contexts"
