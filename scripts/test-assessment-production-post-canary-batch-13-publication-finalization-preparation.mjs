...
import { buildPostCanaryBatch13PublicationFinalization,
  validatePostCanaryBatch13PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-13-publication-finalization-prepared" &&
...
"Batch 13 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 199, "finalization move count changed");
