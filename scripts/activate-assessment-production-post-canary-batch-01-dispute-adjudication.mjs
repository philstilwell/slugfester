...
const executionTools = [
  ...
  "scripts/test-assessment-production-post-canary-batch-01-dispute-adjudication-gate.mjs"
];
...
assertV4(
  ...
  "Batch 1 adjudication activation is not prepared"
);
assertV4(
  ...
  "Batch 1 model, authentication, score-blindness, or tie boundary changed"
);
assertV4(
...
const activation = {
  ...preparation,
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-01-dispute-only-adjudication-execution-activation",
  status:
    "frozen-ten-post-canary-batch-01-dispute-only-adjudication-contexts-authorized",
  authorizedAt,
  ...
  nextAuthorizedAction:
    "execute-exactly-ten-ramped-post-canary-batch-01-dispute-only-adjudication-contexts-once"
};
assertV4(
  ...
  "Batch 1 execution authorization expanded beyond the user instruction"
);
if (shouldWrite) {
