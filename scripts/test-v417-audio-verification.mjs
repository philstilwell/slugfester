...
import { V417_AUDIO_PROTOCOL_ID, V417_AUDIO_SCHEMA_VERSION, bagOfWordsRecall, evaluateAttributionTranscript, lexicalTokens } from "./lib/v417-audio-verification.mjs";
...
console.log(JSON.stringify({ status: "passed", fixtures: 4, mutationsRejected: 3, paidCalls: 0 }, null, 2));
