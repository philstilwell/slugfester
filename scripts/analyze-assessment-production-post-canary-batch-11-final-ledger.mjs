...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-11-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-11-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-11-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-11-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
