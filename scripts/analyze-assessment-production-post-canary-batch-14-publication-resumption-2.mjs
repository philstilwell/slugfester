...
assertV4(
  execution.contextsPlanned === 6 && execution.retries === 0 &&
...
const resumptionPassed =
  execution.status === "six-original-unattempted-batch-14-publication-contexts-passed" &&
...
const analysis = {
  ...
  status: resumptionPassed
    ? "six-original-unattempted-batch-14-publication-contexts-passed"
...
if (resumptionPassed) {
  const allDebates = ["53", "69", "110", "133", ...DEBATES];
    ...
    completeReplay.push({
      ...
      source: debateNumber === "53"
        ...
        : debateNumber === "69"
          ...
          : "original-first-attempt-six-context-resumption",
      validation
    });
  }
