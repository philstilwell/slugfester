...
const cohortRoot = "docs/assessment-production/post-canary-continuation-v1/batch-07";
...
const mediaRoot = "output/transcribe/assessment-production-post-canary-batch-07-audio-verification";
...
const EXPECTED_DEBATES = ["193", "78", "02"];
...
assertV4(
  sourcePreparation.status ===
      "prepared-five-post-canary-batch-07-local-audio-clips-standing-authorization-active-for-audio-verification-preparation" &&
    sourcePreparation.authorization.audioVerificationManifestPreparation &&
    sourcePreparation.nextAuthorizedAction ===
      "prepare-freeze-validate-and-push-batch-07-audio-verification-manifest-and-cost-estimate-under-standing-authorization",
  "Batch 7 audio-verification preparation is not authorized"
);
assertV4(sourcePreparation.clips.length === 5 && work.moves.length === 5, "five-clip cohort changed");
assertV4(
...
assertV4(calls.length === 5 && references.length === 6, "five calls and six references required");
...
const sourceFiles = [
  ...
  batch02PreparationPath, batch02CostPath, POST_CANARY_BATCH_07_STANDING_AUTHORIZATION,
  ...TOOL_SOURCES,
...
const manifest = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-07-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-post-canary-batch-07-decomposed-consensus",
  status: shouldWrite
    ? "prepared-five-post-canary-batch-07-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready"
    : "preview-five-post-canary-batch-07-paid-known-speaker-diarizations-standing-authorization-conditional-activation-ready",
  ...
  userAuthorization: {
    ...
    verificationCallsAuthorizedForPreparation: 5,
  ...
  costEstimate: {
    ...
    primaryEstimateBasis: "Batch 2 returned-token usage rates applied to Batch 7 exact clip seconds and five-call count",
  ...
  sourceHashes,
  nextAuthorizedAction: "activate-and-execute-five-batch-07-paid-audio-verification-calls-under-standing-authorization"
};
