...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 120 &&
    preparation.totals?.cohortMoves === 200 &&
    ...
    preparation.authorization?.failureRecoveryStandingAuthorizationPermitsActivation === true &&
    ...
    preparation.inputs?.failureRecoveryStandingAuthorization ===
      RECOVERY_AUTHORIZATION &&
    preparation.userAuthorization?.failureRecoveryStandingAuthorizationSha256 ===
      recoveryAuthorization.sha256,
  "the Batch 3 publication resumption-2 is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-03-publication-resumption-2-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-six-frozen-batch-03-publication-resumption-2-contexts-once"
};
