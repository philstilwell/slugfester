...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 173 &&
  ...
  "the Batch 2 publication resumption is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-nine-frozen-batch-02-publication-resumption-contexts-once"
};
