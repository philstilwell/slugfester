...
const mediaRoot =
  "output/transcribe/assessment-production-checkpoint-v2.2-1-audio-verification";
...
const EXPECTED_DEBATES = ["25", "104"];
const TOOL_SOURCES = [
  "docs/assessment-production-checkpoint-v2.2-audio-verification-workflow.md",
  "docs/assessment-production-workflow.md",
  "scripts/lib/v416-audio-verification.mjs",
  "scripts/lib/v4-lean-production.mjs",
  "scripts/prepare-assessment-production-checkpoint-v2.2-audio-verification.mjs",
  "scripts/activate-assessment-production-checkpoint-v2.2-audio-verification.mjs",
  "scripts/run-assessment-production-checkpoint-v2.2-audio-verification.mjs",
  "scripts/analyze-assessment-production-checkpoint-v2.2-audio-verification.mjs",
  "scripts/test-assessment-production-checkpoint-v2.2-audio-verification.mjs",
...
assertV4(
  ...
  "production checkpoint v2.2 audio-verification preparation is not authorized"
);
assertV4(
  sourcePreparation.clips.length === 2 && work.moves.length === 2,
  "production checkpoint v2.2 two-clip population changed"
);
...
const manifest = {
  schemaVersion:
    "1.0-production-checkpoint-v2.2-audio-verification-execution-preparation-manifest",
  protocolId: "assessment-production-checkpoint-v2.2-1-decomposed-consensus",
  status: shouldWrite
    ? "prepared-two-production-checkpoint-v2.2-paid-known-speaker-diarizations-pending-explicit-user-approval"
    : "preview-two-production-checkpoint-v2.2-paid-known-speaker-diarizations-pending-explicit-user-approval",
  ...
  nextAuthorizedAction:
    "record-explicit-user-approval-and-freeze-production-checkpoint-v2.2-paid-audio-verification-activation"
};
assertV4(
