...
assertV4(
  activation.status === "frozen-five-original-unattempted-batch-13-publication-contexts-activated" &&
  ...
  "five-context resumption execution is not activated"
);
assertV4(
  ...
  "five-context execution policy changed"
);
...
const execution = {
  ...
  status: passed
    ...
    : "five-context-publication-resumption-stopped-with-failure",
  gateStartedAt,
  ...
  nextRequiredAction: passed
    ? "deterministically-replay-five-outputs-and-complete-ten-debate-publication-cohort"
