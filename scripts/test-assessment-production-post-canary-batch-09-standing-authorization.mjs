...
assert.equal(record.sourcePreparation.frozenDiscoveryContexts, 31);
assert.equal(record.recoveryHistory.sourcePreparationTransportShape.correctionsUsed, 1);
...
assert.equal(
  sha256(await readFile(POST_CANARY_BATCH_09_STANDING_AUTHORIZATION)),
  sha256(bytes)
);
...
console.log(
  JSON.stringify(
    {
      status: "passed-active-batch-09-standing-authorization",
