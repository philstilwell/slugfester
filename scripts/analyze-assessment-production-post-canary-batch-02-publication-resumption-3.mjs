...
assertV4(
  ...
  "the Batch 2 publication resumption-3 analysis boundary changed"
);
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-3-analysis",
  protocolId: activation.protocolId,
  status: passed
    ? "post-canary-batch-02-publication-resumption-3-output-gate-passed"
    : cohortSemanticPass
      ? "post-canary-batch-02-publication-resumption-3-failed-timing"
  ...
  totals: {
    acceptedDebatesBeforeResumption: 5,
    acceptedRepairedDebates: 4,
    acceptedRepairContexts: 16,
    repairedFields: 29,
