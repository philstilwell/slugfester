...
assertV4(
  preparation.schemaVersion ===
      "1.0-production-checkpoint-v2.2-rendering-remedy-v5-preparation" &&
    preparation.protocolId === CHECKPOINT_V22_RENDERING_REMEDY_V5_PROTOCOL_ID &&
    preparation.status ===
    ...
    canonicalJson(preparation.viewports) ===
      canonicalJson(CHECKPOINT_V22_RENDERING_REMEDY_V5_VIEWPORTS) &&
    canonicalJson(preparation.requiredBooleanChecks) ===
      canonicalJson(CHECKPOINT_V22_RENDERING_REMEDY_V5_REQUIRED_BOOLEAN_CHECKS) &&
    ...
    preparation.authorization.remedyV5PlanPreparation === true &&
  ...
  "invalid frozen remedy-v5 preparation"
);
...
assertV4(
  sha256(await readFile(CHECKPOINT_V22_RENDERING_REMEDY_V5_IMAGE_CONTRACT.analyzerPath)) ===
...
assertV4(
  diagnosis.status ===
    ...
    diagnosis.remedyV5Transport.parameters.quality === 85 &&
  ...
  "synthetic remedy-v5 evidence is not passing"
);
...
assertV4(
  ...
  "remedy-v5 preparation replay mismatch"
);

console.log(JSON.stringify({
  status: "remedy-v5-rendering-preparation-passed",
