...
assertV4(write, "Batch 14 compatibility runner requires --write");
...
const paths = {
  root: POST_CANARY_BATCH_14_COMPATIBILITY_ROOT,
...
assertV4(
  ...
  "Batch 14 compatibility pass was already attempted; rerun forbidden"
);
...
assertV4(
  ...
  "frozen Batch 14 compatibility activation is unavailable"
);
...
tests.push(
  runCommand(
    "batch-14-route-positive-negative-controls",
    process.execPath,
...
const nextAuthorizedAction = compatibilityAcceptancePassed
  ? "prepare-batch-14-production-publication-mutation-manifest-under-standing-authorization"
  : "diagnose-batch-14-compatibility-failure-under-failure-recovery-standing-authorization";
const execution = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-compatibility-execution",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-14-route-score-checkpoint-batch-01-batch-02-batch-03-batch-04-batch-05-batch-06-batch-07-batch-08-batch-09-batch-10-batch-11-legacy-reference-validation-passed"
    : "failed-closed-batch-14-compatibility-staging-pass",
  startedAt,
  completedAt,
  activation: {
  ...
  regressions: {
    batch14RouteControlsPassed: tests[0]?.passed === true,
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-compatibility-execution-analysis",
  protocolId: preparation.protocolId,
  status: compatibilityAcceptancePassed
    ? "batch-14-production-compatibility-passed"
    : "batch-14-production-compatibility-failed-closed",
  ...
  checks: {
    ...
    routeAndScoreControlsPassed: execution.regressions.batch14RouteControlsPassed,
    checkpointBatch01ThroughBatch12LegacyReferencePassed:
