...
const root = "docs/assessment-production/post-canary-continuation-v1/batch-10/dispute-only-adjudication/failure-recovery";
...
assertV4(
  prep.status === "frozen-two-batch-10-debate-74-field-disjoint-adjudication-correction-contexts-prepared" &&
    prep.contexts.length === 2 &&
    prep.contexts.reduce((sum, item) => sum + item.candidateSelections, 0) === 52 &&
  ...
  "Debate 74 correction is not prepared"
);
...
const activation = {
  ...prep,
  schemaVersion: "1.0-assessment-production-post-canary-batch-10-debate-74-adjudication-correction-activation",
  status: "frozen-two-batch-10-debate-74-field-disjoint-adjudication-correction-contexts-authorized",
  authorizedAt,
  ...
  nextAuthorizedAction: "execute-two-debate-74-field-disjoint-correction-contexts-once"
};
