...
assertV4(preparation.status ===
  "frozen-post-canary-batch-14-rendering-verification-prepared" &&
  preparation.protocolId === POST_CANARY_BATCH_14_RENDERING_PROTOCOL_ID &&
...
"Batch 14 rendering verification is not prepared");
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-14-rendering-activation",
  protocolId: preparation.protocolId,
  status: "frozen-post-canary-batch-14-rendering-verification-authorized",
  authorizedAt,
  activationCommit,
  ...
  nextAuthorizedAction: "execute-frozen-batch-14-rendering-verification"
};
