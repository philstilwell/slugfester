...
assertV4(
  ...
  "v2.2.3 paid audio activation is not prepared"
);
...
const manifest = {
  ...preparation,
  schemaVersion:
    "1.0-score-stability-v2.2.3-audio-verification-execution-manifest",
  status: "frozen-four-paid-known-speaker-diarizations-authorized",
  approvedAt,
  ...
  nextAuthorizedAction: "execute-four-v2.2.3-paid-known-speaker-diarizations-once"
};
if (shouldWrite) {
