...
const passed =
  ...
  validation.finalMoves === 194 &&
  validation.disputedMoves === 185 &&
  validation.candidateSelections === 576 &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-16-final-ledger-analysis",
  protocolId: ledger.protocolId,
  status: passed
    ? "post-canary-batch-16-deterministic-final-ledger-gate-passed"
    : "post-canary-batch-16-deterministic-final-ledger-gate-failed",
  analyzedAt,
  ...
  nextAuthorizedAction: passed
    ...
    : "standing-authorization-permits-batch-16-final-ledger-diagnosis"
};
if (shouldWrite) {
  await writeFile(
