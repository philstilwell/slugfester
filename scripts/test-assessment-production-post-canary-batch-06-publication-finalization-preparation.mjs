...
import { buildPostCanaryBatch06PublicationFinalization,
  validatePostCanaryBatch06PublicationFinalCandidate,
...
assertV4(m.status === "frozen-post-canary-batch-06-publication-finalization-prepared" &&
...
"Batch 6 finalization preparation changed");
let moves = 0;
...
assertV4(moves === 200, "finalization move count changed");
