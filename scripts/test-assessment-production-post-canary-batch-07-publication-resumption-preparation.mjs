...
const MANIFEST =
  `${POST_CANARY_BATCH_07_PUBLICATION_RESUMPTION_ROOT}/execution-preparation-manifest.json`;
...
assert.equal(manifest.totals.acceptedMoves, 19);
assert.equal(manifest.totals.resumptionContexts, 9);
assert.equal(manifest.totals.resumptionMoves, 168);
