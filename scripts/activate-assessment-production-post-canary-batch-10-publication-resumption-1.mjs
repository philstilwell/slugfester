...
assertV4(
  preparation.protocolId === PROTOCOL_ID &&
    preparation.status === "frozen-nine-original-unattempted-batch-10-publication-contexts-prepared-not-activated" &&
    preparation.contexts?.length === 9 && preparation.totals?.moves === 163 &&
...
const activation = {
  ...preparation,
  schemaVersion: "1.0-assessment-production-post-canary-batch-10-publication-original-unattempted-context-resumption-activation",
  status: "frozen-nine-original-unattempted-batch-10-publication-contexts-activated",
  activatedAt,
