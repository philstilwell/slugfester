...
assertV4(p.protocolId === POST_CANARY_BATCH_08_PUBLICATION_REPAIR_PROTOCOL_ID &&
  p.status === "frozen-one-context-batch-08-publication-repair-prepared-not-activated" &&
...
"the Batch 8 publication repair is not prepared");
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-08-publication-repair-activation",
  protocolId: p.protocolId,
  status: "frozen-one-context-batch-08-publication-repair-authorized",
  ...
  nextAuthorizedAction: "execute-exactly-one-frozen-batch-08-two-field-publication-repair-context"
};
