...
assertV4(
  ...
  "Batch 14 publication analysis boundary changed"
);
...
const passed =
  execution.status === "ten-post-canary-batch-14-publication-contexts-passed" &&
...
const analysis = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-14-publication-analysis",
  protocolId: activation.protocolId,
  status: passed
    ? "post-canary-batch-14-publication-output-gate-passed"
    : "post-canary-batch-14-publication-output-gate-failed",
  ...
  nextAuthorizedAction: passed
    ? "standing-authorization-permits-batch-14-publication-compilation-preparation"
    : "standing-authorization-permits-batch-14-publication-failure-diagnosis"
};
