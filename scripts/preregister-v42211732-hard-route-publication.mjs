...
const manifestPath = `${V42211732_ROOT}/execution-manifest.json`;
const executionPath = `${V42211732_ROOT}/model-execution.json`;
const analysisPath = `${V42211732_ROOT}/analysis.json`;
...
assertV4(preparation.status === "prepared-five-isolated-hard-route-publication-contexts" && preparation.authorization.executionManifest && preparation.totals.modelContextsExecuted === 0 && preparation.totals.modelAuthoredScores === 0, "publication execution manifest is not authorized");
...
const sourceFiles = [
  ...
  `${V42211732_ROOT}/manual.md`,
  `${V42211732_ROOT}/reference-catalog.json`,
  `${V42211732_ROOT}/preparation-manifest.json`,
  ...
  "scripts/prepare-v42211732-hard-route-publication.mjs",
  "scripts/validate-v42211732-hard-route-publication-output.mjs",
  "scripts/compile-v42211732-hard-route-publication.mjs",
  "scripts/test-v42211732-hard-route-publication.mjs",
  "scripts/preregister-v42211732-hard-route-publication.mjs",
  "scripts/run-v42211732-hard-route-publication.mjs",
  "scripts/analyze-v42211732-hard-route-publication.mjs",
  "scripts/test-v42211732-hard-route-publication-gate.mjs"
];
...
const manifest = {
  schemaVersion: "4.2.21.17.32-hard-route-publication-execution-manifest",
  ...
  deterministicValidation: { everyLockedMoveAuthoredExactlyOnce: true, exactQuoteSubstringRequired: true, critiqueWordAndSentenceContract: true, localReferenceCatalogOnly: true, overallCommentaryMinimums: true, aiExtensionNoveltyMapComplete: true, introducedArgumentPerSideRequired: true, exactAccordionDisplayContract: true, prohibitedLanguageAbsent: true, modelAuthoredScores: 0 },
