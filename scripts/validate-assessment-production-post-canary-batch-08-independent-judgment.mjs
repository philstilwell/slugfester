...
assertV4(
  ...
  "usage: validate-assessment-production-post-canary-batch-08-independent-judgment.mjs JUDGMENT PREPARATION DEBATE PASS [--write]"
);
...
assertV4(
  ...
  "Batch 8 independent-judgment preparation unavailable"
);
...
const summary = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-independent-judgment-validation",
