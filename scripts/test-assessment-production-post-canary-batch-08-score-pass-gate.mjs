...
import { POST_CANARY_BATCH_08_SCORE_ROOT } from "./lib/assessment-production-post-canary-batch-08-score-gate.mjs";
...
const analysisPath = `${POST_CANARY_BATCH_08_SCORE_ROOT}/analysis.json`;
...
assert.equal(
  preparation.userAuthorization.scopeReference,
