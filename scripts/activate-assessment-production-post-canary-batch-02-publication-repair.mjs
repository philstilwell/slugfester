...
assertV4(
  preparation.protocolId === POST_CANARY_BATCH_02_DEBATE_103_REPAIR_PROTOCOL_ID &&
    preparation.status ===
  ...
  "the Debate 103 repair execution is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-debate-103-publication-repair-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-nine-frozen-debate-103-publication-repair-contexts-once"
};
