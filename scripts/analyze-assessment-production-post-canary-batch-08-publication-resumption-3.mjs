...
const passed = !failureMessage && totals.debates === 10 && totals.moves === 182 &&
  totals.critiques === 182 && totals.exactSourceQuotes === 20 &&
...
const analysis = { schemaVersion:
    "1.0-assessment-production-post-canary-batch-08-publication-resumption-3-analysis",
  protocolId: a.protocolId, status: passed
    ? "batch-08-complete-ten-debate-publication-reconstruction-cohort-passed"
    : "batch-08-publication-resumption-3-or-cohort-validation-failed",
  productionCanary: false, batchNumber: 8, stagingOnly: true,
  execution: { contextsPlanned: 1, contextsAttempted: e.contextsAttempted,
  ...
  cohortValidation: { status: passed ? "passed" : "failed", ...totals,
    expectedDebateOrder: ["88", "194", "137", "08", "65", "140", "156", "120", "118", "145"],
  ...
  nextAuthorizedAction: passed ? "prepare-and-execute-one-deterministic-batch-08-publication-compilation-pass"
    : "stop-after-failed-batch-08-publication-resumption-3-output" };
