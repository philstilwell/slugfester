...
assertV4(
  preparation.protocolId ===
    ...
    preparation.totals?.resumptionMoves === 97 &&
  ...
  "the Batch 2 publication resumption-3 is not prepared"
);
assertV4(
...
const activation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-02-publication-resumption-3-execution-activation",
  ...
  nextRequiredAction:
    "execute-the-five-frozen-batch-02-publication-resumption-3-contexts-once"
};
