...
const MANIFEST =
  "docs/assessment-production/post-canary-continuation-v1/batch-06/independent-judgments/execution-preparation-manifest.json";
...
assert.equal(manifest.sourceCompatibility.occurrences.length, 1);
assert.equal(
