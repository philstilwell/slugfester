...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-15-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-15-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-15-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 15 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 15 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  ...
  "Batch 15 three-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 15 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 15 exact three-move audio queue was not reproduced"
);
assertV4(
  ...
  "Batch 15 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-15-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_15_DISAGREEMENT_PROTOCOL_ID,
  status:
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-15-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_15_DISAGREEMENT_PROTOCOL_ID,
  status:
