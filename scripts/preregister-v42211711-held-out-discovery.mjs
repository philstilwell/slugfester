...
assertV4(
  preparation.status === "five-held-out-source-and-discovery-contexts-prepared"
...
const sourceFiles = [
  "docs/assessment-workflow-v4.2.21.17.10.md",
  "docs/assessment-workflow-v4.2.21.17.11.md",
  PREPARATION,
  ...
  "scripts/preregister-v42211711-held-out-discovery.mjs",
  "scripts/run-v42211711-held-out-discovery.mjs",
  "scripts/analyze-v42211711-held-out-discovery.mjs",
  "scripts/test-v42211711-held-out-discovery.mjs",
...
const manifest = {
  schemaVersion: "4.2.21.17.11-held-out-discovery-execution-manifest",
  protocolId: "v4.2.21.17.11-held-out-discovery",
  status: "frozen-seventeen-held-out-discovery-contexts-authorized",
  frozenAt,
  ...
  costEstimate: {
    ...
    expectedSerialModelWorkMinutes: [18, 34],
