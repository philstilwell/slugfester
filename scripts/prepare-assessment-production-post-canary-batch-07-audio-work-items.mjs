...
import {
  buildAssessmentProductionPostCanaryBatch07AudioWorkItems
} from "./lib/assessment-production-post-canary-batch-07-audio-work-items.mjs";
import {
...
const EXPECTED_AUDIO = [
  ...
  "78:con-jewish-sect-and-syrian-divergence",
  "78:con-selective-hostile-source-survival",
  "78:pro-gospel-patristic-source-convergence",
  "02:con-scriptural-injunctions-and-harm"
];
...
const TOOL_SOURCES = [
  "scripts/prepare-assessment-production-post-canary-batch-07-audio-work-items.mjs",
  "scripts/test-assessment-production-post-canary-batch-07-audio-work-items.mjs",
  "scripts/lib/assessment-production-post-canary-batch-07-audio-work-items.mjs",
...
if (shouldWrite) {
  assertV4(
    ...
    "frozen Batch 7 audio work-item artifacts already exist"
  );
}
...
assertV4(
  ...
  "Batch 7 disagreement gate or prior audio-work stop rule changed"
);
assertV4(
  ...
  "Batch 7 five-move audio queue or preparation boundary changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 7 execution-preparation population changed"
);
assertV4(
...
assertV4(
  ...
  "Batch 7 exact five-move audio queue was not reproduced"
);
assertV4(
  audioWorkItems.length === 5 &&
  ...
  "Batch 7 work-item trigger, count, or metadata-only boundary changed"
);

const workDocument = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-07-audio-work-items",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_07_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-five-post-canary-batch-07-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
...
const preparation = {
  schemaVersion:
    "1.0-assessment-production-post-canary-batch-07-audio-work-item-preparation",
  protocolId:
    ASSESSMENT_PRODUCTION_POST_CANARY_BATCH_07_DISAGREEMENT_PROTOCOL_ID,
  status:
    "prepared-and-frozen-five-post-canary-batch-07-local-audio-source-work-items-standing-authorization-active-for-audio-preparation",
  developmentValidationOnly: false,
  productionCanary: false,
  batchNumber: 5,
  stagingOnly: true,
