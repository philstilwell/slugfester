...
const expectedDebates = ["124", "14", "58", "150", "157"];
const executionTools = [
  "scripts/activate-assessment-production-post-canary-batch-03-audio-verification.mjs",
  "scripts/run-assessment-production-post-canary-batch-03-audio-verification.mjs",
  "scripts/analyze-assessment-production-post-canary-batch-03-audio-verification.mjs",
...
assert(
  ...
  "Batch 3 audio-verification preparation status changed"
);
assert(preparation.calls.length === 8, "exactly eight frozen calls required");
...
assert(preparation.costEstimate.primaryExpectedFutureExecutionCostUsd === 0.2435025, "frozen usage-derived estimate changed");
...
assert(items.length === 5, "five canonical production-manifest entries required");
...
const activation = {
  ...preparation,
  schemaVersion: "1.0-assessment-production-post-canary-batch-03-audio-verification-execution-manifest",
  status: "frozen-eight-post-canary-batch-03-paid-known-speaker-diarizations-authorized-under-standing-authorization",
  activatedAt,
  ...
  userExecutionAuthorization: {
    ...
    frozenUsageDerivedEstimateUsd: 0.2435025,
    verificationCallsAuthorized: 8,
  ...
  nextAuthorizedAction: "execute-exactly-eight-post-canary-batch-03-paid-audio-verification-calls-once-sequentially"
};
