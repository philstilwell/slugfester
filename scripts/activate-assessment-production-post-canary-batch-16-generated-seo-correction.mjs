...
import { serializedJson, sha256 } from "./lib/assessment-production-post-canary-batch-16-production-publication.mjs";
...
assertV4(
  plan.protocolId === POST_CANARY_BATCH_16_GENERATED_SEO_CORRECTION_PROTOCOL_ID &&
    plan.status === "frozen-batch-16-generated-seo-derivative-correction-plan-prepared" &&
  ...
  "frozen Batch 16 generated SEO plan required"
);
assertV4(
  preparationAnalysis.status === "batch-16-generated-seo-correction-plan-freeze-passed" &&
    preparationAnalysis.plan.sha256 === sha256(serializedJson(plan)),
  "accepted Batch 16 generated SEO preparation required"
);
...
const activation = {
  schemaVersion: "1.0-assessment-production-post-canary-batch-16-generated-seo-correction-execution-activation",
  protocolId: POST_CANARY_BATCH_16_GENERATED_SEO_CORRECTION_PROTOCOL_ID,
  status: "frozen-batch-16-generated-seo-correction-pass-activated",
  activatedAt,
  ...
  nextAuthorizedAction: "execute-one-frozen-batch-16-generated-seo-correction-and-validation-pass-no-reruns"
};
if (write) {
