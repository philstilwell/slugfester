...
import { sha256 } from "./lib/assessment-production-post-canary-batch-16-production-publication.mjs";
...
assert.equal(activation.status, "frozen-batch-16-generated-seo-correction-pass-activated");
