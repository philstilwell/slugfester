# v3.8.11 clean performance-judgment manual
...
The other pass, legacy judgments, calculated totals, winners, assessment prose, and prior v3.8.8, v3.8.9, or v3.8.10 gate outputs are unavailable. If contamination occurs, the context fails. This gate allows exactly one attempt; do not emit provisional JSON or ask for repair.
