...
- Current observed runtime projects to **53.52 compute-hours** for consensus/scoring and about **67.34 hours** including the current publication-finalization assumption. That is above the 50-hour target.
