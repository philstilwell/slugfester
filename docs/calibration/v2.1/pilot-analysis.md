...
Across the 20 sampled moves, v2.1 scores averaged **2.5 points lower** than the legacy move scores; mean absolute change was **4.2** points and the range was -13 to +13. Within-pair ordering was stable in **7/10** cases.
