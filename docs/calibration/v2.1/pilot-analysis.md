...
Across the 20 sampled moves, v2.1 scores averaged **4.05 points lower** than the legacy move scores; mean absolute change was **4.65** points and the range was -19 to +3. Within-pair ordering was stable in **8/10** cases.
