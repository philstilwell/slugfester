# Isolated Batch 17 audio-attribution recovery manual
...
The diarized transcript was produced from the locally retained target clip using known-speaker references. Segment indexes, speaker labels, timings, and text are immutable evidence. The failed deterministic lexical checks are evidence, not conclusions you must reproduce.
