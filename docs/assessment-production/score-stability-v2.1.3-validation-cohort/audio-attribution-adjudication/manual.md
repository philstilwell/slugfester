# Score-stability v2.1.3 isolated audio-attribution adjudication manual

Act only as the fresh isolated audio-attribution adjudicator for Debate 78 move `con-uncertain-single-catholic-lineage`. Read every supplied file completely and no other file. Return exactly one schema-conforming JSON object and no commentary.
