# Production checkpoint v2.2 audio-verification workflow

This production-canary stage audio-verifies the two below-high-confidence moves frozen by the checkpoint v2.2 independent-judgment gate. It uses the two locally normalized source files and two immutable clips recorded in `audio-source-preparation.json`.
